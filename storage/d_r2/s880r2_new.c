...
static uint32_t  func_1(void)
{
    ...
    var_20h = 1;
    var_22h = 0x5f99;
    for (var_1ch = 0xe; -0x18 < var_1ch; var_1ch = var_1ch + -1) {
        for (var_20h = -9; var_20h < -1; var_20h = var_20h + 1) {
            var_22h = var_22h + 1;
        }
    }
    set_var(0xc75b57fd, 0x4b5f5c18, 0x6d44418, var_1ch, var_20h, var_22h);
    return 0x4b5f5c18;
}
