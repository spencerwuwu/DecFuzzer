...
// From module:   /home/weicheng/Documents/CS699_WASM/DecFuzzer/seed_all/s193retdec.c
// Address range: 0x14c0 - 0x14fd
// Line range:    30 - 32
int32_t set_var(int16_t g_7_l, int16_t g_8_l, int32_t g_9_l) {
    // 0x14c0
    int32_t v1; // 0x14c0
    *(int16_t *)(v1 + 0x2b4c) = g_8_l;
    *(int16_t *)(v1 + 0x2b4e) = (int16_t)g_9_l;
    return 0;
}
...
void crc32_byte(char b) {
    // 0x1580
    int32_t v1; // 0x1580
    int32_t * v2 = (int32_t *)(v1 + 0x2a93); // 0x1593
    uint32_t v3 = *v2; // 0x1593
    char v4; // 0x1580
    *v2 = v3 / 256 ^ *(int32_t *)(v1 + 0x2a9b + 4 * (v3 % 256 ^ (int32_t)v4));
}
