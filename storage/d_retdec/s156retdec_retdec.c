...
int32_t set_var(int32_t g_2_l, int32_t g_3_l, int32_t g_6_l, int32_t g_7_l, int16_t g_14_l, int32_t g_26_l);
...
// From module:   /home/weicheng/Documents/CS699_WASM/DecFuzzer/seed_all/s156retdec.c
...
// From module:   /home/weicheng/Documents/CS699_WASM/DecFuzzer/seed_all/s156retdec.c
// Address range: 0x1830 - 0x188e
// Line range:    33 - 35
int32_t set_var(int32_t g_2_l, int32_t g_3_l, int32_t g_6_l, int32_t g_7_l, int16_t g_14_l, int32_t g_26_l) {
    // 0x1830
    int32_t v1; // 0x1830
    *(int32_t *)(v1 + 0x27dc) = g_3_l;
    *(int32_t *)(v1 + 0x27e0) = g_6_l;
    *(int32_t *)(v1 + 0x27e4) = g_7_l;
    *(int32_t *)(v1 + 0x27e8) = (int32_t)g_14_l;
    *(int16_t *)(v1 + 0x27ec) = (int16_t)g_26_l;
    return 0;
}
...
void crc32_byte(char b) {
    // 0x1910
    int32_t v1; // 0x1910
    int32_t * v2 = (int32_t *)(v1 + 0x2713); // 0x1923
    uint32_t v3 = *v2; // 0x1923
    char v4; // 0x1910
    *v2 = v3 / 256 ^ *(int32_t *)(v1 + 0x271b + 4 * (v3 % 256 ^ (int32_t)v4));
}
