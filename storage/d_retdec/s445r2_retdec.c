...
int64_t g1 = 0; // 0x3fe0
int32_t g2 = 0x40001; // 0x4020
char g3 = 4; // 0x4022
int32_t g4 = -10; // 0x4024
int32_t g5 = 0x1001c; // 0x4028
int32_t g6 = -0xffff; // 0x402a
int32_t g7 = -1; // 0x402c
...
// From module:   /home/weicheng/Documents/CS699_WASM/DecFuzzer/seed_all/s445r2.c
...
void crc32_byte(unsigned char b) {
    uint32_t v1 = g9;
    int32_t v2 = *(int32_t *)((int64_t)(4 * (v1 % 256 ^ (int32_t)b)) + (int64_t)&g12); // 0x17e5
    g9 = v1 / 256 ^ v2;
}
