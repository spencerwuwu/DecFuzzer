...
int32_t set_var(int32_t g_9_l, char g_10_l, char g_11_l, int32_t g_13_l, int16_t g_14_l);
...
// From module:   /home/weicheng/Documents/CS699_WASM/DecFuzzer/seed_all/s701retdec.c
...
// From module:   /home/weicheng/Documents/CS699_WASM/DecFuzzer/seed_all/s701retdec.c
// Address range: 0x1550 - 0x15a2
// Line range:    32 - 34
int32_t set_var(int32_t g_9_l, char g_10_l, char g_11_l, int32_t g_13_l, int16_t g_14_l) {
    // 0x1550
    int32_t v1; // 0x1550
    *(int32_t *)(v1 + 0x2abc) = (int32_t)g_10_l;
    *(char *)(v1 + 0x2ac0) = g_11_l;
    *(char *)(v1 + 0x2ac1) = (char)g_13_l;
    *(int32_t *)(v1 + 0x2ac4) = (int32_t)g_14_l;
    return 0;
}
