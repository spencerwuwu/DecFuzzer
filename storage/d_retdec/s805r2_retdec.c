...
// From module:   /home/weicheng/Documents/CS699_WASM/DecFuzzer/seed_all/s805r2.c
...
int main(int argc, char ** argv) {
    ...
    uint16_t v9 = *(int16_t *)(v2 + 0x3e7a); // 0x12ea
...
// From module:   /home/weicheng/Documents/CS699_WASM/DecFuzzer/seed_all/s805r2.c
// Address range: 0x2180 - 0x223e
// Line range:    40 - 42
int32_t set_var(int16_t g_7_l, int32_t g_14_l, int32_t g_28_l, char g_43_l, int16_t g_46_l, int16_t g_53_l, int16_t g_57_l, int32_t g_60_l, int32_t g_61_l, char g_62_l, int32_t g_63_l, int32_t g_90_l, int16_t g_104_l) {
    // 0x2180
    int32_t v1; // 0x2180
    *(int16_t *)(v1 + 0x2e8c) = (int16_t)g_14_l;
    *(int32_t *)(v1 + 0x2e90) = g_28_l;
    *(int32_t *)(v1 + 0x2e94) = (int32_t)g_43_l;
    *(char *)(v1 + 0x2e98) = (char)g_46_l;
    *(int16_t *)(v1 + 0x2e9a) = g_53_l;
    *(int16_t *)(v1 + 0x2e9c) = g_57_l;
    *(int16_t *)(v1 + 0x2e9e) = (int16_t)g_60_l;
    *(int32_t *)(v1 + 0x2ea0) = g_61_l;
    *(int32_t *)(v1 + 0x2ea4) = (int32_t)g_62_l;
    *(char *)(v1 + 0x2ea8) = (char)g_63_l;
    *(int32_t *)(v1 + 0x2eac) = g_90_l;
    *(int32_t *)(v1 + 0x2eb0) = (int32_t)g_104_l;
    return 0;
}

// From module:   /home/weicheng/Documents/CS699_WASM/DecFuzzer/./seed_all/stdint-uintn.h
// Address range: 0x2240 - 0x22c0
// Line range:    86 - 92
void crc32_8bytes(int32_t val) {
    // 0x2240
    int32_t v1; // 0x2240
...
// From module:   /home/weicheng/Documents/CS699_WASM/DecFuzzer/./seed_all/stdint-uintn.h
// Address range: 0x22c0 - 0x2304
// Line range:    78 - 82
void crc32_byte(char b) {
    // 0x22c0
    int32_t v1; // 0x22c0
    int32_t * v2 = (int32_t *)(v1 + 0x2d77); // 0x22d3
    uint32_t v3 = *v2; // 0x22d3
    char v4; // 0x22c0
    *v2 = v3 / 256 ^ *(int32_t *)(v1 + 0x2d7f + 4 * (v3 % 256 ^ (int32_t)v4));
}

// Address range: 0x2304 - 0x231c
int32_t _fini(void) {
    // 0x2304
    int32_t v1; // 0x2304
