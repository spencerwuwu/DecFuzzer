...
int32_t set_var(int32_t g_3_l, int32_t g_4_l, int16_t g_10_l);
...
// From module:   /home/weicheng/Documents/CS699_WASM/DecFuzzer/seed_all/s521retdec.c
...
int32_t set_var(int32_t g_3_l, int32_t g_4_l, int16_t g_10_l) {
    // 0x1560
    int32_t v1; // 0x1560
    *(int32_t *)(v1 + 0x2aac) = g_4_l;
    *(int32_t *)(v1 + 0x2ab0) = (int32_t)g_10_l;
    return 0;
}
