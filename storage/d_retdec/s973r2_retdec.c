...
// From module:   /home/weicheng/Documents/CS699_WASM/DecFuzzer/seed_all/s973r2.c
...
int main(int argc, char ** argv) {
    ...
    int16_t v7 = *(int16_t *)(v2 + 0x2e74); // 0x12a3
    transparent_crc((int32_t)v7, (char *)(v2 + 3697), v1);
    uint16_t v8 = *(int16_t *)(v2 + 0x2e76); // 0x12c6
...
int32_t set_var(int32_t g_2_l, int16_t g_22_l, int32_t g_25_l, int32_t g_75_l, int16_t g_76_l, int16_t g_77_l) {
    // 0x17f0
    int32_t v1; // 0x17f0
    *(int32_t *)(v1 + 0x281c) = (int32_t)g_22_l;
    *(int16_t *)(v1 + 0x2834) = (int16_t)g_25_l;
    *(int32_t *)(v1 + 0x2820) = g_75_l;
    *(int32_t *)(v1 + 0x2824) = (int32_t)g_76_l;
    *(int16_t *)(v1 + 0x2828) = g_77_l;
    return 0;
}
...
void crc32_byte(char b) {
    // 0x18e0
    int32_t v1; // 0x18e0
    int32_t * v2 = (int32_t *)(v1 + 0x273b); // 0x18f3
