...
// From module:   /home/weicheng/Documents/CS699_WASM/DecFuzzer/seed_all/s412retdec.c
...
int main(int argc, char ** argv) {
    ...
    unsigned char v13 = *(char *)(v2 + 0x3e8c); // 0x1373
    transparent_crc((int32_t)v13, (char *)(v2 + 0x1e8d), v1);
    unsigned char v14 = *(char *)(v2 + 0x3e8d); // 0x1396
...
// From module:   /home/weicheng/Documents/CS699_WASM/DecFuzzer/seed_all/s412retdec.c
// Address range: 0x2270 - 0x232e
// Line range:    40 - 42
int32_t set_var(int16_t g_2_l, int16_t g_16_l, char g_17_l, int32_t g_19_l, int32_t g_23_l, int16_t g_30_l, int32_t g_48_l, int16_t g_49_l, int32_t g_50_l, int32_t g_51_l, char g_104_l, char g_126_l, int16_t g_141_l) {
    // 0x2270
    int32_t v1; // 0x2270
    *(int16_t *)(v1 + 0x2d9c) = g_16_l;
    *(int16_t *)(v1 + 0x2d9e) = (int16_t)g_17_l;
    *(char *)(v1 + 0x2da0) = (char)g_19_l;
    *(int32_t *)(v1 + 0x2da4) = g_23_l;
    *(int32_t *)(v1 + 0x2da8) = (int32_t)g_30_l;
    *(int16_t *)(v1 + 0x2dac) = (int16_t)g_48_l;
    *(int32_t *)(v1 + 0x2db0) = (int32_t)g_49_l;
    *(int16_t *)(v1 + 0x2db4) = (int16_t)g_50_l;
    *(int32_t *)(v1 + 0x2db8) = g_51_l;
    *(int32_t *)(v1 + 0x2dbc) = (int32_t)g_104_l;
    *(char *)(v1 + 0x2dc0) = g_126_l;
    *(char *)(v1 + 0x2dc1) = (char)g_141_l;
    return 0;
}

// From module:   /home/weicheng/Documents/CS699_WASM/DecFuzzer/./seed_all/stdint-uintn.h
// Address range: 0x2330 - 0x23b0
// Line range:    86 - 92
void crc32_8bytes(int32_t val) {
    // 0x2330
    int32_t v1; // 0x2330
...
// From module:   /home/weicheng/Documents/CS699_WASM/DecFuzzer/./seed_all/stdint-uintn.h
// Address range: 0x23b0 - 0x23f4
// Line range:    78 - 82
void crc32_byte(char b) {
    // 0x23b0
    int32_t v1; // 0x23b0
    int32_t * v2 = (int32_t *)(v1 + 0x2c83); // 0x23c3
    uint32_t v3 = *v2; // 0x23c3
    char v4; // 0x23b0
    *v2 = v3 / 256 ^ *(int32_t *)(v1 + 0x2c8b + 4 * (v3 % 256 ^ (int32_t)v4));
}

// Address range: 0x23f4 - 0x240c
int32_t _fini(void) {
    // 0x23f4
    int32_t v1; // 0x23f4
