...
int main(int argc, char ** argv) {
    ...
    uint16_t v6 = *(int16_t *)(v2 + 0x2e7c); // 0x1280
...
// From module:   /home/weicheng/Documents/CS699_WASM/DecFuzzer/seed_all/s704retdec.c
// Address range: 0x14d0 - 0x1516
// Line range:    31 - 33
int32_t set_var(int32_t g_3_l, int32_t g_11_l, int32_t g_12_l, int16_t g_15_l) {
    // 0x14d0
    int32_t v1; // 0x14d0
    *(int32_t *)(v1 + 0x2b3c) = g_11_l;
    *(int32_t *)(v1 + 0x2b40) = g_12_l;
    *(int32_t *)(v1 + 0x2b44) = (int32_t)g_15_l;
    return 0;
}
...
void crc32_byte(char b) {
    ...
    char v4; // 0x15a0
    *v2 = v3 / 256 ^ *(int32_t *)(v1 + 0x2a83 + 4 * (v3 % 256 ^ (int32_t)v4));
}
