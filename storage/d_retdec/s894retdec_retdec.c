...
// From module:   /home/weicheng/Documents/CS699_WASM/DecFuzzer/seed_all/s894retdec.c
// Address range: 0x1b60 - 0x1bdf
// Line range:    40 - 42
int32_t set_var(int32_t g_2_l, int32_t g_3_l, int32_t g_4_l, char g_14_l, char g_38_l, char g_39_l, int32_t g_66_l, char g_104_l, char g_135_l) {
    // 0x1b60
    int32_t v1; // 0x1b60
    *(int32_t *)(v1 + 0x24ac) = g_3_l;
    *(int32_t *)(v1 + 0x24b0) = g_4_l;
    *(int32_t *)(v1 + 0x24b4) = (int32_t)g_14_l;
    *(char *)(v1 + 0x24b8) = g_38_l;
    *(char *)(v1 + 0x24b9) = g_39_l;
    *(char *)(v1 + 0x24ba) = (char)g_66_l;
    *(int32_t *)(v1 + 0x24bc) = (int32_t)g_104_l;
    *(char *)(v1 + 0x24c0) = g_135_l;
    return 0;
}

// From module:   /home/weicheng/Documents/CS699_WASM/DecFuzzer/./seed_all/stdint-uintn.h
// Address range: 0x1be0 - 0x1c60
// Line range:    86 - 92
void crc32_8bytes(int32_t val) {
    // 0x1be0
    int32_t v1; // 0x1be0
...
// From module:   /home/weicheng/Documents/CS699_WASM/DecFuzzer/./seed_all/stdint-uintn.h
// Address range: 0x1c60 - 0x1ca4
// Line range:    78 - 82
void crc32_byte(char b) {
    // 0x1c60
    int32_t v1; // 0x1c60
    int32_t * v2 = (int32_t *)(v1 + 0x23c3); // 0x1c73
    uint32_t v3 = *v2; // 0x1c73
    char v4; // 0x1c60
    *v2 = v3 / 256 ^ *(int32_t *)(v1 + 0x23cb + 4 * (v3 % 256 ^ (int32_t)v4));
}

// Address range: 0x1ca4 - 0x1cbc
int32_t _fini(void) {
    // 0x1ca4
    int32_t v1; // 0x1ca4
