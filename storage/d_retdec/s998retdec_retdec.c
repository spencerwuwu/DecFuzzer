...
int main(int argc, char ** argv) {
    ...
    unsigned char v7 = *(char *)(v2 + 0x2e74); // 0x12a2
    transparent_crc((int32_t)v7, (char *)(v2 + 3697), v1);
    char v8 = *(char *)(v2 + 0x2e75); // 0x12c5
    transparent_crc((int32_t)v8, (char *)(v2 + 3702), v1);
    int32_t v9 = *(int32_t *)(v2 + 0x2e78); // 0x12e8
...
// From module:   /home/weicheng/Documents/CS699_WASM/DecFuzzer/seed_all/s998retdec.c
// Address range: 0x1880 - 0x18e7
// Line range:    34 - 36
int32_t set_var(int32_t g_8_l, int32_t g_12_l, int32_t g_13_l, int32_t g_15_l, char g_34_l, char g_65_l, int32_t g_74_l) {
    // 0x1880
    int32_t v1; // 0x1880
    *(int32_t *)(v1 + 0x278c) = g_12_l;
    *(int32_t *)(v1 + 0x2790) = g_13_l;
    *(int32_t *)(v1 + 0x2794) = g_15_l;
    *(int32_t *)(v1 + 0x27a8) = (int32_t)g_34_l;
    *(char *)(v1 + 0x2798) = g_65_l;
    *(char *)(v1 + 0x2799) = (char)g_74_l;
    return 0;
}
