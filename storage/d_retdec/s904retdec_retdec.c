...
int main(int argc, char ** argv) {
    ...
    crc32_gentab();
    func_1();
    int32_t v3 = *(int32_t *)(v2 + 3756); // 0x121a
    ...
    unsigned char v6 = *(char *)(v2 + 0x2e6c); // 0x1280
    transparent_crc((int32_t)v6, (char *)(v2 + 3691), v1);
    int16_t v7 = *(int16_t *)(v2 + 0x2e6e); // 0x12a3
    transparent_crc((int32_t)v7, (char *)(v2 + 3696), v1);
    char v8 = *(char *)(v2 + 0x2e70); // 0x12c6
...
// From module:   /home/weicheng/Documents/CS699_WASM/DecFuzzer/seed_all/s904retdec.c
// Address range: 0x1650 - 0x16a2
// Line range:    37 - 39
int32_t set_var(int32_t g_3_l, int32_t g_24_l, char g_25_l, int16_t g_27_l, char g_28_l) {
    // 0x1650
    int32_t v1; // 0x1650
    *(int32_t *)(v1 + 0x29d0) = g_24_l;
    *(int32_t *)(v1 + 0x29bc) = (int32_t)g_25_l;
    *(char *)(v1 + 0x29c0) = (char)g_27_l;
    *(int16_t *)(v1 + 0x29c2) = (int16_t)g_28_l;
    return 0;
}
...
void crc32_byte(char b) {
    // 0x1730
    int32_t v1; // 0x1730
    int32_t * v2 = (int32_t *)(v1 + 0x28e7); // 0x1743
