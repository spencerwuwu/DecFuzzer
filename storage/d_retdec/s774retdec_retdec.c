...
// From module:   /home/weicheng/Documents/CS699_WASM/DecFuzzer/seed_all/s774retdec.c
// Address range: 0x1540 - 0x158f
// Line range:    32 - 34
int32_t set_var(int32_t g_9_l, int32_t g_12_l, char g_14_l, char g_15_l, int32_t g_17_l) {
    // 0x1540
    int32_t v1; // 0x1540
    *(int32_t *)(v1 + 0x2acc) = g_12_l;
    *(int32_t *)(v1 + 0x2ad0) = (int32_t)g_14_l;
    *(char *)(v1 + 0x2ad4) = g_15_l;
    *(char *)(v1 + 0x2ad5) = (char)g_17_l;
    return 0;
}
...
void crc32_byte(char b) {
    // 0x1610
    int32_t v1; // 0x1610
    int32_t * v2 = (int32_t *)(v1 + 0x2a07); // 0x1623
