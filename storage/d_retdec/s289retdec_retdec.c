...
int main(int argc, char ** argv) {
    ...
    uint16_t v6 = *(int16_t *)(v2 + 0x2e72); // 0x1282
...
// From module:   /home/weicheng/Documents/CS699_WASM/DecFuzzer/seed_all/s289retdec.c
// Address range: 0x16e0 - 0x1741
// Line range:    33 - 35
int32_t set_var(char g_2_l, int32_t g_16_l, int16_t g_19_l, int16_t g_23_l, int32_t g_29_l, char g_30_l) {
    // 0x16e0
    int32_t v1; // 0x16e0
    *(char *)(v1 + 0x292c) = (char)g_16_l;
    *(int32_t *)(v1 + 0x2930) = (int32_t)g_19_l;
    *(int16_t *)(v1 + 0x2934) = g_23_l;
    *(int16_t *)(v1 + 0x2936) = (int16_t)g_29_l;
    *(int32_t *)(v1 + 0x2938) = (int32_t)g_30_l;
    return 0;
}
