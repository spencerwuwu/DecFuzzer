...
int32_t set_var(int32_t g_2_l, int32_t g_3_l, int32_t g_6_l, int32_t g_7_l, int32_t g_22_l) {
    // 0x16d0
    int32_t v1; // 0x16d0
    *(int32_t *)(v1 + 0x293c) = g_3_l;
    *(int32_t *)(v1 + 0x2940) = g_6_l;
    *(int32_t *)(v1 + 0x2944) = g_7_l;
    *(int32_t *)(v1 + 0x2948) = g_22_l;
    return 0;
}
...
void crc32_byte(char b) {
    // 0x17a0
    int32_t v1; // 0x17a0
    int32_t * v2 = (int32_t *)(v1 + 0x287f); // 0x17b3
