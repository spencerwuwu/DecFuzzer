...
int64_t g1 = 0; // 0x3fe0
int32_t g2 = 0xf931fc; // 0x4020
int32_t g3 = 0xd00f931; // 0x4021
int32_t g4 = 0x7a0d00f9; // 0x4022
int32_t g5 = 0x1b5f7a0d; // 0x4024
int32_t g6 = 3; // 0x4028
int16_t g7 = 1; // 0x402c
int32_t g8 = -9; // 0x4030
int32_t g9 = 0x1a35a1ef; // 0x4034
int32_t g10 = -4; // 0x4038
int32_t g11 = 0x1e9d581d; // 0x403c
int32_t g12 = 255; // 0x4040
...
// From module:   /home/weicheng/Documents/CS699_WASM/DecFuzzer/seed_all/s350r2.c
...
int main(int argc, char ** argv) {
    ...
    transparent_crc((int32_t)g7, "g_30", v1);
    transparent_crc(g8, "g_34", v1);
    transparent_crc((int32_t)*(int16_t *)&g16, "g_117", v1);
    transparent_crc(g9, "g_119", v1);
