...
// From module:   /home/weicheng/Documents/CS699_WASM/DecFuzzer/seed_all/s399retdec.c
// Address range: 0x1870 - 0x18d7
// Line range:    34 - 36
int32_t set_var(int32_t g_9_l, int32_t g_11_l, int32_t g_29_l, int32_t g_48_l, int32_t g_61_l, int32_t g_78_l, int32_t g_90_l) {
    // 0x1870
    int32_t v1; // 0x1870
    *(int32_t *)(v1 + 0x279c) = g_11_l;
    *(int32_t *)(v1 + 0x27a0) = g_29_l;
    *(int32_t *)(v1 + 0x27a4) = g_48_l;
    *(int32_t *)(v1 + 0x27a8) = g_61_l;
    *(int32_t *)(v1 + 0x27ac) = g_78_l;
    *(int32_t *)(v1 + 0x27b0) = g_90_l;
    return 0;
}
