...
int main(int argc, char ** argv) {
    ...
    uint16_t v7 = *(int16_t *)(v2 + 0x2e84); // 0x12a4
...
// From module:   /home/weicheng/Documents/CS699_WASM/DecFuzzer/seed_all/s597retdec.c
// Address range: 0x1880 - 0x18ed
// Line range:    34 - 36
int32_t set_var(int32_t g_2_l, int32_t g_6_l, char g_32_l, int16_t g_47_l, int16_t g_52_l, int32_t g_53_l, int32_t g_54_l) {
    // 0x1880
    int32_t v1; // 0x1880
    *(int32_t *)(v1 + 0x278c) = g_6_l;
    *(int32_t *)(v1 + 0x2790) = (int32_t)g_32_l;
    *(char *)(v1 + 0x2794) = (char)g_47_l;
    *(int16_t *)(v1 + 0x2796) = g_52_l;
    *(int16_t *)(v1 + 0x27a8) = (int16_t)g_53_l;
    *(int32_t *)(v1 + 0x2798) = g_54_l;
    return 0;
}
...
void crc32_byte(char b) {
    // 0x1970
    int32_t v1; // 0x1970
    int32_t * v2 = (int32_t *)(v1 + 0x26af); // 0x1983
    uint32_t v3 = *v2; // 0x1983
    char v4; // 0x1970
    *v2 = v3 / 256 ^ *(int32_t *)(v1 + 0x26bb + 4 * (v3 % 256 ^ (int32_t)v4));
}
