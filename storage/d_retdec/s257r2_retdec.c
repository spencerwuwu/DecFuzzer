...
int main(int argc, char ** argv) {
    ...
    unsigned char v8 = *(char *)(v2 + 0x2e7c); // 0x12c4
...
// From module:   /home/weicheng/Documents/CS699_WASM/DecFuzzer/seed_all/s257r2.c
// Address range: 0x17b0 - 0x1826
// Line range:    35 - 37
int32_t set_var(int32_t g_9_l, int32_t g_20_l, int32_t g_23_l, int32_t g_26_l, int32_t g_28_l, char g_46_l, int32_t g_48_l, int16_t g_49_l) {
    // 0x17b0
    int32_t v1; // 0x17b0
    *(int32_t *)(v1 + 0x285c) = g_20_l;
    *(int32_t *)(v1 + 0x2860) = g_23_l;
    *(int32_t *)(v1 + 0x2864) = g_26_l;
    *(int32_t *)(v1 + 0x2868) = g_28_l;
    *(int32_t *)(v1 + 0x286c) = (int32_t)g_46_l;
    *(char *)(v1 + 0x2870) = (char)g_48_l;
    *(int32_t *)(v1 + 0x2874) = (int32_t)g_49_l;
    return 0;
}
...
void crc32_byte(char b) {
    // 0x18b0
    int32_t v1; // 0x18b0
    int32_t * v2 = (int32_t *)(v1 + 0x277b); // 0x18c3
    uint32_t v3 = *v2; // 0x18c3
    char v4; // 0x18b0
    *v2 = v3 / 256 ^ *(int32_t *)(v1 + 0x2783 + 4 * (v3 % 256 ^ (int32_t)v4));
}
