...
int64_t g1 = 0; // 0x3fe0
int32_t g2 = -0x4293c10; // 0x4020
int16_t g3 = -0x537c; // 0x4024
int32_t g4 = -0x10ae5166; // 0x4028
int32_t g5 = -1; // 0x402c
int32_t g6 = 7; // 0x4030
int32_t g7 = -1; // 0x4034
char g8 = 0; // 0x4040
...
int main(int argc, char ** argv) {
    ...
    transparent_crc((int32_t)g3, "g_16", v1);
    transparent_crc(g4, "g_18", v1);
    transparent_crc((int32_t)*(int16_t *)&g9, "g_27", v1);
