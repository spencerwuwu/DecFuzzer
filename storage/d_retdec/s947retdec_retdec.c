...
// From module:   /home/weicheng/Documents/CS699_WASM/DecFuzzer/seed_all/s947retdec.c
...
int main(int argc, char ** argv) {
    ...
    char v9 = *(char *)(v2 + 0x3e7d); // 0x12eb
    transparent_crc((int32_t)v9, (char *)(v2 + 0x1e7b), v1);
    int32_t v10 = *(int32_t *)(v2 + 0x3e90); // 0x130e
    ...
    unsigned char v13 = *(char *)(v2 + 0x3e84); // 0x1375
...
void crc32_byte(char b) {
    // 0x20a0
    int32_t v1; // 0x20a0
    int32_t * v2 = (int32_t *)(v1 + 0x2f8b); // 0x20b3
