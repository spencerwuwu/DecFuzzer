...
int main(int argc, char ** argv) {
    ...
    char v12 = *(char *)(v2 + 0x3e8c); // 0x134d
    transparent_crc((int32_t)v12, (char *)(v2 + 0x1e8c), v1);
    unsigned char v13 = *(char *)(v2 + 0x3e98); // 0x1370
...
void crc32_gentab(void) {
    for (int32_t i = 0; i < 256; i++) {
        ...
        // 0x1455
        int32_t v5; // 0x13d0
        *(int32_t *)(v5 + 0x3c6d + 4 * i) = v3;
    }
}

// From module:   /home/weicheng/Documents/CS699_WASM/DecFuzzer/seed_all/s741retdec.c
// Address range: 0x1480 - 0x2150
// Line range:    48 - 168
int32_t func_1(void) {
    // 0x1fd3
...
// From module:   /home/weicheng/Documents/CS699_WASM/DecFuzzer/seed_all/s741retdec.c
// Address range: 0x21f0 - 0x228a
// Line range:    38 - 40
int32_t set_var(int32_t g_2_l, int32_t g_30_l, int16_t g_36_l, int32_t g_38_l, int32_t g_40_l, int32_t g_101_l, int32_t g_124_l, int32_t g_150_l, int32_t g_153_l, char g_159_l, char g_168_l) {
    // 0x21f0
    int32_t v1; // 0x21f0
    *(int32_t *)(v1 + 0x2e1c) = g_30_l;
    *(int32_t *)(v1 + 0x2e20) = (int32_t)g_36_l;
    *(int16_t *)(v1 + 0x2e24) = (int16_t)g_38_l;
    *(int32_t *)(v1 + 0x2e28) = g_40_l;
    *(int32_t *)(v1 + 0x2e2c) = g_101_l;
    *(int32_t *)(v1 + 0x2e30) = g_124_l;
    *(int32_t *)(v1 + 0x2e34) = g_150_l;
    *(int32_t *)(v1 + 0x2e38) = g_153_l;
    *(int32_t *)(v1 + 0x2e3c) = (int32_t)g_159_l;
    *(char *)(v1 + 0x2e40) = g_168_l;
    return 0;
}

// From module:   /home/weicheng/Documents/CS699_WASM/DecFuzzer/./seed_all/stdint-uintn.h
// Address range: 0x2290 - 0x2310
// Line range:    86 - 92
void crc32_8bytes(int32_t val) {
    // 0x2290
    int32_t v1; // 0x2290
...
// From module:   /home/weicheng/Documents/CS699_WASM/DecFuzzer/./seed_all/stdint-uintn.h
// Address range: 0x2310 - 0x2354
// Line range:    78 - 82
void crc32_byte(char b) {
    // 0x2310
    int32_t v1; // 0x2310
    int32_t * v2 = (int32_t *)(v1 + 0x2d23); // 0x2323
    uint32_t v3 = *v2; // 0x2323
    char v4; // 0x2310
    *v2 = v3 / 256 ^ *(int32_t *)(v1 + 0x2d2f + 4 * (v3 % 256 ^ (int32_t)v4));
}

// Address range: 0x2354 - 0x236c
int32_t _fini(void) {
    // 0x2354
    int32_t v1; // 0x2354
