...
// From module:   /home/weicheng/Documents/CS699_WASM/DecFuzzer/seed_all/s132r2.c
...
int main(int argc, char ** argv) {
    ...
    char v8 = *(char *)(v2 + 0x2e76); // 0x12ca
    transparent_crc((int32_t)v8, (char *)(v2 + 3702), v1);
    int32_t v9 = *(int32_t *)(v2 + 0x2e78); // 0x12ef
...
// From module:   /home/weicheng/Documents/CS699_WASM/DecFuzzer/seed_all/s132r2.c
// Address range: 0x1780 - 0x17ed
// Line range:    34 - 36
int32_t set_var(int16_t g_4_l, char g_15_l, int32_t g_26_l, int32_t g_52_l, int16_t g_53_l, char g_54_l, int32_t g_55_l) {
    // 0x1780
    int32_t v1; // 0x1780
    *(int16_t *)(v1 + 0x288c) = (int16_t)g_15_l;
    *(char *)(v1 + 0x288e) = (char)g_26_l;
    *(int32_t *)(v1 + 0x2890) = g_52_l;
    *(int32_t *)(v1 + 0x2894) = (int32_t)g_53_l;
    *(int16_t *)(v1 + 0x2898) = (int16_t)g_54_l;
    *(char *)(v1 + 0x289a) = (char)g_55_l;
    return 0;
}
