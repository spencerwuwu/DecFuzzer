...
int main(int argc, char ** argv) {
    ...
    unsigned char v4 = *(char *)(v2 + 0x2e7c); // 0x123c
    transparent_crc((int32_t)v4, (char *)(v2 + 3683), v1);
    transparent_crc(-102, (char *)(v2 + 3688), v1);
    int32_t v5 = *(int32_t *)(v2 + 0x2e6c); // 0x127f
    transparent_crc(v5, (char *)(v2 + 3693), v1);
    int32_t v6 = *(int32_t *)(v2 + 0x2e70); // 0x12a1
...
int32_t set_var(int32_t g_13_l, char g_24_l, int32_t g_26_l, int32_t g_35_l) {
    // 0x1560
    int32_t v1; // 0x1560
    *(int32_t *)(v1 + 0x2aac) = (int32_t)g_24_l;
    *(char *)(v1 + 0x2ac0) = (char)g_26_l;
    *(int32_t *)(v1 + 0x2ab0) = g_35_l;
    return 0;
}
