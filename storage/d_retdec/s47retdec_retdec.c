...
int32_t set_var(char g_3_l, int32_t g_5_l, int32_t g_6_l, char g_8_l);
...
// From module:   /home/weicheng/Documents/CS699_WASM/DecFuzzer/seed_all/s47retdec.c
...
int main(int argc, char ** argv) {
    ...
    unsigned char v6 = *(char *)(v2 + 0x2e74); // 0x1283
...
// From module:   /home/weicheng/Documents/CS699_WASM/DecFuzzer/seed_all/s47retdec.c
// Address range: 0x14b0 - 0x14f3
// Line range:    31 - 33
int32_t set_var(char g_3_l, int32_t g_5_l, int32_t g_6_l, char g_8_l) {
    // 0x14b0
    int32_t v1; // 0x14b0
    *(char *)(v1 + 0x2b5c) = (char)g_5_l;
    *(int32_t *)(v1 + 0x2b60) = g_6_l;
    *(int32_t *)(v1 + 0x2b64) = (int32_t)g_8_l;
    return 0;
}
...
void crc32_byte(char b) {
    // 0x1580
    int32_t v1; // 0x1580
    int32_t * v2 = (int32_t *)(v1 + 0x2a9b); // 0x1593
