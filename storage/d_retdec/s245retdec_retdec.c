...
int32_t set_var(int32_t g_5_l, int32_t g_8_l, char g_30_l, char g_32_l, int32_t g_47_l);
...
// From module:   /home/weicheng/Documents/CS699_WASM/DecFuzzer/seed_all/s245retdec.c
...
// From module:   /home/weicheng/Documents/CS699_WASM/DecFuzzer/seed_all/s245retdec.c
// Address range: 0x1700 - 0x174f
// Line range:    32 - 34
int32_t set_var(int32_t g_5_l, int32_t g_8_l, char g_30_l, char g_32_l, int32_t g_47_l) {
    // 0x1700
    int32_t v1; // 0x1700
    *(int32_t *)(v1 + 0x290c) = g_8_l;
    *(int32_t *)(v1 + 0x2910) = (int32_t)g_30_l;
    *(char *)(v1 + 0x2924) = g_32_l;
    *(char *)(v1 + 0x2914) = (char)g_47_l;
    return 0;
}
...
void crc32_byte(char b) {
    // 0x17d0
    int32_t v1; // 0x17d0
    int32_t * v2 = (int32_t *)(v1 + 0x284b); // 0x17e3
