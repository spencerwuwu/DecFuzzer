...
// From module:   /home/weicheng/Documents/CS699_WASM/DecFuzzer/seed_all/s221retdec.c
// Address range: 0x1570 - 0x15bf
// Line range:    32 - 34
int32_t set_var(char g_3_l, int32_t g_4_l, char g_14_l, int32_t g_15_l, int32_t g_16_l) {
    // 0x1570
    int32_t v1; // 0x1570
    *(char *)(v1 + 0x2a9c) = (char)g_4_l;
    *(int32_t *)(v1 + 0x2aa0) = (int32_t)g_14_l;
    *(char *)(v1 + 0x2aa4) = (char)g_15_l;
    *(int32_t *)(v1 + 0x2aa8) = g_16_l;
    return 0;
}
...
void crc32_byte(char b) {
    // 0x1640
    int32_t v1; // 0x1640
    int32_t * v2 = (int32_t *)(v1 + 0x29df); // 0x1653
