...
// From module:   /home/weicheng/Documents/CS699_WASM/DecFuzzer/seed_all/s677r2.c
...
int32_t set_var(int32_t g_2_l, char g_5_l, int32_t g_20_l, int16_t g_23_l, int32_t g_25_l) {
    // 0x15f0
    int32_t v1; // 0x15f0
    *(int32_t *)(v1 + 0x2a1c) = (int32_t)g_5_l;
    *(char *)(v1 + 0x2a20) = (char)g_20_l;
    *(int32_t *)(v1 + 0x2a24) = (int32_t)g_23_l;
    *(int16_t *)(v1 + 0x2a28) = (int16_t)g_25_l;
    return 0;
}
