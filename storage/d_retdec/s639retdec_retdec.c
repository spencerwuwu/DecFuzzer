...
int32_t set_var(int16_t g_9_l, char g_10_l, int32_t g_11_l, char g_17_l) {
    // 0x15c0
    int32_t v1; // 0x15c0
    *(int16_t *)(v1 + 0x2a4c) = (int16_t)g_10_l;
    *(char *)(v1 + 0x2a4e) = (char)g_11_l;
    *(int32_t *)(v1 + 0x2a50) = (int32_t)g_17_l;
    return 0;
}
...
void crc32_byte(char b) {
    // 0x1690
    int32_t v1; // 0x1690
    int32_t * v2 = (int32_t *)(v1 + 0x2987); // 0x16a3
    uint32_t v3 = *v2; // 0x16a3
    char v4; // 0x1690
    *v2 = v3 / 256 ^ *(int32_t *)(v1 + 0x298f + 4 * (v3 % 256 ^ (int32_t)v4));
}
