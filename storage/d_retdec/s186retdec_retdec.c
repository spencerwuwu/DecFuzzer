...
int32_t set_var(int32_t g_5_l, int32_t g_6_l, int32_t g_10_l, int16_t g_11_l);
...
// From module:   /home/weicheng/Documents/CS699_WASM/DecFuzzer/seed_all/s186retdec.c
...
// From module:   /home/weicheng/Documents/CS699_WASM/DecFuzzer/seed_all/s186retdec.c
// Address range: 0x1560 - 0x15a6
// Line range:    31 - 33
int32_t set_var(int32_t g_5_l, int32_t g_6_l, int32_t g_10_l, int16_t g_11_l) {
    // 0x1560
    int32_t v1; // 0x1560
    *(int32_t *)(v1 + 0x2ac0) = g_6_l;
    *(int32_t *)(v1 + 0x2aac) = g_10_l;
    *(int32_t *)(v1 + 0x2ab0) = (int32_t)g_11_l;
    return 0;
}
