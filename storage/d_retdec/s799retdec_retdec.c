...
// From module:   /home/weicheng/Documents/CS699_WASM/DecFuzzer/seed_all/s799retdec.c
...
int main(int argc, char ** argv) {
    ...
    char v11 = *(char *)(v2 + 0x2e8c); // 0x132e
    transparent_crc((int32_t)v11, (char *)(v2 + 3716), v1);
    int32_t v12 = *(int32_t *)(v2 + 0x2e80); // 0x1351
...
// From module:   /home/weicheng/Documents/CS699_WASM/DecFuzzer/seed_all/s799retdec.c
// Address range: 0x1740 - 0x17d4
// Line range:    37 - 39
int32_t set_var(int32_t g_17_l, int32_t g_18_l, int16_t g_21_l, int16_t g_28_l, int16_t g_29_l, char g_30_l, int32_t g_31_l, int32_t g_32_l, char g_33_l, int32_t g_34_l) {
    // 0x1740
    int32_t v1; // 0x1740
    *(int32_t *)(v1 + 0x28cc) = g_18_l;
    *(int32_t *)(v1 + 0x28d0) = (int32_t)g_21_l;
    *(int16_t *)(v1 + 0x28d4) = g_28_l;
    *(int16_t *)(v1 + 0x28d6) = g_29_l;
    *(int16_t *)(v1 + 0x28d8) = (int16_t)g_30_l;
    *(char *)(v1 + 0x28da) = (char)g_31_l;
    *(int32_t *)(v1 + 0x28dc) = g_32_l;
    *(int32_t *)(v1 + 0x28e0) = (int32_t)g_33_l;
    *(char *)(v1 + 0x28f0) = (char)g_34_l;
    return 0;
}

// From module:   /home/weicheng/Documents/CS699_WASM/DecFuzzer/./seed_all/stdint-uintn.h
// Address range: 0x17e0 - 0x1860
// Line range:    86 - 92
void crc32_8bytes(int32_t val) {
    // 0x17e0
    int32_t v1; // 0x17e0
...
// From module:   /home/weicheng/Documents/CS699_WASM/DecFuzzer/./seed_all/stdint-uintn.h
// Address range: 0x1860 - 0x18a4
// Line range:    78 - 82
void crc32_byte(char b) {
    // 0x1860
    int32_t v1; // 0x1860
    int32_t * v2 = (int32_t *)(v1 + 0x27c7); // 0x1873
    uint32_t v3 = *v2; // 0x1873
    char v4; // 0x1860
    *v2 = v3 / 256 ^ *(int32_t *)(v1 + 0x27d3 + 4 * (v3 % 256 ^ (int32_t)v4));
}
