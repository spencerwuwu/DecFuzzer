...
int64_t p = 61563;
c[1] = p;
int64_t q = (ushort)c[2];
c[3] = q;
int64_t r = (ushort)c[2];
int64_t s = 65535;
int64_t t = r & s;
int64_t u = (ushort)c[1];
int64_t v = 65535;
int64_t w = u & v;
int64_t x = w & t;
c[1] = x;
int64_t y = (int64_t)c[2];
int64_t z = 2;
int64_t aa = y - z;
c[2] = aa;
//continue L_b;
...
int64_t ca = (int64_t)c[2];
set_var(ba, ca);
int64_t da = (int64_t)c[3];
int64_t ea = 16;
int64_t* fa = c + ea;
stack_pointer = fa;
return da;
