...
int64_t g = 49667;
c[3] = g;
int64_t h = (ushort)c[3];
int64_t i = 16;
int64_t j = h << i;
int64_t k = j >> i;
int64_t l = (ushort)c[7];
int64_t m = 16;
int64_t n = l << m;
int64_t o = n >> m;
int64_t p = (ushort)c[6];
int64_t q = 65535;
int64_t r = p & q;
int64_t s = r ^ o;
c[6] = s;
...
int64_t da = ca;
if (eqz(ba)) goto B_a;
int64_t ea = (ushort)c[6];
int64_t fa = 65535;
int64_t ga = ea & fa;
int64_t ha = (ushort)c[3];
int64_t ia = 16;
int64_t ja = ha << ia;
int64_t ka = ja >> ia;
int64_t la = ga;
...
int64_t qa = oa & pa;
c[2] = qa;
int64_t ra = (ushort)c[7];
int64_t sa = (ushort)c[6];
int64_t ta = (int64_t)c[2];
int64_t ua = 16;
int64_t va = ra << ua;
int64_t wa = va >> ua;
int64_t xa = 65535;
