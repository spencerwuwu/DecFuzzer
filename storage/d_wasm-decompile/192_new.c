...
int64_t g = 35;
c[25] = g;
int64_t h = -2124628753;
c[5] = h;
int64_t i = 5;
c[4] = i;
int64_t j = 1622199983;
c[3] = j;
int64_t k = -7;
c[2] = k;
int64_t l = (ushort)c[15];
int64_t m = 16;
int64_t n = l << m;
int64_t o = n >> m;
int64_t p = -1174818023;
int64_t q = o | p;
c[15] = q;
int64_t r = (int64_t)c[4];
c[3] = r;
int64_t s = (int64_t)c[5];
int64_t t = 1;
int64_t u = s + t;
c[5] = u;
int64_t v = (ushort)c[15];
int64_t w = (ushort)c[14];
int64_t x = (ushort)c[13];
int64_t y = (ubyte)c[25];
int64_t z = (int64_t)c[5];
int64_t aa = 16;
int64_t ba = v << aa;
int64_t ca = ba >> aa;
int64_t da = 16;
...
int64_t ka = y << ja;
int64_t la = ka >> ja;
set_var(ca, fa, ia, la, z);
int64_t ma = (ushort)c[13];
int64_t na = 16;
int64_t oa = ma << na;
int64_t pa = oa >> na;
int64_t qa = 32;
