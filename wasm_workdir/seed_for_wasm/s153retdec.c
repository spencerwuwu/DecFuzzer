...
static uint32_t set_var(int32_t g_10_l, uint32_t g_11_l, uint8_t g_13_l, uint32_t *crc32_context, uint32_t *crc32_tab){
int32_t g_10 = 1;
uint32_t g_11 = 0x247ADF1A;
uint8_t g_13 = 0xED;
...
uint8_t g_13_l = 0xED;
 /* block id: 0 */
    ...
    l_12 &= g_13_l;
    return set_var(g_10_l, g_11_l, g_13_l, &crc32_context, crc32_tab);
}
/* ---------------------------------------- */
