...
static uint32_t set_var(int8_t g_4_l, uint8_t g_5_l, int32_t g_7_l, uint8_t g_16_l, uint32_t *crc32_context, uint32_t *crc32_tab){
volatile int8_t g_4 = 0;/* VOLATILE GLOBAL g_4 */
uint8_t g_5 = 255U;
int32_t g_7 = (-1);
uint8_t g_16 = 1U;
...
uint8_t g_16_l = 1U;
 /* block id: 0 */
    ...
    return set_var(g_4_l, g_5_l, g_7_l, g_16_l, &crc32_context, crc32_tab);
}
/* ---------------------------------------- */
