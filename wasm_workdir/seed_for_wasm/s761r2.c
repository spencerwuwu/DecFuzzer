...
static uint32_t set_var(uint32_t g_2_l, uint8_t g_8_l, uint32_t g_9_l, uint32_t *crc32_context, uint32_t *crc32_tab){
volatile uint32_t g_2 = 0xC29A3DF6;/* VOLATILE GLOBAL g_2 */
uint8_t g_8 = 0x49;
uint32_t g_9 = 0x3989226C;
...
uint32_t func_1(void)
{
 ...
 /* block id: 0 */
    ...
    return set_var(g_2_l, g_8_l, g_9_l, &crc32_context, crc32_tab);
}
/* ---------------------------------------- */
