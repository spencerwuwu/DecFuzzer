...
static uint32_t set_var(int32_t g_2_l, int32_t g_3_l, int16_t g_12_l, int32_t g_14_l, uint32_t *crc32_context, uint32_t *crc32_tab){
volatile int32_t g_2 = 0x4E064826;/* VOLATILE GLOBAL g_2 */
int32_t g_3 = 1;
int16_t g_12 = 0x2524;
int32_t g_14 = 0x5EAFB5D1;
...
uint32_t func_1(void)
{
 ...
 /* block id: 0 */
    ...
    l_6 = (g_2_l <= l_25);
    return set_var(g_2_l, g_3_l, g_12_l, g_14_l, &crc32_context, crc32_tab);
}
/* ---------------------------------------- */
