...
static uint32_t set_var(uint32_t g_2_l, int16_t g_3_l, uint32_t g_4_l, uint16_t g_19_l, uint32_t *crc32_context, uint32_t *crc32_tab){
volatile uint32_t g_2 = 1U;/* VOLATILE GLOBAL g_2 */
volatile int16_t g_3 = (-1);/* VOLATILE GLOBAL g_3 */
volatile uint32_t g_4 = 1U;/* VOLATILE GLOBAL g_4 */
uint16_t g_19 = 0xFA97;
...
uint32_t func_1(void)
{
 ...
 /* block id: 0 */
    ...
    return set_var(g_2_l, g_3_l, g_4_l, g_19_l, &crc32_context, crc32_tab);
}
/* ---------------------------------------- */
