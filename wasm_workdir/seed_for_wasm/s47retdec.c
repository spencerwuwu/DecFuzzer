...
static uint32_t set_var(int8_t g_3_l, int32_t g_5_l, int32_t g_6_l, uint8_t g_8_l, uint32_t *crc32_context, uint32_t *crc32_tab){
volatile int8_t g_3 = (-6);/* VOLATILE GLOBAL g_3 */
...
uint8_t g_8_l = 0x59;
 /* block id: 0 */
    ...
    int32_t l_7 = (-1);
    g_8_l++;
    return set_var(g_3_l, g_5_l, g_6_l, g_8_l, &crc32_context, crc32_tab);
}
/* ---------------------------------------- */
