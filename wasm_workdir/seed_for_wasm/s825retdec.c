...
static uint32_t set_var(uint32_t g_4_l, int32_t g_6_l, uint32_t *crc32_context, uint32_t *crc32_tab){
volatile uint32_t g_4 = 2U;/* VOLATILE GLOBAL g_4 */
const int32_t g_5 = 0x2E31D832;
int32_t g_6 = 0xC1574781;
