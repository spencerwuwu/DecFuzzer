...
static void w2c_s836r2_0x5F_wasm_call_ctors_0(w2c_s836r2*);
static void w2c_s836r2_0x5F_wasm_apply_data_relocs_0(w2c_s836r2*);
static u32 w2c_s836r2_func_1_0(w2c_s836r2*);
static void w2c_s836r2_crc32_gentab(w2c_s836r2*, u32);
static u32 w2c_s836r2_set_var(w2c_s836r2*, u32, u32, u32);
static void w2c_s836r2_transparent_crc(w2c_s836r2*, u32, u32, u32, u32, u32);
static void w2c_s836r2_call_cb_0(w2c_s836r2*, u32);
static void w2c_s836r2_crc32_8bytes(w2c_s836r2*, u32, u32, u32);
static void w2c_s836r2_crc32_byte(w2c_s836r2*, u32, u32, u32);

FUNC_TYPE_T(w2c_s836r2_t0) = "\x89\x3a\x3d\x2c\x8f\x4d\x7f\x6d\x6c\x9d\x62\x67\x29\xaf\x3d\x44\x39\x8e\xc3\xf3\xe8\x51\xc1\x99\xb9\xdd\x9f\xd5\x3d\x1f\xd3\xe4";
FUNC_TYPE_T(w2c_s836r2_t1) = "\x36\xa9\xe7\xf1\xc9\x5b\x82\xff\xb9\x97\x43\xe0\xc5\xc4\xce\x95\xd8\x3c\x9a\x43\x0a\xac\x59\xf8\x4e\xf3\xcb\xfa\xb6\x14\x50\x68";
FUNC_TYPE_T(w2c_s836r2_t2) = "\x78\xde\x71\xb6\x49\x9a\x33\x9d\xd3\x70\x88\x4c\x50\xd4\xea\xdf\xe1\x2a\x18\x12\xf6\xf3\x64\xf7\xea\x4f\x94\x19\xa7\x20\x28\xe8";
FUNC_TYPE_T(w2c_s836r2_t3) = "\x72\xab\x00\xdf\x20\x3d\xce\xa1\xf2\x29\xc7\x9d\x13\x40\x7e\x98\xac\x7d\x41\x4a\x53\x2e\x42\x42\x61\x55\x2e\xaa\xeb\xbe\xc6\x35";
FUNC_TYPE_T(w2c_s836r2_t4) = "\xcd\xad\x8f\x6a\xaf\x3e\xd0\x86\xf0\x9a\xd7\xf0\xc7\x0d\x48\x9f\x27\x59\xf3\x8d\x71\xa1\x81\xa8\xcc\x06\x53\x98\x62\x34\xaa\xf5";
FUNC_TYPE_T(w2c_s836r2_t5) = "\x10\x14\x42\x90\xbf\xa8\x37\x8c\xdc\x81\x9f\x4c\x63\x4e\x62\xb7\x11\x29\xaa\x09\x68\x89\x5f\x5e\x13\x9c\xcc\xe2\xcb\x51\x7a\x78";

static void init_globals(w2c_s836r2* instance) {
}

static const u8 data_segment_data_w2c_s836r2_0x2Erodata[] = {
...
static void init_memories(w2c_s836r2* instance) {
  LOAD_DATA((*instance->w2c_env_memory), (*instance->w2c_env_0x5F_memory_base), data_segment_data_w2c_s836r2_0x2Erodata, 38);
}

static void init_data_instances(w2c_s836r2 *instance) {
}

static void init_tables(w2c_s836r2* instance) {
}

/* export: '__wasm_call_ctors' */
void w2c_s836r2_0x5F_wasm_call_ctors(w2c_s836r2* instance) {
  return w2c_s836r2_0x5F_wasm_call_ctors_0(instance);
}

/* export: '__wasm_apply_data_relocs' */
void w2c_s836r2_0x5F_wasm_apply_data_relocs(w2c_s836r2* instance) {
  return w2c_s836r2_0x5F_wasm_apply_data_relocs_0(instance);
}

/* export: 'func_1' */
u32 w2c_s836r2_func_1(w2c_s836r2* instance) {
  return w2c_s836r2_func_1_0(instance);
}

/* export: 'call_cb' */
void w2c_s836r2_call_cb(w2c_s836r2* instance, u32 var_p0) {
  return w2c_s836r2_call_cb_0(instance, var_p0);
}

static void init_instance_import(w2c_s836r2* instance, struct w2c_env* w2c_env_instance){
...
const u32 wasm2c_s836r2_min_env_0x5F_indirect_function_table = 0;
const u32 wasm2c_s836r2_max_env_0x5F_indirect_function_table = 4294967295;
const u64 wasm2c_s836r2_min_env_memory = 1;
const u64 wasm2c_s836r2_max_env_memory = 65536;
const u8 wasm2c_s836r2_is64_env_memory = 0;

void wasm2c_s836r2_instantiate(w2c_s836r2* instance, struct w2c_env* w2c_env_instance) {
...
void wasm2c_s836r2_free(w2c_s836r2* instance) {
}

wasm_rt_func_type_t wasm2c_s836r2_get_func_type(uint32_t param_count, uint32_t result_count, ...) {
  va_list args;
...
void w2c_s836r2_0x5F_wasm_call_ctors_0(w2c_s836r2* instance) {
  FUNC_PROLOGUE;
  FUNC_EPILOGUE;
}

void w2c_s836r2_0x5F_wasm_apply_data_relocs_0(w2c_s836r2* instance) {
  FUNC_PROLOGUE;
  FUNC_EPILOGUE;
}

u32 w2c_s836r2_func_1_0(w2c_s836r2* instance) {
  ...
  var_l6 = var_i0;
  var_i0 = var_l6;
  w2c_s836r2_crc32_gentab(instance, var_i0);
  var_i0 = 992394718u;
  var_l7 = var_i0;
  var_i0 = var_l2;
  var_i1 = var_l7;
  ...
  var_i1 = var_l96;
  var_i2 = var_l93;
  var_i0 = w2c_s836r2_set_var(instance, var_i0, var_i1, var_i2);
  var_l97 = var_i0;
  var_i0 = 1056u;
  var_l98 = var_i0;
  var_i0 = var_l2;
...
void w2c_s836r2_crc32_gentab(w2c_s836r2* instance, u32 var_p0) {
...
u32 w2c_s836r2_set_var(w2c_s836r2* instance, u32 var_p0, u32 var_p1, u32 var_p2) {
  ...
  var_i3 = var_l8;
  var_i4 = var_l9;
  w2c_s836r2_transparent_crc(instance, var_i0, var_i1, var_i2, var_i3, var_i4);
  var_i0 = var_l5;
  var_i0 = i32_load(instance->w2c_env_memory, (u64)(var_i0) + 8u);
  var_l14 = var_i0;
  var_i0 = var_l14;
...
void w2c_s836r2_transparent_crc(w2c_s836r2* instance, u32 var_p0, u32 var_p1, u32 var_p2, u32 var_p3, u32 var_p4) {
  ...
  var_i1 = var_l9;
  var_i2 = var_l10;
  w2c_s836r2_crc32_8bytes(instance, var_i0, var_i1, var_i2);
  var_i0 = 32u;
  var_l11 = var_i0;
  var_i0 = var_l7;
  var_i1 = var_l11;
...
void w2c_s836r2_call_cb_0(w2c_s836r2* instance, u32 var_p0) {
  u32 var_l1 = 0, var_l2 = 0, var_l3 = 0, var_l4 = 0, var_l5 = 0, var_l6 = 0, var_l7 = 0, var_l8 = 0, 
      var_l9 = 0;
  FUNC_PROLOGUE;
  u32 var_i0, var_i1;
  ...
  var_i0 = var_l7;
  var_i1 = var_l4;
  CALL_INDIRECT((*instance->w2c_env_0x5F_indirect_function_table), void (*)(void*, u32), w2c_s836r2_t0, var_i1, (*instance->w2c_env_0x5F_indirect_function_table).data[var_i1].module_instance, var_i0);
  var_i0 = 16u;
  var_l8 = var_i0;
  var_i0 = var_l3;
  var_i1 = var_l8;
...
void w2c_s836r2_crc32_8bytes(w2c_s836r2* instance, u32 var_p0, u32 var_p1, u32 var_p2) {
  u32 var_l3 = 0, var_l4 = 0, var_l5 = 0, var_l6 = 0, var_l7 = 0, var_l8 = 0, var_l9 = 0, var_l10 = 0, 
      var_l11 = 0, var_l12 = 0, var_l13 = 0, var_l14 = 0, var_l15 = 0, var_l16 = 0, var_l17 = 0, var_l18 = 0, 
  ...
  var_i1 = var_l11;
  var_i2 = var_l12;
  w2c_s836r2_crc32_byte(instance, var_i0, var_i1, var_i2);
  var_i0 = var_l5;
  var_i0 = i32_load(instance->w2c_env_memory, (u64)(var_i0) + 12u);
  var_l15 = var_i0;
  var_i0 = 8u;
...
void w2c_s836r2_crc32_byte(w2c_s836r2* instance, u32 var_p0, u32 var_p1, u32 var_p2) {
  u32 var_l3 = 0, var_l4 = 0, var_l5 = 0, var_l6 = 0, var_l7 = 0, var_l8 = 0, var_l9 = 0, var_l10 = 0, 
      var_l11 = 0, var_l12 = 0, var_l13 = 0, var_l14 = 0, var_l15 = 0, var_l16 = 0, var_l17 = 0, var_l18 = 0, 
      var_l19 = 0, var_l20 = 0, var_l21 = 0, var_l22 = 0, var_l23 = 0, var_l24 = 0, var_l25 = 0, var_l26 = 0;
  FUNC_PROLOGUE;
