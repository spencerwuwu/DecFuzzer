...
static void w2c_s659retdec_0x5F_wasm_call_ctors_0(w2c_s659retdec*);
static void w2c_s659retdec_0x5F_wasm_apply_data_relocs_0(w2c_s659retdec*);
static u32 w2c_s659retdec_func_1_0(w2c_s659retdec*);
static void w2c_s659retdec_crc32_gentab(w2c_s659retdec*, u32);
static void w2c_s659retdec_call_cb_0(w2c_s659retdec*, u32);

FUNC_TYPE_T(w2c_s659retdec_t0) = "\x89\x3a\x3d\x2c\x8f\x4d\x7f\x6d\x6c\x9d\x62\x67\x29\xaf\x3d\x44\x39\x8e\xc3\xf3\xe8\x51\xc1\x99\xb9\xdd\x9f\xd5\x3d\x1f\xd3\xe4";
FUNC_TYPE_T(w2c_s659retdec_t1) = "\x36\xa9\xe7\xf1\xc9\x5b\x82\xff\xb9\x97\x43\xe0\xc5\xc4\xce\x95\xd8\x3c\x9a\x43\x0a\xac\x59\xf8\x4e\xf3\xcb\xfa\xb6\x14\x50\x68";
FUNC_TYPE_T(w2c_s659retdec_t2) = "\x72\xab\x00\xdf\x20\x3d\xce\xa1\xf2\x29\xc7\x9d\x13\x40\x7e\x98\xac\x7d\x41\x4a\x53\x2e\x42\x42\x61\x55\x2e\xaa\xeb\xbe\xc6\x35";

static void init_globals(w2c_s659retdec* instance) {
}

static const u8 data_segment_data_w2c_s659retdec_0x2Erodata[] = {
...
static void init_memories(w2c_s659retdec* instance) {
  LOAD_DATA((*instance->w2c_env_memory), (*instance->w2c_env_0x5F_memory_base), data_segment_data_w2c_s659retdec_0x2Erodata, 34);
}

static void init_data_instances(w2c_s659retdec *instance) {
}

static void init_tables(w2c_s659retdec* instance) {
}

/* export: '__wasm_call_ctors' */
void w2c_s659retdec_0x5F_wasm_call_ctors(w2c_s659retdec* instance) {
  return w2c_s659retdec_0x5F_wasm_call_ctors_0(instance);
}

/* export: '__wasm_apply_data_relocs' */
void w2c_s659retdec_0x5F_wasm_apply_data_relocs(w2c_s659retdec* instance) {
  return w2c_s659retdec_0x5F_wasm_apply_data_relocs_0(instance);
}

/* export: 'func_1' */
u32 w2c_s659retdec_func_1(w2c_s659retdec* instance) {
  return w2c_s659retdec_func_1_0(instance);
}

/* export: 'call_cb' */
void w2c_s659retdec_call_cb(w2c_s659retdec* instance, u32 var_p0) {
  return w2c_s659retdec_call_cb_0(instance, var_p0);
}

static void init_instance_import(w2c_s659retdec* instance, struct w2c_env* w2c_env_instance){
...
const u32 wasm2c_s659retdec_min_env_0x5F_indirect_function_table = 0;
const u32 wasm2c_s659retdec_max_env_0x5F_indirect_function_table = 4294967295;
const u64 wasm2c_s659retdec_min_env_memory = 1;
const u64 wasm2c_s659retdec_max_env_memory = 65536;
const u8 wasm2c_s659retdec_is64_env_memory = 0;

void wasm2c_s659retdec_instantiate(w2c_s659retdec* instance, struct w2c_env* w2c_env_instance) {
...
void wasm2c_s659retdec_free(w2c_s659retdec* instance) {
}

wasm_rt_func_type_t wasm2c_s659retdec_get_func_type(uint32_t param_count, uint32_t result_count, ...) {
  va_list args;
...
void w2c_s659retdec_0x5F_wasm_call_ctors_0(w2c_s659retdec* instance) {
  FUNC_PROLOGUE;
  FUNC_EPILOGUE;
}

void w2c_s659retdec_0x5F_wasm_apply_data_relocs_0(w2c_s659retdec* instance) {
  FUNC_PROLOGUE;
  FUNC_EPILOGUE;
}

u32 w2c_s659retdec_func_1_0(w2c_s659retdec* instance) {
  ...
  var_l6 = var_i0;
  var_i0 = var_l6;
  w2c_s659retdec_crc32_gentab(instance, var_i0);
  var_i0 = 1u;
  var_l7 = var_i0;
  var_i0 = var_l2;
  var_i1 = var_l7;
...
void w2c_s659retdec_crc32_gentab(w2c_s659retdec* instance, u32 var_p0) {
...
void w2c_s659retdec_call_cb_0(w2c_s659retdec* instance, u32 var_p0) {
  u32 var_l1 = 0, var_l2 = 0, var_l3 = 0, var_l4 = 0, var_l5 = 0, var_l6 = 0, var_l7 = 0, var_l8 = 0, 
      var_l9 = 0;
  FUNC_PROLOGUE;
  u32 var_i0, var_i1;
  ...
  var_i0 = var_l7;
  var_i1 = var_l4;
  CALL_INDIRECT((*instance->w2c_env_0x5F_indirect_function_table), void (*)(void*, u32), w2c_s659retdec_t0, var_i1, (*instance->w2c_env_0x5F_indirect_function_table).data[var_i1].module_instance, var_i0);
  var_i0 = 16u;
  var_l8 = var_i0;
  var_i0 = var_l3;
  var_i1 = var_l8;
