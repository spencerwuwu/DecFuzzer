...
#include "s124retdec.w2c2.h"

void f0(s124retdecInstance*i) {
L0:;
}

void f1(s124retdecInstance*i) {
L0:;
}

U32 f2(s124retdecInstance*i) {
U32 l0=0;
U32 l1=0;
U32 l2=0;
U32 l3=0;
...
void f3(s124retdecInstance*i,U32 l0) {
U32 l1=0;
U32 l2=0;
U32 l3=0;
U32 l4=0;
...
void f4(s124retdecInstance*i,U32 l0) {
U32 l1=0;
U32 l2=0;
U32 l3=0;
U32 l4=0;
...
si0=l7;
si1=l4;
TF((*i->env_____indirect_function_table),si1,void (*)(s124retdecInstance*,U32))(i,si0);
si0=16U;
l8=si0;
si0=l3;
si1=l8;
...
static void s124retdecInitImports(s124retdecInstance* i, void* resolve(const char* module, const char* name)) {
...
void s124retdecInstantiate(s124retdecInstance* i, void* resolve(const char* module, const char* name)) {
s124retdecInitImports(i, resolve);
}

void s124retdecFreeInstance(s124retdecInstance* i) {
}
