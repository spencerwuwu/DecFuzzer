...
void f0(s8r2Instance*i) {
L0:;
}

void f1(s8r2Instance*i) {
L0:;
}

U32 f2(s8r2Instance*i) {
U32 l0=0;
U32 l1=0;
U32 l2=0;
U32 l3=0;
...
si0=l7;
si1=l4;
TF((*i->env_____indirect_function_table),si1,void (*)(s8r2Instance*,U32))(i,si0);
si0=16U;
l8=si0;
si0=l3;
si1=l8;
...
static void s8r2InitImports(s8r2Instance* i, void* resolve(const char* module, const char* name)) {
...
void s8r2Instantiate(s8r2Instance* i, void* resolve(const char* module, const char* name)) {
s8r2InitImports(i, resolve);
}

void s8r2FreeInstance(s8r2Instance* i) {
}
