...
#include "s247r2.w2c2.h"

void f0(s247r2Instance*i) {
L0:;
}

void f1(s247r2Instance*i) {
L0:;
}

U32 f2(s247r2Instance*i) {
U32 l0=0;
U32 l1=0;
U32 l2=0;
U32 l3=0;
...
void f3(s247r2Instance*i,U32 l0) {
U32 l1=0;
U32 l2=0;
U32 l3=0;
U32 l4=0;
...
void f4(s247r2Instance*i,U32 l0) {
U32 l1=0;
U32 l2=0;
U32 l3=0;
U32 l4=0;
...
si0=l7;
si1=l4;
TF((*i->env_____indirect_function_table),si1,void (*)(s247r2Instance*,U32))(i,si0);
si0=16U;
l8=si0;
si0=l3;
si1=l8;
...
static void s247r2InitImports(s247r2Instance* i, void* resolve(const char* module, const char* name)) {
...
void s247r2Instantiate(s247r2Instance* i, void* resolve(const char* module, const char* name)) {
s247r2InitImports(i, resolve);
}

void s247r2FreeInstance(s247r2Instance* i) {
}
