...
#include "s783r2.w2c2.h"

void f0(s783r2Instance*i) {
L0:;
}

void f1(s783r2Instance*i) {
L0:;
}

U32 f2(s783r2Instance*i) {
U32 l0=0;
U32 l1=0;
U32 l2=0;
U32 l3=0;
...
void f3(s783r2Instance*i,U32 l0) {
U32 l1=0;
U32 l2=0;
U32 l3=0;
U32 l4=0;
...
void f4(s783r2Instance*i,U32 l0) {
U32 l1=0;
U32 l2=0;
U32 l3=0;
U32 l4=0;
...
si0=l7;
si1=l4;
TF((*i->env_____indirect_function_table),si1,void (*)(s783r2Instance*,U32))(i,si0);
si0=16U;
l8=si0;
si0=l3;
si1=l8;
...
static void s783r2InitImports(s783r2Instance* i, void* resolve(const char* module, const char* name)) {
...
void s783r2____wasm_call_ctors(s783r2Instance*i){
f0(i);
}

void s783r2____wasm_apply_data_relocs(s783r2Instance*i){
f1(i);
}

U32 s783r2_func_1(s783r2Instance*i){
return f2(i);
}

void s783r2_call_cb(s783r2Instance*i,U32 l0){
f4(i,l0);
}

void s783r2Instantiate(s783r2Instance* i, void* resolve(const char* module, const char* name)) {
s783r2InitImports(i, resolve);
}

void s783r2FreeInstance(s783r2Instance* i) {
}
