...
void f0(s4r2Instance*i) {
L0:;
}

void f1(s4r2Instance*i) {
L0:;
}

U32 f2(s4r2Instance*i) {
U32 l0=0;
U32 l1=0;
U32 l2=0;
U32 l3=0;
...
si0=l7;
si1=l4;
TF((*i->env_____indirect_function_table),si1,void (*)(s4r2Instance*,U32))(i,si0);
si0=16U;
l8=si0;
si0=l3;
si1=l8;
...
static void s4r2InitImports(s4r2Instance* i, void* resolve(const char* module, const char* name)) {
...
void s4r2Instantiate(s4r2Instance* i, void* resolve(const char* module, const char* name)) {
s4r2InitImports(i, resolve);
}

void s4r2FreeInstance(s4r2Instance* i) {
}
