...
#include "s824r2.w2c2.h"

void f0(s824r2Instance*i) {
L0:;
}

void f1(s824r2Instance*i) {
L0:;
}

U32 f2(s824r2Instance*i) {
U32 l0=0;
U32 l1=0;
U32 l2=0;
U32 l3=0;
...
void f3(s824r2Instance*i,U32 l0) {
U32 l1=0;
U32 l2=0;
U32 l3=0;
U32 l4=0;
...
void f4(s824r2Instance*i,U32 l0) {
U32 l1=0;
U32 l2=0;
U32 l3=0;
U32 l4=0;
...
si0=l7;
si1=l4;
TF((*i->env_____indirect_function_table),si1,void (*)(s824r2Instance*,U32))(i,si0);
si0=16U;
l8=si0;
si0=l3;
si1=l8;
...
static void s824r2InitImports(s824r2Instance* i, void* resolve(const char* module, const char* name)) {
...
void s824r2Instantiate(s824r2Instance* i, void* resolve(const char* module, const char* name)) {
s824r2InitImports(i, resolve);
}

void s824r2FreeInstance(s824r2Instance* i) {
}
