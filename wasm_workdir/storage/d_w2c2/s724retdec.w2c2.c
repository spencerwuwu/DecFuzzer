...
#include "s724retdec.w2c2.h"

void f0(s724retdecInstance*i) {
L0:;
}

void f1(s724retdecInstance*i) {
L0:;
}

U32 f2(s724retdecInstance*i) {
U32 l0=0;
U32 l1=0;
U32 l2=0;
U32 l3=0;
...
void f3(s724retdecInstance*i,U32 l0) {
U32 l1=0;
U32 l2=0;
U32 l3=0;
U32 l4=0;
...
void f4(s724retdecInstance*i,U32 l0) {
U32 l1=0;
U32 l2=0;
U32 l3=0;
U32 l4=0;
...
si0=l7;
si1=l4;
TF((*i->env_____indirect_function_table),si1,void (*)(s724retdecInstance*,U32))(i,si0);
si0=16U;
l8=si0;
si0=l3;
si1=l8;
...
static void s724retdecInitImports(s724retdecInstance* i, void* resolve(const char* module, const char* name)) {
...
void s724retdecInstantiate(s724retdecInstance* i, void* resolve(const char* module, const char* name)) {
s724retdecInitImports(i, resolve);
}

void s724retdecFreeInstance(s724retdecInstance* i) {
}
