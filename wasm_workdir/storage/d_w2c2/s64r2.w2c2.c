...
#include "s64r2.w2c2.h"

void f0(s64r2Instance*i) {
L0:;
}

void f1(s64r2Instance*i) {
L0:;
}

U32 f2(s64r2Instance*i) {
U32 l0=0;
U32 l1=0;
U32 l2=0;
U32 l3=0;
...
void f3(s64r2Instance*i,U32 l0) {
U32 l1=0;
U32 l2=0;
U32 l3=0;
U32 l4=0;
...
void f4(s64r2Instance*i,U32 l0) {
U32 l1=0;
U32 l2=0;
U32 l3=0;
U32 l4=0;
...
si0=l7;
si1=l4;
TF((*i->env_____indirect_function_table),si1,void (*)(s64r2Instance*,U32))(i,si0);
si0=16U;
l8=si0;
si0=l3;
si1=l8;
...
static void s64r2InitImports(s64r2Instance* i, void* resolve(const char* module, const char* name)) {
...
void s64r2Instantiate(s64r2Instance* i, void* resolve(const char* module, const char* name)) {
s64r2InitImports(i, resolve);
}

void s64r2FreeInstance(s64r2Instance* i) {
}
