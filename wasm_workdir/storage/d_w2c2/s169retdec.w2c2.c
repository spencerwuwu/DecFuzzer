...
#include "s169retdec.w2c2.h"

void f0(s169retdecInstance*i) {
L0:;
}

void f1(s169retdecInstance*i) {
L0:;
}

U32 f2(s169retdecInstance*i) {
U32 l0=0;
U32 l1=0;
U32 l2=0;
U32 l3=0;
...
void f3(s169retdecInstance*i,U32 l0) {
U32 l1=0;
U32 l2=0;
U32 l3=0;
U32 l4=0;
...
void f4(s169retdecInstance*i,U32 l0) {
U32 l1=0;
U32 l2=0;
U32 l3=0;
U32 l4=0;
...
si0=l7;
si1=l4;
TF((*i->env_____indirect_function_table),si1,void (*)(s169retdecInstance*,U32))(i,si0);
si0=16U;
l8=si0;
si0=l3;
si1=l8;
...
static void s169retdecInitImports(s169retdecInstance* i, void* resolve(const char* module, const char* name)) {
...
void s169retdecInstantiate(s169retdecInstance* i, void* resolve(const char* module, const char* name)) {
s169retdecInitImports(i, resolve);
}

void s169retdecFreeInstance(s169retdecInstance* i) {
}
