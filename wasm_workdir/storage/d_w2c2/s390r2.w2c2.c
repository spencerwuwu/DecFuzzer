...
#include "s390r2.w2c2.h"

void f0(s390r2Instance*i) {
L0:;
}

void f1(s390r2Instance*i) {
L0:;
}

U32 f2(s390r2Instance*i) {
U32 l0=0;
U32 l1=0;
U32 l2=0;
U32 l3=0;
...
void f3(s390r2Instance*i,U32 l0) {
U32 l1=0;
U32 l2=0;
U32 l3=0;
U32 l4=0;
...
U32 f4(s390r2Instance*i,U32 l0,U32 l1,U32 l2,U32 l3,U32 l4,U32 l5,U32 l6) {
U32 l7=0;
U32 l8=0;
U32 l9=0;
U32 l10=0;
...
void f5(s390r2Instance*i,U32 l0,U32 l1,U32 l2,U32 l3,U32 l4) {
U32 l5=0;
U32 l6=0;
U32 l7=0;
U32 l8=0;
...
void f6(s390r2Instance*i,U32 l0) {
U32 l1=0;
U32 l2=0;
U32 l3=0;
U32 l4=0;
...
si0=l7;
si1=l4;
TF((*i->env_____indirect_function_table),si1,void (*)(s390r2Instance*,U32))(i,si0);
si0=16U;
l8=si0;
si0=l3;
si1=l8;
...
void f7(s390r2Instance*i,U32 l0,U32 l1,U32 l2) {
U32 l3=0;
U32 l4=0;
U32 l5=0;
U32 l6=0;
...
void f8(s390r2Instance*i,U32 l0,U32 l1,U32 l2) {
U32 l3=0;
U32 l4=0;
U32 l5=0;
U32 l6=0;
...
static void s390r2InitImports(s390r2Instance* i, void* resolve(const char* module, const char* name)) {
...
void s390r2Instantiate(s390r2Instance* i, void* resolve(const char* module, const char* name)) {
s390r2InitImports(i, resolve);
}

void s390r2FreeInstance(s390r2Instance* i) {
}
