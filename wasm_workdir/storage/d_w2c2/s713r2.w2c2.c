...
#include "s713r2.w2c2.h"

void f0(s713r2Instance*i) {
L0:;
}

void f1(s713r2Instance*i) {
L0:;
}

U32 f2(s713r2Instance*i) {
U32 l0=0;
U32 l1=0;
U32 l2=0;
U32 l3=0;
...
void f3(s713r2Instance*i,U32 l0) {
U32 l1=0;
U32 l2=0;
U32 l3=0;
U32 l4=0;
...
void f4(s713r2Instance*i,U32 l0) {
U32 l1=0;
U32 l2=0;
U32 l3=0;
U32 l4=0;
...
si0=l7;
si1=l4;
TF((*i->env_____indirect_function_table),si1,void (*)(s713r2Instance*,U32))(i,si0);
si0=16U;
l8=si0;
si0=l3;
si1=l8;
...
static void s713r2InitImports(s713r2Instance* i, void* resolve(const char* module, const char* name)) {
...
void s713r2Instantiate(s713r2Instance* i, void* resolve(const char* module, const char* name)) {
s713r2InitImports(i, resolve);
}

void s713r2FreeInstance(s713r2Instance* i) {
}
