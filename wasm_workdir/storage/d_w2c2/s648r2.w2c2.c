...
#include "s648r2.w2c2.h"

void f0(s648r2Instance*i) {
L0:;
}

void f1(s648r2Instance*i) {
L0:;
}

U32 f2(s648r2Instance*i) {
U32 l0=0;
U32 l1=0;
U32 l2=0;
U32 l3=0;
...
void f3(s648r2Instance*i,U32 l0) {
U32 l1=0;
U32 l2=0;
U32 l3=0;
U32 l4=0;
...
void f4(s648r2Instance*i,U32 l0) {
U32 l1=0;
U32 l2=0;
U32 l3=0;
U32 l4=0;
...
si0=l7;
si1=l4;
TF((*i->env_____indirect_function_table),si1,void (*)(s648r2Instance*,U32))(i,si0);
si0=16U;
l8=si0;
si0=l3;
si1=l8;
...
static void s648r2InitImports(s648r2Instance* i, void* resolve(const char* module, const char* name)) {
...
void s648r2Instantiate(s648r2Instance* i, void* resolve(const char* module, const char* name)) {
s648r2InitImports(i, resolve);
}

void s648r2FreeInstance(s648r2Instance* i) {
}
