...
#include "s783retdec.w2c2.h"

void f0(s783retdecInstance*i) {
L0:;
}

void f1(s783retdecInstance*i) {
L0:;
}

U32 f2(s783retdecInstance*i) {
U32 l0=0;
U32 l1=0;
U32 l2=0;
U32 l3=0;
...
void f3(s783retdecInstance*i,U32 l0) {
U32 l1=0;
U32 l2=0;
U32 l3=0;
U32 l4=0;
...
void f4(s783retdecInstance*i,U32 l0) {
U32 l1=0;
U32 l2=0;
U32 l3=0;
U32 l4=0;
...
si0=l7;
si1=l4;
TF((*i->env_____indirect_function_table),si1,void (*)(s783retdecInstance*,U32))(i,si0);
si0=16U;
l8=si0;
si0=l3;
si1=l8;
...
static void s783retdecInitImports(s783retdecInstance* i, void* resolve(const char* module, const char* name)) {
...
void s783retdecInstantiate(s783retdecInstance* i, void* resolve(const char* module, const char* name)) {
s783retdecInitImports(i, resolve);
}

void s783retdecFreeInstance(s783retdecInstance* i) {
}
