...
#include "s373retdec.w2c2.h"

void f0(s373retdecInstance*i) {
L0:;
}

void f1(s373retdecInstance*i) {
L0:;
}

U32 f2(s373retdecInstance*i) {
U32 l0=0;
U32 l1=0;
U32 l2=0;
U32 l3=0;
...
void f3(s373retdecInstance*i,U32 l0) {
U32 l1=0;
U32 l2=0;
U32 l3=0;
U32 l4=0;
...
U32 f4(s373retdecInstance*i,U32 l0,U32 l1,U32 l2,U32 l3,U32 l4,U32 l5,U32 l6) {
U32 l7=0;
U32 l8=0;
U32 l9=0;
U32 l10=0;
...
void f5(s373retdecInstance*i,U32 l0,U32 l1,U32 l2,U32 l3,U32 l4) {
U32 l5=0;
U32 l6=0;
U32 l7=0;
U32 l8=0;
...
void f6(s373retdecInstance*i,U32 l0) {
U32 l1=0;
U32 l2=0;
U32 l3=0;
U32 l4=0;
...
si0=l7;
si1=l4;
TF((*i->env_____indirect_function_table),si1,void (*)(s373retdecInstance*,U32))(i,si0);
si0=16U;
l8=si0;
si0=l3;
si1=l8;
...
void f7(s373retdecInstance*i,U32 l0,U32 l1,U32 l2) {
U32 l3=0;
U32 l4=0;
U32 l5=0;
U32 l6=0;
...
void f8(s373retdecInstance*i,U32 l0,U32 l1,U32 l2) {
U32 l3=0;
U32 l4=0;
U32 l5=0;
U32 l6=0;
...
const U8 d0[]={
0x44,0x75,0x6d,0x6d,0x79,0x20,0x66,0x6f,0x72,0x20,0x69,0x6e,0x64,0x69,0x72,0x65,0x63,0x74,0x20,0x66,0x75,0x6e,0x63,0x74,0x69,0x6f,0x6e,0x20,0x74,0x61,0x62,0x6c,0x65,0x0,0x67,0x5f,0x33,0x36,0x0,0x67,0x5f,0x33,0x34,0x0,0x67,0x5f,0x32,0x0,0x67,0x5f,0x33,0x31,0x0,0x67,0x5f,0x31,0x31,0x0,
};

static void s373retdecInitImports(s373retdecInstance* i, void* resolve(const char* module, const char* name)) {
...
void s373retdecInstantiate(s373retdecInstance* i, void* resolve(const char* module, const char* name)) {
s373retdecInitImports(i, resolve);
}

void s373retdecFreeInstance(s373retdecInstance* i) {
}
