 ...
 */
static int32_t  func_1(void)
{    unsigned int stack0xfffffff4, unique0x00007a80;
    ...
    var_1h = 'S';
    for (stack0xfffffff4 = -0x12; stack0xfffffff4 < -10; unique0x00007a80 = stack0xfffffff4 + 6) {
        var_1h = '\x01';
    }
    set_var(0xfffffff8, 0xde0b4073, var_1h, 0x5cf1c946, 0x17f4039d);
