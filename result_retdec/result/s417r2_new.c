...
int64_t g1 = 0; // 0x3fe0
int32_t g2 = 0x76ec7516; // 0x4020
int32_t g3 = -10; // 0x4024
int32_t g4 = 0x7c7ab89b; // 0x4028
int32_t g5 = 0x42ff18c9; // 0x402c
int32_t g6 = 206; // 0x4030
int32_t g7 = -1; // 0x4034
char g8 = 0; // 0x4040
...
int32_t __libc_start_main(int64_t a1, int32_t a2, char ** a3, void (*a4)(), void (*a5)(), void (*a6)());
    ...
    // 0x12f0
    set_var(0x76ec7516, -10, 0x7c7ab89b, 0x42ff18c9, -50);
    return 0x7d37;
}
