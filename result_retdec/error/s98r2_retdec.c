...
// Address range: 0x804a347 - 0x804a387
int32_t set_var(int32_t a1, int32_t a2, int32_t a3, int32_t a4, int16_t a5, char a6, int32_t a7, char a8, int32_t a9) {
    // 0x804a347
    int32_t v1; // 0x804a347
    int32_t v2 = __x86_get_pc_thunk_ax(v1); // 0x804a34d
    *(int32_t *)(v2 + 0x2cc6) = a1;
    *(char *)(v2 + 0x30f2) = (char)a2;
    *(char *)(v2 + 0x2cca) = (char)a3;
    return 0;
}

// Address range: 0x804a387 - 0x804a40a
int32_t func_1(void) {
    // 0x804a387
    int32_t v1; // 0x804a387
    __x86_get_pc_thunk_ax(v1);
    set_var(-1, 0, 1, 0, 0, -114, 1, 0, -1);
    return 0;
}

// Address range: 0x804a40a - 0x804a4ec
int main(int argc, char ** argv) {
    // 0x804a40a
    int32_t v1; // 0x804a40a
    int32_t v2 = v1;
    char ** v3 = argv;
    __x86_get_pc_thunk_bx((int32_t)&v3);
    int32_t v4 = 0; // 0x804a433
    if (v3 == (char **)2) {
        int32_t str = *(int32_t *)(v1 + 4); // 0x804a43b
        v4 = strcmp((char *)str, (char *)(v2 + 3135)) == 0;
    }
    // 0x804a45b
    platform_main_begin();
    crc32_gentab();
    func_1();
    transparent_crc(*(int32_t *)(v2 + 0x2bf7), v2 + 3137, v4);
    transparent_crc((int32_t)*(char *)(v2 + 0x3023), v2 + 3141, v4);
    transparent_crc((int32_t)*(char *)(v2 + 0x2bfb), v2 + 3145, v4);
    platform_main_end(-1 - *(int32_t *)(v2 + 0x2bf3));
    return 0;
}

// Address range: 0x804a4ec - 0x804a4f0
int32_t __x86_get_pc_thunk_ax(int32_t result) {
    // 0x804a4ec
    return result;
}
