...
int32_t set_var(int32_t a1, int32_t a2, int32_t a3, int16_t a4) {
    ...
    *(int16_t *)(v2 + 0x2cc6) = (int16_t)a2;
    return 0;
}

// Address range: 0x804a379 - 0x804a3c0
int32_t func_1(void) {
    // 0x804a379
...
// Address range: 0x804a3c0 - 0x804a482
int main(int argc, char ** argv) {
    ...
    int32_t v4 = 0; // 0x804a3e9
    if (v3 == (char **)2) {
        int32_t str = *(int32_t *)(v1 + 4); // 0x804a3f1
        v4 = strcmp((char *)str, (char *)(v2 + 3209)) == 0;
    }
    // 0x804a411
    platform_main_begin();
    crc32_gentab();
    func_1();
    transparent_crc(*(int32_t *)(v2 + 0x306d), v2 + 3211, v4);
    transparent_crc((int32_t)*(int16_t *)(v2 + 0x2c41), v2 + 3215, v4);
    platform_main_end(-1 - *(int32_t *)(v2 + 0x2c3d));
    return 0;
}

// Address range: 0x804a482 - 0x804a486
int32_t __x86_get_pc_thunk_ax(int32_t result) {
    // 0x804a482
    return result;
}
