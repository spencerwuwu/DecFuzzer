...
// Address range: 0x804a377 - 0x804a420
int32_t func_1(void) {
    // 0x804a377
...
// Address range: 0x804a420 - 0x804a4e2
int main(int argc, char ** argv) {
    ...
    int32_t v4 = 0; // 0x804a449
    if (v3 == (char **)2) {
        int32_t str = *(int32_t *)(v1 + 4); // 0x804a451
        v4 = strcmp((char *)str, (char *)(v2 + 3113)) == 0;
    }
    // 0x804a471
    platform_main_begin();
    crc32_gentab();
    func_1();
    transparent_crc((int32_t)*(char *)(v2 + 0x2be1), v2 + 3115, v4);
    transparent_crc(*(int32_t *)(v2 + 0x2be5), v2 + 3119, v4);
    platform_main_end(-1 - *(int32_t *)(v2 + 0x2bdd));
    return 0;
}

// Address range: 0x804a4e2 - 0x804a4e6
int32_t __x86_get_pc_thunk_ax(int32_t result) {
    // 0x804a4e2
    return result;
}
