...
int32_t set_var(int32_t a1, int32_t a2, int32_t a3, char a4) {
    ...
    *(char *)(__x86_get_pc_thunk_ax(v1) + 0x30f2) = (char)a1;
    return 0;
}

// Address range: 0x804a36e - 0x804a3e6
int32_t func_1(void) {
    // 0x804a36e
...
// Address range: 0x804a3e6 - 0x804a48c
int main(int argc, char ** argv) {
    ...
    crc32_gentab();
    func_1();
    transparent_crc((int32_t)*(char *)(v2 + 0x3047), v2 + 3173, v4);
