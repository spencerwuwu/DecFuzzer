...
// Address range: 0x804a392 - 0x804a500
int32_t func_1(void) {
    // 0x804a4fb
...
// Address range: 0x804a500 - 0x804a61a
int main(int argc, char ** argv) {
    // 0x804a500
    int32_t v1; // 0x804a500
    int32_t v2 = v1;
    char ** v3 = argv;
    __x86_get_pc_thunk_bx((int32_t)&v3);
    int32_t v4 = 0; // 0x804a529
    if (v3 == (char **)2) {
        int32_t str = *(int32_t *)(v1 + 4); // 0x804a531
        v4 = strcmp((char *)str, (char *)(v2 + 2889)) == 0;
    }
    // 0x804a551
    platform_main_begin();
    crc32_gentab();
    func_1();
    transparent_crc(*(int32_t *)(v2 + 0x2b01), v2 + 2891, v4);
    transparent_crc((int32_t)*(char *)(v2 + 0x2f4d), v2 + 2895, v4);
    transparent_crc(*(int32_t *)(v2 + 0x2b05), v2 + 2900, v4);
    transparent_crc(*(int32_t *)(v2 + 0x2b09), v2 + 2905, v4);
    transparent_crc(*(int32_t *)(v2 + 0x2b0d), v2 + 2910, v4);
    platform_main_end(-1 - *(int32_t *)(v2 + 0x2afd));
    return 0;
}

// Address range: 0x804a61a - 0x804a61e
int32_t __x86_get_pc_thunk_ax(int32_t result) {
    // 0x804a61a
    return result;
}
