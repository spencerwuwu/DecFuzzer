...
int32_t set_var(int32_t a1, int32_t a2, int32_t a3, int32_t a4, char a5, int16_t a6, int16_t a7, int16_t a8, int16_t a9, int32_t a10) {
    ...
    *(int16_t *)(v2 + 0x30f1) = (int16_t)a3;
    return 0;
}

// Address range: 0x804a398 - 0x804a418
int32_t func_1(void) {
    // 0x804a398
...
// Address range: 0x804a418 - 0x804a4fc
int main(int argc, char ** argv) {
    // 0x804a418
    int32_t v1; // 0x804a418
    int32_t v2 = v1;
    char ** v3 = argv;
    __x86_get_pc_thunk_bx((int32_t)&v3);
    int32_t v4 = 0; // 0x804a441
    if (v3 == (char **)2) {
        int32_t str = *(int32_t *)(v1 + 4); // 0x804a449
        v4 = strcmp((char *)str, (char *)(v2 + 3121)) == 0;
    }
    // 0x804a469
    platform_main_begin();
    crc32_gentab();
    func_1();
    transparent_crc((int32_t)*(int16_t *)(v2 + 0x2be9), v2 + 3123, v4);
    transparent_crc((int32_t)*(int16_t *)(v2 + 0x2beb), v2 + 3127, v4);
    transparent_crc((int32_t)*(int16_t *)(v2 + 0x3015), v2 + 3132, v4);
    platform_main_end(-1 - *(int32_t *)(v2 + 0x2be5));
    return 0;
}

// Address range: 0x804a4fc - 0x804a500
int32_t __x86_get_pc_thunk_ax(int32_t result) {
    // 0x804a4fc
    return result;
}
