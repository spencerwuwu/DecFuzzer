...
int32_t set_var(int32_t a1, int32_t a2, int32_t a3, int32_t a4, int32_t a5, int32_t a6, int32_t a7, int32_t a8, int32_t a9) {
    ...
    *(int16_t *)(v2 + 0x2cc7) = (int16_t)a4;
    *(int16_t *)(v2 + 0x2cc9) = (int16_t)a5;
    *(int32_t *)(v2 + 0x3113) = a6;
    *(int32_t *)(v2 + 0x2ccb) = a7;
    return 0;
}

// Address range: 0x804a3cc - 0x804a618
int32_t func_1(void) {
    // 0x804a3cc
...
// Address range: 0x804a618 - 0x804a772
int main(int argc, char ** argv) {
    // 0x804a618
    int32_t v1; // 0x804a618
    int32_t v2 = v1;
    char ** v3 = argv;
    __x86_get_pc_thunk_bx((int32_t)&v3);
    int32_t v4 = 0; // 0x804a641
    if (v3 == (char **)2) {
        int32_t str = *(int32_t *)(v1 + 4); // 0x804a649
        v4 = strcmp((char *)str, (char *)(v2 + 2609)) == 0;
    }
    // 0x804a669
    platform_main_begin();
    crc32_gentab();
    func_1();
    transparent_crc((int32_t)*(char *)(v2 + 0x29e9), v2 + 2611, v4);
    transparent_crc((int32_t)*(int16_t *)(v2 + 0x29eb), v2 + 2615, v4);
    transparent_crc(*(int32_t *)(v2 + 0x2e35), v2 + 2620, v4);
    transparent_crc((int32_t)*(int16_t *)(v2 + 0x29ed), v2 + 2625, v4);
    transparent_crc((int32_t)*(int16_t *)(v2 + 0x29ef), v2 + 2630, v4);
    transparent_crc(*(int32_t *)(v2 + 0x2e39), v2 + 2635, v4);
    transparent_crc(*(int32_t *)(v2 + 0x29f1), v2 + 2640, v4);
    platform_main_end(-1 - *(int32_t *)(v2 + 0x29e5));
    return 0;
}
