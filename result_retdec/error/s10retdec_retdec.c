...
// Address range: 0x804a347 - 0x804a398
int32_t set_var(int32_t a1, int32_t a2, int32_t a3, int32_t a4, int32_t a5, int32_t a6, int32_t a7) {
    // 0x804a347
...
// Address range: 0x804a398 - 0x804a4f8
int32_t func_1(void) {
    // 0x804a398
    int32_t v1; // 0x804a398
    __x86_get_pc_thunk_ax(v1);
    set_var(0xfffb, 0x66f6, -1, 0, 0, 0, 0xfffb);
    return 0x66f6;
}

// Address range: 0x804a4f8 - 0x804a5dc
int main(int argc, char ** argv) {
    // 0x804a4f8
    int32_t v1; // 0x804a4f8
    int32_t v2 = v1;
    char ** v3 = argv;
    __x86_get_pc_thunk_bx((int32_t)&v3);
    int32_t v4 = 0; // 0x804a521
    if (v3 == (char **)2) {
        int32_t str = *(int32_t *)(v1 + 4); // 0x804a529
        v4 = strcmp((char *)str, (char *)(v2 + 2897)) == 0;
    }
    // 0x804a549
    platform_main_begin();
    crc32_gentab();
    func_1();
    transparent_crc((int32_t)*(int16_t *)(v2 + 0x2b09), v2 + 2899, v4);
    transparent_crc((int32_t)*(int16_t *)(v2 + 0x2b0b), v2 + 2903, v4);
    transparent_crc((int32_t)*(int16_t *)(v2 + 0x2b0d), v2 + 2907, v4);
    platform_main_end(-1 - *(int32_t *)(v2 + 0x2b05));
    return 0;
}

// Address range: 0x804a5dc - 0x804a5e0
int32_t __x86_get_pc_thunk_ax(int32_t result) {
    // 0x804a5dc
    return result;
}
