...
// Address range: 0x804a347 - 0x804a36e
int32_t set_var(int32_t a1, int32_t a2, int32_t a3, char a4, int32_t a5) {
    // 0x804a347
    int32_t v1; // 0x804a347
    *(char *)(__x86_get_pc_thunk_ax(v1) + 0x2cc6) = (char)a1;
    return 0;
}

// Address range: 0x804a36e - 0x804a3de
int32_t func_1(void) {
    // 0x804a36e
    int32_t v1; // 0x804a36e
    __x86_get_pc_thunk_ax(v1);
    set_var(-3, -0x17120e02, -20, -3, 0x37ad4351);
    return -3;
}

// Address range: 0x804a3de - 0x804a4a1
int main(int argc, char ** argv) {
    // 0x804a3de
    int32_t v1; // 0x804a3de
    int32_t v2 = v1;
    char ** v3 = argv;
    __x86_get_pc_thunk_bx((int32_t)&v3);
    int32_t v4 = 0; // 0x804a407
    if (v3 == (char **)2) {
        int32_t str = *(int32_t *)(v1 + 4); // 0x804a40f
        v4 = strcmp((char *)str, (char *)(v2 + 3183)) == 0;
    }
    // 0x804a42f
    platform_main_begin();
    crc32_gentab();
    func_1();
    transparent_crc(0x37ad4351, v2 + 3185, v4);
    transparent_crc((int32_t)*(char *)(v2 + 0x2c23), v2 + 3189, v4);
    platform_main_end(-1 - *(int32_t *)(v2 + 0x2c1f));
    return 0;
}

// Address range: 0x804a4a1 - 0x804a4a5
int32_t __x86_get_pc_thunk_ax(int32_t result) {
    // 0x804a4a1
    return result;
}
