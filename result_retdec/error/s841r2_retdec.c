...
// Address range: 0x804a394 - 0x804a43b
int32_t func_1(void) {
    // 0x804a394
...
// Address range: 0x804a43b - 0x804a539
int main(int argc, char ** argv) {
    // 0x804a43b
    int32_t v1; // 0x804a43b
    int32_t v2 = v1;
    char ** v3 = argv;
    __x86_get_pc_thunk_bx((int32_t)&v3);
    int32_t v4 = 0; // 0x804a464
    if (v3 == (char **)2) {
        int32_t str = *(int32_t *)(v1 + 4); // 0x804a46c
        v4 = strcmp((char *)str, (char *)(v2 + 3086)) == 0;
    }
    // 0x804a48c
    platform_main_begin();
    crc32_gentab();
    func_1();
    transparent_crc((int32_t)*(int16_t *)(v2 + 0x2bc6), v2 + 3088, v4);
    transparent_crc(*(int32_t *)(v2 + 0x2bca), v2 + 3092, v4);
    transparent_crc((int32_t)*(int16_t *)(v2 + 0x2bce), v2 + 3097, v4);
    transparent_crc(*(int32_t *)(v2 + 0x2bd2), v2 + 3102, v4);
    platform_main_end(-1 - *(int32_t *)(v2 + 0x2bc2));
    return 0;
}
