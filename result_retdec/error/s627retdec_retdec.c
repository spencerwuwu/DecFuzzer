...
// Address range: 0x804a379 - 0x804a414
int32_t func_1(void) {
    // 0x804a379
...
// Address range: 0x804a414 - 0x804a4d6
int main(int argc, char ** argv) {
    // 0x804a414
    int32_t v1; // 0x804a414
    int32_t v2 = v1;
    char ** v3 = argv;
    __x86_get_pc_thunk_bx((int32_t)&v3);
    int32_t v4 = 0; // 0x804a43d
    if (v3 == (char **)2) {
        int32_t str = *(int32_t *)(v1 + 4); // 0x804a445
        v4 = strcmp((char *)str, (char *)(v2 + 3125)) == 0;
    }
    // 0x804a465
    platform_main_begin();
    crc32_gentab();
    func_1();
    transparent_crc(*(int32_t *)(v2 + 0x2bed), v2 + 3127, v4);
    transparent_crc((int32_t)*(int16_t *)(v2 + 0x2bf1), v2 + 3131, v4);
    platform_main_end(-1 - *(int32_t *)(v2 + 0x2be9));
    return 0;
}

// Address range: 0x804a4d6 - 0x804a4da
int32_t __x86_get_pc_thunk_ax(int32_t result) {
    // 0x804a4d6
    return result;
}
