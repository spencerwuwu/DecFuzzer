...
// Address range: 0x804a347 - 0x804a3b6
int32_t set_var(int32_t a1, int32_t a2, int32_t a3, int32_t a4, int32_t a5, int32_t a6, int32_t a7, int16_t a8, int32_t a9) {
    // 0x804a347
    int32_t v1; // 0x804a347
    int32_t v2 = __x86_get_pc_thunk_ax(v1); // 0x804a350
    *(char *)(v2 + 0x2cc3) = (char)a1;
    *(char *)(v2 + 0x2cc4) = (char)a2;
    *(char *)(v2 + 0x2cc5) = (char)a3;
    *(int32_t *)(v2 + 0x2cc7) = a4;
    *(int16_t *)(v2 + 0x2ccb) = (int16_t)a5;
    return 0;
}

// Address range: 0x804a3b6 - 0x804a4c2
int32_t func_1(void) {
    // 0x804a3b6
...
// Address range: 0x804a4c2 - 0x804a5e6
int main(int argc, char ** argv) {
    // 0x804a4c2
    int32_t v1; // 0x804a4c2
    int32_t v2 = v1;
    char ** v3 = argv;
    __x86_get_pc_thunk_bx((int32_t)&v3);
    int32_t v4 = 0; // 0x804a4eb
    if (v3 == (char **)2) {
        int32_t str = *(int32_t *)(v1 + 4); // 0x804a4f3
        v4 = strcmp((char *)str, (char *)(v2 + 2951)) == 0;
    }
    // 0x804a513
    platform_main_begin();
    crc32_gentab();
    func_1();
    transparent_crc((int32_t)*(char *)(v2 + 0x2b3f), v2 + 2953, v4);
    transparent_crc((int32_t)*(char *)(v2 + 0x2b40), v2 + 2958, v4);
    transparent_crc((int32_t)*(char *)(v2 + 0x2b41), v2 + 2963, v4);
    transparent_crc(*(int32_t *)(v2 + 0x2b43), v2 + 2968, v4);
    transparent_crc((int32_t)*(int16_t *)(v2 + 0x2b47), v2 + 2973, v4);
    platform_main_end(-1 - *(int32_t *)(v2 + 0x2b3b));
    return 0;
}

// Address range: 0x804a5e6 - 0x804a5ea
int32_t __x86_get_pc_thunk_ax(int32_t result) {
    // 0x804a5e6
    return result;
}
