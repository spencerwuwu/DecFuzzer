...
// Address range: 0x804a388 - 0x804a451
int32_t func_1(void) {
    // 0x804a388
    int32_t v1; // 0x804a388
    __x86_get_pc_thunk_ax(v1);
    set_var(0, -18, 0, 1, 1, 0x654fddd4, 0, 0, 1, 1, 0);
    return 0;
}

// Address range: 0x804a451 - 0x804a569
int main(int argc, char ** argv) {
    // 0x804a451
    int32_t v1; // 0x804a451
    int32_t v2 = v1;
    char ** v3 = argv;
    __x86_get_pc_thunk_bx((int32_t)&v3);
    int32_t v4 = 0; // 0x804a47a
    if (v3 == (char **)2) {
        int32_t str = *(int32_t *)(v1 + 4); // 0x804a482
        v4 = strcmp((char *)str, (char *)(v2 + 3064)) == 0;
    }
    // 0x804a4a2
    platform_main_begin();
    crc32_gentab();
    func_1();
    transparent_crc(*(int32_t *)(v2 + 0x2ffc), v2 + 3066, v4);
    transparent_crc(*(int32_t *)(v2 + 0x2bb0), v2 + 3070, v4);
    transparent_crc(*(int32_t *)(v2 + 0x2bb4), v2 + 3074, v4);
    transparent_crc(*(int32_t *)(v2 + 0x2bb8), v2 + 3079, v4);
    transparent_crc(*(int32_t *)(v2 + 0x2bbc), v2 + 3084, v4);
    platform_main_end(-1 - *(int32_t *)(v2 + 0x2bac));
    return 0;
}
