...
int32_t set_var(int32_t a1, int32_t a2, int32_t a3, int32_t a4, int32_t a5, int16_t a6, int32_t a7, char a8, int32_t a9, int32_t a10, int32_t a11, char a12, int32_t a13, int32_t a14, int32_t a15, int32_t a16) {
    ...
    *(int32_t *)(v2 + 0x2ccd) = a2;
    *(int32_t *)(v2 + 0x2cd1) = a3;
    *(int32_t *)(v2 + 0x2cd5) = a4;
    *(int32_t *)(v2 + 0x2cd9) = a5;
    return 0;
}

// Address range: 0x804a388 - 0x804a52e
int32_t func_1(void) {
    // 0x804a388
...
// Address range: 0x804a52e - 0x804a648
int main(int argc, char ** argv) {
    // 0x804a52e
    int32_t v1; // 0x804a52e
    int32_t v2 = v1;
    char ** v3 = argv;
    __x86_get_pc_thunk_bx((int32_t)&v3);
    int32_t v4 = 0; // 0x804a557
    if (v3 == (char **)2) {
        int32_t str = *(int32_t *)(v1 + 4); // 0x804a55f
        v4 = strcmp((char *)str, (char *)(v2 + 2843)) == 0;
    }
    // 0x804a57f
    platform_main_begin();
    crc32_gentab();
    func_1();
    transparent_crc(*(int32_t *)(v2 + 0x2ad3), v2 + 2845, v4);
    transparent_crc(*(int32_t *)(v2 + 0x2ad7), v2 + 2849, v4);
    transparent_crc(*(int32_t *)(v2 + 0x2adb), v2 + 2853, v4);
    transparent_crc(*(int32_t *)(v2 + 0x2adf), v2 + 2857, v4);
    transparent_crc(*(int32_t *)(v2 + 0x2ae3), v2 + 2861, v4);
    platform_main_end(-1 - *(int32_t *)(v2 + 0x2acf));
    return 0;
}

// Address range: 0x804a648 - 0x804a64c
int32_t __x86_get_pc_thunk_ax(int32_t result) {
    // 0x804a648
    return result;
}
