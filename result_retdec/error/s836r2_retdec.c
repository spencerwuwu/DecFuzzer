...
// Address range: 0x804a364 - 0x804a3f8
int32_t func_1(void) {
    // 0x804a364
...
// Address range: 0x804a3f8 - 0x804a49c
int main(int argc, char ** argv) {
    // 0x804a3f8
    int32_t v1; // 0x804a3f8
    int32_t v2 = v1;
    char ** v3 = argv;
    __x86_get_pc_thunk_bx((int32_t)&v3);
    int32_t v4 = 0; // 0x804a421
    if (v3 == (char **)2) {
        int32_t str = *(int32_t *)(v1 + 4); // 0x804a429
        v4 = strcmp((char *)str, (char *)(v2 + 3153)) == 0;
    }
    // 0x804a449
    platform_main_begin();
    crc32_gentab();
    func_1();
    transparent_crc(*(int32_t *)(v2 + 0x2c09), v2 + 3155, v4);
    platform_main_end(-1 - *(int32_t *)(v2 + 0x2c05));
    return 0;
}

// Address range: 0x804a49c - 0x804a4a0
int32_t __x86_get_pc_thunk_ax(int32_t result) {
    // 0x804a49c
    return result;
}
