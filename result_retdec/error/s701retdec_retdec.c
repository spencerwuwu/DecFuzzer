...
// Address range: 0x804a347 - 0x804a3a6
int32_t set_var(int32_t a1, int32_t a2, int32_t a3, int32_t a4, int32_t a5, int32_t a6, char a7, int32_t a8, int32_t a9, int32_t a10, int32_t a11, char a12, int32_t a13, int32_t a14) {
    // 0x804a347
    int32_t v1; // 0x804a347
    int32_t v2 = __x86_get_pc_thunk_ax(v1); // 0x804a34e
    *(int32_t *)(v2 + 0x2cc5) = a1;
    *(char *)(v2 + 0x2cc9) = (char)a2;
    *(char *)(v2 + 0x2cca) = (char)a3;
    *(int32_t *)(v2 + 0x2ccd) = a4;
    *(int16_t *)(v2 + 0x2cd1) = (int16_t)a5;
    return 0;
}

// Address range: 0x804a3a6 - 0x804a464
int32_t func_1(void) {
    // 0x804a3a6
...
// Address range: 0x804a464 - 0x804a584
int main(int argc, char ** argv) {
    // 0x804a464
    int32_t v1; // 0x804a464
    int32_t v2 = v1;
    char ** v3 = argv;
    __x86_get_pc_thunk_bx((int32_t)&v3);
    int32_t v4 = 0; // 0x804a48d
    if (v3 == (char **)2) {
        int32_t str = *(int32_t *)(v1 + 4); // 0x804a495
        v4 = strcmp((char *)str, (char *)(v2 + 3045)) == 0;
    }
    // 0x804a4b5
    platform_main_begin();
    crc32_gentab();
    func_1();
    transparent_crc(*(int32_t *)(v2 + 0x2b9d), v2 + 3047, v4);
    transparent_crc((int32_t)*(char *)(v2 + 0x2ba1), v2 + 3051, v4);
    transparent_crc((int32_t)*(char *)(v2 + 0x2ba2), v2 + 3056, v4);
    transparent_crc(*(int32_t *)(v2 + 0x2ba5), v2 + 3061, v4);
    transparent_crc((int32_t)*(int16_t *)(v2 + 0x2ba9), v2 + 3066, v4);
    platform_main_end(-1 - *(int32_t *)(v2 + 0x2b99));
    return 0;
}

// Address range: 0x804a584 - 0x804a588
int32_t __x86_get_pc_thunk_ax(int32_t result) {
    // 0x804a584
    return result;
}
