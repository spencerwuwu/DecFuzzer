...
int32_t set_var(int32_t a1, int32_t a2, int32_t a3, int32_t a4, int32_t a5, int32_t a6, int32_t a7, int32_t a8, int32_t a9, int32_t a10, int32_t a11) {
    ...
    *(char *)(v2 + 0x3112) = (char)a3;
    *(int32_t *)(v2 + 0x2cce) = a4;
    *(int32_t *)(v2 + 0x3116) = a5;
    return 0;
}

// Address range: 0x804a392 - 0x804a442
int32_t func_1(void) {
    // 0x804a392
...
// Address range: 0x804a442 - 0x804a55a
int main(int argc, char ** argv) {
    // 0x804a442
    int32_t v1; // 0x804a442
    int32_t v2 = v1;
    char ** v3 = argv;
    __x86_get_pc_thunk_bx((int32_t)&v3);
    int32_t v4 = 0; // 0x804a46b
    if (v3 == (char **)2) {
        int32_t str = *(int32_t *)(v1 + 4); // 0x804a473
        v4 = strcmp((char *)str, (char *)(v2 + 3079)) == 0;
    }
    // 0x804a493
    platform_main_begin();
    crc32_gentab();
    func_1();
    transparent_crc(*(int32_t *)(v2 + 0x2bbf), v2 + 3081, v4);
    transparent_crc(*(int32_t *)(v2 + 0x2bc3), v2 + 3085, v4);
    transparent_crc((int32_t)*(char *)(v2 + 0x300b), v2 + 3090, v4);
    transparent_crc(*(int32_t *)(v2 + 0x2bc7), v2 + 3095, v4);
    transparent_crc(*(int32_t *)(v2 + 0x300f), v2 + 3100, v4);
    platform_main_end(-1 - *(int32_t *)(v2 + 0x2bbb));
    return 0;
}

// Address range: 0x804a55a - 0x804a55e
int32_t __x86_get_pc_thunk_ax(int32_t result) {
    // 0x804a55a
    return result;
}
