...
// Address range: 0x804a347 - 0x804a3a8
int32_t set_var(int32_t a1, int32_t a2, int32_t a3, int32_t a4, int32_t a5, int32_t a6, int32_t a7, int32_t a8, int32_t a9, int32_t a10, int32_t a11, int16_t a12, int32_t a13) {
    // 0x804a347
    int32_t v1; // 0x804a347
    int32_t v2 = __x86_get_pc_thunk_ax(v1); // 0x804a34e
    *(char *)(v2 + 0x2cc5) = (char)a1;
    *(int16_t *)(v2 + 0x2cc7) = (int16_t)a2;
    *(int16_t *)(v2 + 0x2cc9) = (int16_t)a3;
    *(int32_t *)(v2 + 0x2ccd) = a4;
    *(int32_t *)(v2 + 0x3111) = a5;
    return 0;
}

// Address range: 0x804a3a8 - 0x804a4a6
int32_t func_1(void) {
    // 0x804a3a8
    int32_t v1; // 0x804a3a8
    __x86_get_pc_thunk_ax(v1);
    set_var(186, 0x7c9d, 0, 0, 1, -114, 29, -70, 1, 0, 0, 0x7c9d, -70);
    return -70;
}

// Address range: 0x804a4a6 - 0x804a5c8
int main(int argc, char ** argv) {
    ...
    int32_t v4 = 0; // 0x804a4cf
    if (v3 == (char **)2) {
        int32_t str = *(int32_t *)(v1 + 4); // 0x804a4d7
        v4 = strcmp((char *)str, (char *)(v2 + 2979)) == 0;
    }
    // 0x804a4f7
    platform_main_begin();
    crc32_gentab();
    func_1();
    transparent_crc((int32_t)*(char *)(v2 + 0x2b5b), v2 + 2981, v4);
    transparent_crc((int32_t)*(int16_t *)(v2 + 0x2b5d), v2 + 2986, v4);
    transparent_crc((int32_t)*(int16_t *)(v2 + 0x2b5f), v2 + 2991, v4);
    transparent_crc(*(int32_t *)(v2 + 0x2b63), v2 + 2996, v4);
    transparent_crc(*(int32_t *)(v2 + 0x2fa7), v2 + 3001, v4);
    platform_main_end(-1 - *(int32_t *)(v2 + 0x2b57));
    return 0;
}

// Address range: 0x804a5c8 - 0x804a5cc
int32_t __x86_get_pc_thunk_ax(int32_t result) {
    // 0x804a5c8
    return result;
}
