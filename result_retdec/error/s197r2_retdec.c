...
// Address range: 0x804a347 - 0x804a370
int32_t set_var(int32_t a1, int32_t a2) {
    // 0x804a347
    int32_t v1; // 0x804a347
    *(int16_t *)(__x86_get_pc_thunk_ax(v1) + 0x2cc6) = (int16_t)a1;
    return 0;
}

// Address range: 0x804a370 - 0x804a3f5
int32_t func_1(void) {
    // 0x804a370
    int32_t v1; // 0x804a370
    __x86_get_pc_thunk_ax(v1);
    set_var(-0x5d39, (int32_t)&g1);
    return 0;
}

// Address range: 0x804a3f5 - 0x804a499
int main(int argc, char ** argv) {
    // 0x804a3f5
    int32_t v1; // 0x804a3f5
    int32_t v2 = v1;
    char ** v3 = argv;
    __x86_get_pc_thunk_bx((int32_t)&v3);
    int32_t v4 = 0; // 0x804a41e
    if (v3 == (char **)2) {
        int32_t str = *(int32_t *)(v1 + 4); // 0x804a426
        v4 = strcmp((char *)str, (char *)(v2 + 3156)) == 0;
    }
    // 0x804a446
    platform_main_begin();
    crc32_gentab();
    func_1();
    transparent_crc((int32_t)*(int16_t *)(v2 + 0x2c0c), v2 + 3158, v4);
    platform_main_end(-1 - *(int32_t *)(v2 + 0x2c08));
    return 0;
}

// Address range: 0x804a499 - 0x804a49d
int32_t __x86_get_pc_thunk_ax(int32_t result) {
    // 0x804a499
    return result;
}
