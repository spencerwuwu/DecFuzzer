...
// Address range: 0x804a380 - 0x804a44c
int32_t func_1(void) {
    // 0x804a380
...
// Address range: 0x804a44c - 0x804a52c
int main(int argc, char ** argv) {
    // 0x804a44c
    int32_t v1; // 0x804a44c
    int32_t v2 = v1;
    char ** v3 = argv;
    __x86_get_pc_thunk_bx((int32_t)&v3);
    int32_t v4 = 0; // 0x804a475
    if (v3 == (char **)2) {
        int32_t str = *(int32_t *)(v1 + 4); // 0x804a47d
        v4 = strcmp((char *)str, (char *)(v2 + 3069)) == 0;
    }
    // 0x804a49d
    platform_main_begin();
    crc32_gentab();
    func_1();
    transparent_crc(*(int32_t *)(v2 + 0x2fe1), v2 + 3071, v4);
    transparent_crc((int32_t)*(char *)(v2 + 0x2bb5), v2 + 3075, v4);
    transparent_crc(*(int32_t *)(v2 + 0x2bb9), v2 + 3079, v4);
    platform_main_end(-1 - *(int32_t *)(v2 + 0x2bb1));
    return 0;
}

// Address range: 0x804a52c - 0x804a530
int32_t __x86_get_pc_thunk_ax(int32_t result) {
    // 0x804a52c
    return result;
}
