...
// Address range: 0x804a38b - 0x804a435
int32_t func_1(void) {
    // 0x804a38b
...
// Address range: 0x804a435 - 0x804a531
int main(int argc, char ** argv) {
    ...
    int32_t v4 = 0; // 0x804a45e
    if (v3 == (char **)2) {
        int32_t str = *(int32_t *)(v1 + 4); // 0x804a466
        v4 = strcmp((char *)str, (char *)(v2 + 3092)) == 0;
    }
    // 0x804a486
    platform_main_begin();
    crc32_gentab();
    func_1();
    transparent_crc(*(int32_t *)(v2 + 0x2bcc), v2 + 3094, v4);
    transparent_crc((int32_t)*(int16_t *)(v2 + 0x2bd0), v2 + 3098, v4);
    transparent_crc(*(int32_t *)(v2 + 0x2bd4), v2 + 3102, v4);
    transparent_crc(*(int32_t *)(v2 + 0x2bd8), v2 + 3107, v4);
    platform_main_end(-1 - *(int32_t *)(v2 + 0x2bc8));
    return 0;
}

// Address range: 0x804a531 - 0x804a535
int32_t __x86_get_pc_thunk_ax(int32_t result) {
    // 0x804a531
    return result;
}
