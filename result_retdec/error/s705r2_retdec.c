...
// Address range: 0x804a364 - 0x804a3a7
int32_t func_1(void) {
    // 0x804a364
...
// Address range: 0x804a3a7 - 0x804a44b
int main(int argc, char ** argv) {
    // 0x804a3a7
    int32_t v1; // 0x804a3a7
    int32_t v2 = v1;
    char ** v3 = argv;
    __x86_get_pc_thunk_bx((int32_t)&v3);
    int32_t v4 = 0; // 0x804a3d0
    if (v3 == (char **)2) {
        int32_t str = *(int32_t *)(v1 + 4); // 0x804a3d8
        v4 = strcmp((char *)str, (char *)(v2 + 3234)) == 0;
    }
    // 0x804a3f8
    platform_main_begin();
    crc32_gentab();
    func_1();
    transparent_crc(*(int32_t *)(v2 + 0x2c5a), v2 + 3236, v4);
    platform_main_end(-1 - *(int32_t *)(v2 + 0x2c56));
    return 0;
}

// Address range: 0x804a44b - 0x804a44f
int32_t __x86_get_pc_thunk_ax(int32_t result) {
    // 0x804a44b
    return result;
}
