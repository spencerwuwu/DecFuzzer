...
// Address range: 0x804a375 - 0x804a3e6
int32_t set_var(int32_t a1, int32_t a2, int32_t a3, int32_t a4, int32_t a5, int32_t a6, int32_t a7, int32_t a8, int32_t a9, int32_t a10) {
    // 0x804a375
    int32_t v1; // 0x804a375
    int32_t v2 = __x86_get_pc_thunk_ax(v1); // 0x804a37c
    *(int16_t *)(v2 + 0x2c97) = (int16_t)a1;
    *(int32_t *)(v2 + 0x30e3) = a2;
    *(int32_t *)(v2 + 0x2c9b) = a3;
    *(char *)(v2 + 0x2c9f) = (char)a4;
    *(int32_t *)(v2 + 0x2ca3) = a5;
    *(int32_t *)(v2 + 0x2ca7) = a6;
    *(char *)(v2 + 0x2cab) = (char)a7;
    return 0;
}

// Address range: 0x804a3e6 - 0x804a582
int32_t func_1(void) {
    // 0x804a3e6
    int32_t v1; // 0x804a3e6
    __x86_get_pc_thunk_ax(v1);
    set_var(1, 1, -3, 251, 0x4489be66, -1, 29, -0xb7b91e3, 0, 0x78cca699);
    return 0;
}

// Address range: 0x804a582 - 0x804a6da
int main(int argc, char ** argv) {
    // 0x804a582
    int32_t v1; // 0x804a582
    int32_t v2 = v1;
    char ** v3 = argv;
    __x86_get_pc_thunk_bx((int32_t)&v3);
    int32_t v4 = 0; // 0x804a5ab
    if (v3 == (char **)2) {
        int32_t str = *(int32_t *)(v1 + 4); // 0x804a5b3
        v4 = strcmp((char *)str, (char *)(v2 + 2763)) == 0;
    }
    // 0x804a5d3
    platform_main_begin();
    crc32_gentab();
    func_1();
    transparent_crc((int32_t)*(int16_t *)(v2 + 0x2a7f), v2 + 2765, v4);
    transparent_crc(*(int32_t *)(v2 + 0x2ecb), v2 + 2770, v4);
    transparent_crc(*(int32_t *)(v2 + 0x2a83), v2 + 2775, v4);
    transparent_crc((int32_t)*(char *)(v2 + 0x2a87), v2 + 2780, v4);
    transparent_crc(*(int32_t *)(v2 + 0x2a8b), v2 + 2785, v4);
    transparent_crc(*(int32_t *)(v2 + 0x2a8f), v2 + 2790, v4);
    transparent_crc((int32_t)*(char *)(v2 + 0x2a93), v2 + 2795, v4);
    platform_main_end(-1 - *(int32_t *)(v2 + 0x2a7b));
    return 0;
}
