...
// Address range: 0x804a377 - 0x804a3b4
int32_t func_1(void) {
    // 0x804a377
...
// Address range: 0x804a3b4 - 0x804a476
int main(int argc, char ** argv) {
    // 0x804a3b4
    int32_t v1; // 0x804a3b4
    int32_t v2 = v1;
    char ** v3 = argv;
    __x86_get_pc_thunk_bx((int32_t)&v3);
    int32_t v4 = 0; // 0x804a3dd
    if (v3 == (char **)2) {
        int32_t str = *(int32_t *)(v1 + 4); // 0x804a3e5
        v4 = strcmp((char *)str, (char *)(v2 + 3221)) == 0;
    }
    // 0x804a405
    platform_main_begin();
    crc32_gentab();
    func_1();
    transparent_crc(*(int32_t *)(v2 + 0x2c4d), v2 + 3223, v4);
    transparent_crc((int32_t)*(char *)(v2 + 0x2c51), v2 + 3227, v4);
    platform_main_end(-1 - *(int32_t *)(v2 + 0x2c49));
    return 0;
}

// Address range: 0x804a476 - 0x804a47a
int32_t __x86_get_pc_thunk_ax(int32_t result) {
    // 0x804a476
    return result;
}
