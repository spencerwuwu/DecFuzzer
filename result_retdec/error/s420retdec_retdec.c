...
int32_t set_var(int32_t a1, int32_t a2, int32_t a3, int32_t a4, int32_t a5, int32_t a6) {
    ...
    *(int32_t *)(v2 + 0x3112) = a4;
    return 0;
}

// Address range: 0x804a38b - 0x804a439
int32_t func_1(void) {
    // 0x804a38b
...
// Address range: 0x804a439 - 0x804a537
int main(int argc, char ** argv) {
    // 0x804a439
    int32_t v1; // 0x804a439
    int32_t v2 = v1;
    char ** v3 = argv;
    __x86_get_pc_thunk_bx((int32_t)&v3);
    int32_t v4 = 0; // 0x804a462
    if (v3 == (char **)2) {
        int32_t str = *(int32_t *)(v1 + 4); // 0x804a46a
        v4 = strcmp((char *)str, (char *)(v2 + 3088)) == 0;
    }
    // 0x804a48a
    platform_main_begin();
    crc32_gentab();
    func_1();
    transparent_crc(*(int32_t *)(v2 + 0x2bc8), v2 + 3090, v4);
    transparent_crc(*(int32_t *)(v2 + 0x2bcc), v2 + 3095, v4);
    transparent_crc((int32_t)*(int16_t *)(v2 + 0x2bd0), v2 + 3100, v4);
    transparent_crc(*(int32_t *)(v2 + 0x3014), v2 + 3105, v4);
    platform_main_end(-1 - *(int32_t *)(v2 + 0x2bc4));
    return 0;
}

// Address range: 0x804a537 - 0x804a53b
int32_t __x86_get_pc_thunk_ax(int32_t result) {
    // 0x804a537
    return result;
}
