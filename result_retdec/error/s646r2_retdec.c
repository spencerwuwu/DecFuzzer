...
// Address range: 0x804a38b - 0x804a429
int32_t func_1(void) {
    // 0x804a38b
...
// Address range: 0x804a429 - 0x804a527
int main(int argc, char ** argv) {
    ...
    int32_t v4 = 0; // 0x804a452
    if (v3 == (char **)2) {
        int32_t str = *(int32_t *)(v1 + 4); // 0x804a45a
        v4 = strcmp((char *)str, (char *)(v2 + 3104)) == 0;
    }
    // 0x804a47a
    platform_main_begin();
    crc32_gentab();
    func_1();
    transparent_crc(*(int32_t *)(v2 + 0x2bd8), v2 + 3106, v4);
    transparent_crc(*(int32_t *)(v2 + 0x3024), v2 + 3110, v4);
    transparent_crc(*(int32_t *)(v2 + 0x2bdc), v2 + 3114, v4);
    transparent_crc((int32_t)*(int16_t *)(v2 + 0x2be0), v2 + 3118, v4);
    platform_main_end(-1 - *(int32_t *)(v2 + 0x2bd4));
    return 0;
}

// Address range: 0x804a527 - 0x804a52b
int32_t __x86_get_pc_thunk_ax(int32_t result) {
    // 0x804a527
    return result;
}
