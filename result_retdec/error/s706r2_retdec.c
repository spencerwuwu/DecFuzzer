...
// Address range: 0x804a377 - 0x804a3de
int32_t func_1(void) {
    // 0x804a377
...
// Address range: 0x804a3de - 0x804a4a2
int main(int argc, char ** argv) {
    ...
    if (v3 == (char **)2) {
        ...
        v4 = strcmp((char *)str, (char *)(v2 + 3179)) == 0;
    }
    // 0x804a42f
    platform_main_begin();
    crc32_gentab();
    ...
    transparent_crc(*(int32_t *)(v2 + 0x2c27), v2 + 3185, v4);
    platform_main_end(-1 - *(int32_t *)(v2 + 0x2c1f));
    return 0;
}

// Address range: 0x804a4a2 - 0x804a4a6
int32_t __x86_get_pc_thunk_ax(int32_t result) {
    // 0x804a4a2
    return result;
}
