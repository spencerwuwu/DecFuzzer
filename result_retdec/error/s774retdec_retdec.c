...
// Address range: 0x804a347 - 0x804a399
int32_t set_var(int32_t a1, int32_t a2, int32_t a3, int32_t a4, int32_t a5, int32_t a6, int16_t a7, int32_t a8, char a9, int32_t a10) {
    // 0x804a347
    ...
    *(int32_t *)(v2 + 0x3112) = a5;
    return 0;
}

// Address range: 0x804a399 - 0x804a450
int32_t func_1(void) {
    // 0x804a399
    int32_t v1; // 0x804a399
    __x86_get_pc_thunk_ax(v1);
    set_var(-10, 5, -10, -6, -1, 1, -5, -1, -6, -10);
    return 0xfffb;
}

// Address range: 0x804a450 - 0x804a56e
int main(int argc, char ** argv) {
    ...
    int32_t v4 = 0; // 0x804a479
    if (v3 == (char **)2) {
        int32_t str = *(int32_t *)(v1 + 4); // 0x804a481
        v4 = strcmp((char *)str, (char *)(v2 + 3065)) == 0;
    }
    // 0x804a4a1
    platform_main_begin();
    crc32_gentab();
    func_1();
    transparent_crc(*(int32_t *)(v2 + 0x2bb1), v2 + 3067, v4);
    transparent_crc(*(int32_t *)(v2 + 0x2bb5), v2 + 3071, v4);
    transparent_crc((int32_t)*(char *)(v2 + 0x2bb9), v2 + 3076, v4);
    transparent_crc((int32_t)*(char *)(v2 + 0x2bba), v2 + 3081, v4);
    transparent_crc(*(int32_t *)(v2 + 0x2ffd), v2 + 3086, v4);
    platform_main_end(-1 - *(int32_t *)(v2 + 0x2bad));
    return 0;
}

// Address range: 0x804a56e - 0x804a572
int32_t __x86_get_pc_thunk_ax(int32_t result) {
    // 0x804a56e
    return result;
}
