...
// Address range: 0x804a394 - 0x804a40f
int32_t func_1(void) {
    // 0x804a394
...
// Address range: 0x804a40f - 0x804a515
int main(int argc, char ** argv) {
    // 0x804a40f
    int32_t v1; // 0x804a40f
    int32_t v2 = v1;
    char ** v3 = argv;
    __x86_get_pc_thunk_bx((int32_t)&v3);
    int32_t v4 = 0; // 0x804a438
    if (v3 == (char **)2) {
        int32_t str = *(int32_t *)(v1 + 4); // 0x804a440
        v4 = strcmp((char *)str, (char *)(v2 + 3131)) == 0;
    }
    // 0x804a460
    platform_main_begin();
    crc32_gentab();
    func_1();
    transparent_crc((int32_t)*(char *)(v2 + 3130), v2 + 3133, v4);
    transparent_crc((int32_t)*(int16_t *)(v2 + 0x2bf2), v2 + 3137, v4);
    transparent_crc((int32_t)*(char *)(v2 + 0x2bf4), v2 + 3142, v4);
    transparent_crc((int32_t)*(char *)(v2 + 0x2bf5), v2 + 3147, v4);
    platform_main_end(-1 - *(int32_t *)(v2 + 0x2bee));
    return 0;
}
