...
// Address range: 0x804a379 - 0x804a3fc
int32_t func_1(void) {
    // 0x804a379
...
// Address range: 0x804a3fc - 0x804a4be
int main(int argc, char ** argv) {
    ...
    int32_t v4 = 0; // 0x804a425
    if (v3 == (char **)2) {
        int32_t str = *(int32_t *)(v1 + 4); // 0x804a42d
        v4 = strcmp((char *)str, (char *)(v2 + 3149)) == 0;
    }
    // 0x804a44d
    platform_main_begin();
    crc32_gentab();
    func_1();
    transparent_crc(*(int32_t *)(v2 + 0x2c05), v2 + 3151, v4);
    transparent_crc((int32_t)*(int16_t *)(v2 + 0x3031), v2 + 3156, v4);
    platform_main_end(-1 - *(int32_t *)(v2 + 0x2c01));
    return 0;
}

// Address range: 0x804a4be - 0x804a4c2
int32_t __x86_get_pc_thunk_ax(int32_t result) {
    // 0x804a4be
    return result;
}
