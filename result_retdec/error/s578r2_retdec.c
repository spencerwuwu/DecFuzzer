...
// Address range: 0x804a347 - 0x804a376
int32_t set_var(int32_t a1, int32_t a2, int32_t a3, int32_t a4) {
    // 0x804a347
...
// Address range: 0x804a376 - 0x804a5d5
int32_t func_1(void) {
    // 0x804a376
    int32_t v1; // 0x804a376
    __x86_get_pc_thunk_ax(v1);
    set_var(14, -5, -0x4d304eeb, 0x647dc4b);
    return 0x647dc4b;
}

// Address range: 0x804a5d5 - 0x804a6b5
int main(int argc, char ** argv) {
    // 0x804a5d5
    int32_t v1; // 0x804a5d5
    int32_t v2 = v1;
    char ** v3 = argv;
    __x86_get_pc_thunk_bx((int32_t)&v3);
    int32_t v4 = 0; // 0x804a5fe
    if (v3 == (char **)2) {
        int32_t str = *(int32_t *)(v1 + 4); // 0x804a606
        v4 = strcmp((char *)str, (char *)(v2 + 2676)) == 0;
    }
    // 0x804a626
    platform_main_begin();
    crc32_gentab();
    func_1();
    transparent_crc(*(int32_t *)(v2 + 0x2a2c), v2 + 2678, v4);
    transparent_crc(*(int32_t *)(v2 + 0x2a30), v2 + 2682, v4);
    transparent_crc(*(int32_t *)(v2 + 0x2a34), v2 + 2687, v4);
    platform_main_end(-1 - *(int32_t *)(v2 + 0x2a28));
    return 0;
}
