...
int32_t set_var(int32_t a1, int32_t a2, int32_t a3, int32_t a4) {
    ...
    *(int32_t *)(__x86_get_pc_thunk_ax(v1) + 0x30f5) = a1;
    return 0;
}

// Address range: 0x804a364 - 0x804a444
int32_t func_1(void) {
    // 0x804a364
...
// Address range: 0x804a444 - 0x804a4e8
int main(int argc, char ** argv) {
    // 0x804a444
    int32_t v1; // 0x804a444
    int32_t v2 = v1;
    char ** v3 = argv;
    __x86_get_pc_thunk_bx((int32_t)&v3);
    int32_t v4 = 0; // 0x804a46d
    if (v3 == (char **)2) {
        int32_t str = *(int32_t *)(v1 + 4); // 0x804a475
        v4 = strcmp((char *)str, (char *)(v2 + 3077)) == 0;
    }
    // 0x804a495
    platform_main_begin();
    crc32_gentab();
    func_1();
    transparent_crc(*(int32_t *)(v2 + 0x2fe9), v2 + 3079, v4);
    platform_main_end(-1 - *(int32_t *)(v2 + 0x2bb9));
    return 0;
}

// Address range: 0x804a4e8 - 0x804a4ec
int32_t __x86_get_pc_thunk_ax(int32_t result) {
    // 0x804a4e8
    return result;
}
