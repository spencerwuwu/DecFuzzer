...
// Address range: 0x804a396 - 0x804a452
int32_t func_1(void) {
    // 0x804a396
...
// Address range: 0x804a452 - 0x804a536
int main(int argc, char ** argv) {
    // 0x804a452
    int32_t v1; // 0x804a452
    int32_t v2 = v1;
    char ** v3 = argv;
    __x86_get_pc_thunk_bx((int32_t)&v3);
    int32_t v4 = 0; // 0x804a47b
    if (v3 == (char **)2) {
        int32_t str = *(int32_t *)(v1 + 4); // 0x804a483
        v4 = strcmp((char *)str, (char *)(v2 + 3063)) == 0;
    }
    // 0x804a4a3
    platform_main_begin();
    crc32_gentab();
    func_1();
    transparent_crc((int32_t)*(char *)(v2 + 0x2baf), v2 + 3065, v4);
    transparent_crc((int32_t)*(int16_t *)(v2 + 0x2bb1), v2 + 3069, v4);
    transparent_crc((int32_t)*(int16_t *)(v2 + 0x2bb3), v2 + 3074, v4);
    platform_main_end(-1 - *(int32_t *)(v2 + 0x2bab));
    return 0;
}
