...
// Address range: 0x804a375 - 0x804a3c9
int32_t set_var(int32_t a1, int32_t a2, int32_t a3, int32_t a4, int32_t a5, char a6, char a7, int32_t a8, int32_t a9, char a10, int32_t a11, int32_t a12) {
    // 0x804a375
    int32_t v1; // 0x804a375
    int32_t v2 = __x86_get_pc_thunk_ax(v1); // 0x804a37b
    *(int32_t *)(v2 + 0x2c98) = a1;
    *(int32_t *)(v2 + 0x2c9c) = a2;
    *(char *)(v2 + 0x30e4) = (char)a3;
    *(int16_t *)(v2 + 0x2ca0) = (int16_t)a4;
    *(int32_t *)(v2 + 0x30e8) = a5;
    return 0;
}

// Address range: 0x804a3c9 - 0x804a4cd
int32_t func_1(void) {
    // 0x804a3c9
    int32_t v1; // 0x804a3c9
    __x86_get_pc_thunk_ax(v1);
    set_var(0, 16, 0, 0, 0, 1, 16, 45, 0, 9, 0, 0);
    return 0;
}

// Address range: 0x804a4cd - 0x804a5e9
int main(int argc, char ** argv) {
    // 0x804a4cd
    int32_t v1; // 0x804a4cd
    int32_t v2 = v1;
    char ** v3 = argv;
    __x86_get_pc_thunk_bx((int32_t)&v3);
    int32_t v4 = 0; // 0x804a4f6
    if (v3 == (char **)2) {
        int32_t str = *(int32_t *)(v1 + 4); // 0x804a4fe
        v4 = strcmp((char *)str, (char *)(v2 + 2944)) == 0;
    }
    // 0x804a51e
    platform_main_begin();
    crc32_gentab();
    func_1();
    transparent_crc(*(int32_t *)(v2 + 0x2b34), v2 + 2946, v4);
    transparent_crc(*(int32_t *)(v2 + 0x2b38), v2 + 2950, v4);
    transparent_crc((int32_t)*(char *)(v2 + 0x2f80), v2 + 2955, v4);
    transparent_crc((int32_t)*(int16_t *)(v2 + 0x2b3c), v2 + 2960, v4);
    transparent_crc(*(int32_t *)(v2 + 0x2f84), v2 + 2965, v4);
    platform_main_end(-1 - *(int32_t *)(v2 + 0x2b30));
    return 0;
}

// Address range: 0x804a5e9 - 0x804a5ed
int32_t __x86_get_pc_thunk_ax(int32_t result) {
    // 0x804a5e9
    return result;
}
