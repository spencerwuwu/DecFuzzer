...
// Address range: 0x804a379 - 0x804a3d2
int32_t func_1(void) {
    // 0x804a379
...
// Address range: 0x804a3d2 - 0x804a496
int main(int argc, char ** argv) {
    // 0x804a3d2
    int32_t v1; // 0x804a3d2
    int32_t v2 = v1;
    char ** v3 = argv;
    __x86_get_pc_thunk_bx((int32_t)&v3);
    int32_t v4 = 0; // 0x804a3fb
    if (v3 == (char **)2) {
        int32_t str = *(int32_t *)(v1 + 4); // 0x804a403
        v4 = strcmp((char *)str, (char *)(v2 + 3191)) == 0;
    }
    // 0x804a423
    platform_main_begin();
    crc32_gentab();
    func_1();
    transparent_crc((int32_t)*(int16_t *)(v2 + 0x2c2f), v2 + 3193, v4);
    transparent_crc(*(int32_t *)(v2 + 0x2c33), v2 + 3197, v4);
    platform_main_end(-1 - *(int32_t *)(v2 + 0x2c2b));
    return 0;
}

// Address range: 0x804a496 - 0x804a49a
int32_t __x86_get_pc_thunk_ax(int32_t result) {
    // 0x804a496
    return result;
}
