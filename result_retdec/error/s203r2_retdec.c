...
// Address range: 0x804a347 - 0x804a37f
int32_t set_var(int32_t a1, int32_t a2, int32_t a3, int32_t a4, int32_t a5) {
    // 0x804a347
...
// Address range: 0x804a37f - 0x804a413
int32_t func_1(void) {
    // 0x804a37f
    int32_t v1; // 0x804a37f
    __x86_get_pc_thunk_ax(v1);
    set_var(0, 1, 0, -1, 0);
    return -1;
}

// Address range: 0x804a413 - 0x804a50d
int main(int argc, char ** argv) {
    // 0x804a413
    int32_t v1; // 0x804a413
    int32_t v2 = v1;
    char ** v3 = argv;
    __x86_get_pc_thunk_bx((int32_t)&v3);
    int32_t v4 = 0; // 0x804a43c
    if (v3 == (char **)2) {
        int32_t str = *(int32_t *)(v1 + 4); // 0x804a444
        v4 = strcmp((char *)str, (char *)(v2 + 3126)) == 0;
    }
    // 0x804a464
    platform_main_begin();
    crc32_gentab();
    func_1();
    transparent_crc(*(int32_t *)(v2 + 0x303a), v2 + 3128, v4);
    transparent_crc(*(int32_t *)(v2 + 0x2bee), v2 + 3132, v4);
    transparent_crc(*(int32_t *)(v2 + 0x2bf2), v2 + 3137, v4);
    transparent_crc(*(int32_t *)(v2 + 0x2bf6), v2 + 3142, v4);
    platform_main_end(-1 - *(int32_t *)(v2 + 0x2bea));
    return 0;
}

// Address range: 0x804a50d - 0x804a511
int32_t __x86_get_pc_thunk_ax(int32_t result) {
    // 0x804a50d
    return result;
}
