...
// Address range: 0x804a392 - 0x804a489
int32_t func_1(void) {
    // 0x804a392
...
// Address range: 0x804a489 - 0x804a587
int main(int argc, char ** argv) {
    // 0x804a489
    int32_t v1; // 0x804a489
    int32_t v2 = v1;
    char ** v3 = argv;
    __x86_get_pc_thunk_bx((int32_t)&v3);
    int32_t v4 = 0; // 0x804a4b2
    if (v3 == (char **)2) {
        int32_t str = *(int32_t *)(v1 + 4); // 0x804a4ba
        v4 = strcmp((char *)str, (char *)(v2 + 3008)) == 0;
    }
    // 0x804a4da
    platform_main_begin();
    crc32_gentab();
    func_1();
    transparent_crc(*(int32_t *)(v2 + 0x2b78), v2 + 3010, v4);
    transparent_crc((int32_t)*(int16_t *)(v2 + 0x2b7c), v2 + 3014, v4);
    transparent_crc(*(int32_t *)(v2 + 0x2b80), v2 + 3018, v4);
    transparent_crc((int32_t)*(char *)(v2 + 0x2b84), v2 + 3022, v4);
    platform_main_end(-1 - *(int32_t *)(v2 + 0x2b74));
    return 0;
}
