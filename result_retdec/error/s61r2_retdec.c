...
// Address range: 0x804a347 - 0x804a3a2
int32_t set_var(int32_t a1, int32_t a2, int32_t a3, int32_t a4, int32_t a5, int32_t a6, int16_t a7) {
    // 0x804a347
    ...
    *(char *)(v2 + 0x2cce) = (char)a3;
    *(int32_t *)(v2 + 0x2cd2) = a4;
    *(char *)(v2 + 0x2cd6) = (char)a5;
    *(int32_t *)(v2 + 0x3112) = a6;
    return 0;
}

// Address range: 0x804a3a2 - 0x804a4dd
int32_t func_1(void) {
    // 0x804a3a2
    int32_t v1; // 0x804a3a2
    __x86_get_pc_thunk_ax(v1);
    set_var(-1, 0x72031aa2, 0, 8, 0, 1, -1);
    return 0;
}

// Address range: 0x804a4dd - 0x804a615
int main(int argc, char ** argv) {
    ...
    int32_t v4 = 0; // 0x804a506
    if (v3 == (char **)2) {
        int32_t str = *(int32_t *)(v1 + 4); // 0x804a50e
        v4 = strcmp((char *)str, (char *)(v2 + 2924)) == 0;
    }
    // 0x804a52e
    platform_main_begin();
    crc32_gentab();
    func_1();
    transparent_crc(*(int32_t *)(v2 + 0x2b24), v2 + 2926, v4);
    transparent_crc(*(int32_t *)(v2 + 0x2b28), v2 + 2931, v4);
    transparent_crc((int32_t)*(char *)(v2 + 0x2b2c), v2 + 2936, v4);
    transparent_crc(*(int32_t *)(v2 + 0x2b30), v2 + 2941, v4);
    transparent_crc((int32_t)*(char *)(v2 + 0x2b34), v2 + 2946, v4);
    transparent_crc(*(int32_t *)(v2 + 0x2f70), v2 + 2951, v4);
    platform_main_end(-1 - *(int32_t *)(v2 + 0x2b20));
    return 0;
}
