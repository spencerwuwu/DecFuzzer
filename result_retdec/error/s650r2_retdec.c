...
// Address range: 0x804a364 - 0x804a39a
int32_t func_1(void) {
    // 0x804a364
...
// Address range: 0x804a39a - 0x804a43c
int main(int argc, char ** argv) {
    ...
    int32_t v4 = 0; // 0x804a3c3
    if (v3 == (char **)2) {
        int32_t str = *(int32_t *)(v1 + 4); // 0x804a3cb
        v4 = strcmp((char *)str, (char *)(v2 + 3247)) == 0;
    }
    // 0x804a3eb
    platform_main_begin();
    crc32_gentab();
    func_1();
    transparent_crc(*(int32_t *)(v2 + 0x2c67), v2 + 3249, v4);
    platform_main_end(-1 - *(int32_t *)(v2 + 0x2c63));
    return 0;
}

// Address range: 0x804a43c - 0x804a440
int32_t __x86_get_pc_thunk_ax(int32_t result) {
    // 0x804a43c
    return result;
}
