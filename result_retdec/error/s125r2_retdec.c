...
// Address range: 0x804a38b - 0x804a465
int32_t func_1(void) {
    // 0x804a38b
...
// Address range: 0x804a465 - 0x804a563
int main(int argc, char ** argv) {
    // 0x804a465
    int32_t v1; // 0x804a465
    int32_t v2 = v1;
    char ** v3 = argv;
    __x86_get_pc_thunk_bx((int32_t)&v3);
    int32_t v4 = 0; // 0x804a48e
    if (v3 == (char **)2) {
        int32_t str = *(int32_t *)(v1 + 4); // 0x804a496
        v4 = strcmp((char *)str, (char *)(v2 + 3044)) == 0;
    }
    // 0x804a4b6
    platform_main_begin();
    crc32_gentab();
    func_1();
    transparent_crc(*(int32_t *)(v2 + 0x2b9c), v2 + 3046, v4);
    transparent_crc(*(int32_t *)(v2 + 0x2ba0), v2 + 3051, v4);
    transparent_crc((int32_t)*(int16_t *)(v2 + 0x2ba4), v2 + 3056, v4);
    transparent_crc(*(int32_t *)(v2 + 0x2ba8), v2 + 3061, v4);
    platform_main_end(-1 - *(int32_t *)(v2 + 0x2b98));
    return 0;
}

// Address range: 0x804a563 - 0x804a567
int32_t __x86_get_pc_thunk_ax(int32_t result) {
    // 0x804a563
    return result;
}
