...
// Address range: 0x804a382 - 0x804a404
int32_t func_1(void) {
    // 0x804a382
...
// Address range: 0x804a404 - 0x804a4e6
int main(int argc, char ** argv) {
    // 0x804a404
    int32_t v1; // 0x804a404
    int32_t v2 = v1;
    char ** v3 = argv;
    __x86_get_pc_thunk_bx((int32_t)&v3);
    int32_t v4 = 0; // 0x804a42d
    if (v3 == (char **)2) {
        int32_t str = *(int32_t *)(v1 + 4); // 0x804a435
        v4 = strcmp((char *)str, (char *)(v2 + 3141)) == 0;
    }
    // 0x804a455
    platform_main_begin();
    crc32_gentab();
    func_1();
    transparent_crc(*(int32_t *)(v2 + 0x2bfd), v2 + 3143, v4);
    transparent_crc(*(int32_t *)(v2 + 0x2c01), v2 + 3148, v4);
    transparent_crc((int32_t)*(int16_t *)(v2 + 0x2c05), v2 + 3153, v4);
    platform_main_end(-1 - *(int32_t *)(v2 + 0x2bf9));
    return 0;
}

// Address range: 0x804a4e6 - 0x804a4ea
int32_t __x86_get_pc_thunk_ax(int32_t result) {
    // 0x804a4e6
    return result;
}
