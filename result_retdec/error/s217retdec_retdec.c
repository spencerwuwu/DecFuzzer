...
int32_t set_var(int32_t a1, int32_t a2, int32_t a3, int32_t a4, int32_t a5, int16_t a6, int32_t a7, int32_t a8, int16_t a9, int32_t a10, int16_t a11, int32_t a12, int32_t a13, char a14) {
    ...
    *(int32_t *)(v2 + 0x3111) = a3;
    *(int16_t *)(v2 + 0x2ccd) = (int16_t)a4;
    *(int16_t *)(v2 + 0x3115) = (int16_t)a5;
    return 0;
}

// Address range: 0x804a3a8 - 0x804a4a9
int32_t func_1(void) {
    // 0x804a3a8
...
// Address range: 0x804a4a9 - 0x804a5c5
int main(int argc, char ** argv) {
    ...
    if (v3 == (char **)2) {
        ...
        v4 = strcmp((char *)str, (char *)(v2 + 2976)) == 0;
    }
    // 0x804a4fa
    platform_main_begin();
    crc32_gentab();
    func_1();
    transparent_crc((int32_t)*(char *)(v2 + 0x2b58), v2 + 2978, v4);
    transparent_crc(*(int32_t *)(v2 + 0x2b5c), v2 + 2983, v4);
    transparent_crc(*(int32_t *)(v2 + 0x2fa4), v2 + 2988, v4);
    transparent_crc((int32_t)*(int16_t *)(v2 + 0x2b60), v2 + 2993, v4);
    transparent_crc((int32_t)*(int16_t *)(v2 + 0x2fa8), v2 + 2998, v4);
    platform_main_end(-1 - *(int32_t *)(v2 + 0x2b54));
    return 0;
}

// Address range: 0x804a5c5 - 0x804a5c9
int32_t __x86_get_pc_thunk_ax(int32_t result) {
    // 0x804a5c5
    return result;
}
