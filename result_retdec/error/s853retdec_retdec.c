...
int32_t set_var(int32_t a1, int32_t a2, int32_t a3, int32_t a4, int32_t a5, int32_t a6, char a7, int32_t a8, char a9, char a10, int32_t a11, int32_t a12, char a13, int32_t a14, char a15, int32_t a16) {
    ...
    *(int32_t *)(v2 + 0x3111) = a2;
    *(char *)(v2 + 0x2cc7) = (char)a3;
    *(int32_t *)(v2 + 0x2cc9) = a4;
    *(char *)(v2 + 0x2ccd) = (char)a5;
    *(int32_t *)(v2 + 0x2cd1) = a6;
    return 0;
}

// Address range: 0x804a3af - 0x804a562
int32_t func_1(void) {
    // 0x804a3af
...
// Address range: 0x804a562 - 0x804a69c
int main(int argc, char ** argv) {
    ...
    int32_t v4 = 0; // 0x804a58b
    if (v3 == (char **)2) {
        int32_t str = *(int32_t *)(v1 + 4); // 0x804a593
        v4 = strcmp((char *)str, (char *)(v2 + 2791)) == 0;
    }
    // 0x804a5b3
    platform_main_begin();
    crc32_gentab();
    func_1();
    transparent_crc((int32_t)*(int16_t *)(v2 + 0x2a9f), v2 + 2793, v4);
    transparent_crc(*(int32_t *)(v2 + 0x2eeb), v2 + 2797, v4);
    transparent_crc((int32_t)*(char *)(v2 + 0x2aa1), v2 + 2802, v4);
    transparent_crc(*(int32_t *)(v2 + 0x2aa3), v2 + 2807, v4);
    transparent_crc((int32_t)*(char *)(v2 + 0x2aa7), v2 + 2812, v4);
    transparent_crc(*(int32_t *)(v2 + 0x2aab), v2 + 2817, v4);
    platform_main_end(-1 - *(int32_t *)(v2 + 0x2a9b));
    return 0;
}

// Address range: 0x804a69c - 0x804a6a0
int32_t __x86_get_pc_thunk_ax(int32_t result) {
    // 0x804a69c
    return result;
}
