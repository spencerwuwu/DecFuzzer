...
// Address range: 0x804a389 - 0x804a44b
int32_t func_1(void) {
    // 0x804a389
...
// Address range: 0x804a44b - 0x804a547
int main(int argc, char ** argv) {
    // 0x804a44b
    int32_t v1; // 0x804a44b
    int32_t v2 = v1;
    char ** v3 = argv;
    __x86_get_pc_thunk_bx((int32_t)&v3);
    int32_t v4 = 0; // 0x804a474
    if (v3 == (char **)2) {
        int32_t str = *(int32_t *)(v1 + 4); // 0x804a47c
        v4 = strcmp((char *)str, (char *)(v2 + 3070)) == 0;
    }
    // 0x804a49c
    platform_main_begin();
    crc32_gentab();
    func_1();
    transparent_crc(*(int32_t *)(v2 + 0x2bb6), v2 + 3072, v4);
    transparent_crc(*(int32_t *)(v2 + 0x2bba), v2 + 3076, v4);
    transparent_crc(*(int32_t *)(v2 + 0x2bbe), v2 + 3081, v4);
    transparent_crc((int32_t)*(char *)(v2 + 0x2bc2), v2 + 3086, v4);
    platform_main_end(-1 - *(int32_t *)(v2 + 0x2bb2));
    return 0;
}

// Address range: 0x804a547 - 0x804a54b
int32_t __x86_get_pc_thunk_ax(int32_t result) {
    // 0x804a547
    return result;
}
