...
// Address range: 0x804a347 - 0x804a377
int32_t set_var(int32_t a1, int32_t a2, int32_t a3, int16_t a4, char a5) {
    // 0x804a347
...
// Address range: 0x804a377 - 0x804a3ef
int32_t func_1(void) {
    // 0x804a377
...
// Address range: 0x804a3ef - 0x804a4b3
int main(int argc, char ** argv) {
    ...
    transparent_crc((int32_t)*(char *)(v2 + 0x303e), v2 + 3168, v4);
    platform_main_end(-1 - *(int32_t *)(v2 + 0x2c0e));
    return 0;
}

// Address range: 0x804a4b3 - 0x804a4b7
int32_t __x86_get_pc_thunk_ax(int32_t result) {
    // 0x804a4b3
    return result;
}
