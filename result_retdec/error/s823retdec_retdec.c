...
int main(int argc, char ** argv) {
    ...
    int32_t v4 = 0; // 0x804a454
    if (v3 == (char **)2) {
        int32_t str = *(int32_t *)(v1 + 4); // 0x804a45c
        v4 = strcmp((char *)str, (char *)(v2 + 3102)) == 0;
    }
    // 0x804a47c
    platform_main_begin();
    crc32_gentab();
    func_1();
    transparent_crc(*(int32_t *)(v2 + 0x3002), v2 + 3104, v4);
    transparent_crc((int32_t)*(char *)(v2 + 0x2bd6), v2 + 3109, v4);
    transparent_crc(*(int32_t *)(v2 + 0x2bda), v2 + 3114, v4);
    platform_main_end(-1 - *(int32_t *)(v2 + 0x2bd2));
    return 0;
}
