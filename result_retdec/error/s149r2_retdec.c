...
// Address range: 0x804a347 - 0x804a390
int32_t set_var(int32_t a1, int32_t a2, int32_t a3, int32_t a4, int32_t a5, int32_t a6, int32_t a7, char a8, char a9, int32_t a10) {
    // 0x804a347
    int32_t v1; // 0x804a347
    int32_t v2 = __x86_get_pc_thunk_ax(v1); // 0x804a34d
    *(int32_t *)(v2 + 0x2cc6) = a1;
    *(char *)(v2 + 0x2cca) = (char)a2;
    *(char *)(v2 + 0x2ccb) = (char)a3;
    *(int32_t *)(v2 + 0x2cce) = a4;
    return 0;
}

// Address range: 0x804a390 - 0x804a428
int32_t func_1(void) {
    // 0x804a390
    int32_t v1; // 0x804a390
    __x86_get_pc_thunk_ax(v1);
    set_var(-1, 72, 5, 0, 0x25bb0866, 0, 1, 72, 5, 72);
    return 5;
}

// Address range: 0x804a428 - 0x804a526
int main(int argc, char ** argv) {
    // 0x804a428
    int32_t v1; // 0x804a428
    int32_t v2 = v1;
    char ** v3 = argv;
    __x86_get_pc_thunk_bx((int32_t)&v3);
    int32_t v4 = 0; // 0x804a451
    if (v3 == (char **)2) {
        int32_t str = *(int32_t *)(v1 + 4); // 0x804a459
        v4 = strcmp((char *)str, (char *)(v2 + 3105)) == 0;
    }
    // 0x804a479
    platform_main_begin();
    crc32_gentab();
    func_1();
    transparent_crc(*(int32_t *)(v2 + 0x2bd9), v2 + 3107, v4);
    transparent_crc((int32_t)*(char *)(v2 + 0x2bdd), v2 + 3111, v4);
    transparent_crc((int32_t)*(char *)(v2 + 0x2bde), v2 + 3115, v4);
    transparent_crc(*(int32_t *)(v2 + 0x2be1), v2 + 3120, v4);
    platform_main_end(-1 - *(int32_t *)(v2 + 0x2bd5));
    return 0;
}

// Address range: 0x804a526 - 0x804a52a
int32_t __x86_get_pc_thunk_ax(int32_t result) {
    // 0x804a526
    return result;
}
