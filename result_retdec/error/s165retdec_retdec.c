...
// Address range: 0x804a380 - 0x804a3ef
int32_t func_1(void) {
    // 0x804a380
...
// Address range: 0x804a3ef - 0x804a4cf
int main(int argc, char ** argv) {
    ...
    int32_t v4 = 0; // 0x804a418
    if (v3 == (char **)2) {
        int32_t str = *(int32_t *)(v1 + 4); // 0x804a420
        v4 = strcmp((char *)str, (char *)(v2 + 3162)) == 0;
    }
    // 0x804a440
    platform_main_begin();
    crc32_gentab();
    ...
    transparent_crc((int32_t)*(char *)(v2 + 0x2c1a), v2 + 3172, v4);
    platform_main_end(-1 - *(int32_t *)(v2 + 0x2c0e));
    return 0;
}

// Address range: 0x804a4cf - 0x804a4d3
int32_t __x86_get_pc_thunk_ax(int32_t result) {
    // 0x804a4cf
    return result;
}
