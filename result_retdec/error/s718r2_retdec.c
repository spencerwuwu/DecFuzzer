...
// Address range: 0x804a379 - 0x804a3ca
int32_t func_1(void) {
    // 0x804a379
...
// Address range: 0x804a3ca - 0x804a48c
int main(int argc, char ** argv) {
    // 0x804a3ca
    int32_t v1; // 0x804a3ca
    int32_t v2 = v1;
    char ** v3 = argv;
    __x86_get_pc_thunk_bx((int32_t)&v3);
    int32_t v4 = 0; // 0x804a3f3
    if (v3 == (char **)2) {
        int32_t str = *(int32_t *)(v1 + 4); // 0x804a3fb
        v4 = strcmp((char *)str, (char *)(v2 + 3199)) == 0;
    }
    // 0x804a41b
    platform_main_begin();
    crc32_gentab();
    func_1();
    transparent_crc((int32_t)*(int16_t *)(v2 + 0x2c37), v2 + 3201, v4);
    transparent_crc(*(int32_t *)(v2 + 0x2c3b), v2 + 3205, v4);
    platform_main_end(-1 - *(int32_t *)(v2 + 0x2c33));
    return 0;
}

// Address range: 0x804a48c - 0x804a490
int32_t __x86_get_pc_thunk_ax(int32_t result) {
    // 0x804a48c
    return result;
}
