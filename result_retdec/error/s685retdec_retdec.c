...
// Address range: 0x804a377 - 0x804a3d0
int32_t func_1(void) {
    // 0x804a377
...
// Address range: 0x804a3d0 - 0x804a492
int main(int argc, char ** argv) {
    ...
    int32_t v4 = 0; // 0x804a3f9
    if (v3 == (char **)2) {
        int32_t str = *(int32_t *)(v1 + 4); // 0x804a401
        v4 = strcmp((char *)str, (char *)(v2 + 3193)) == 0;
    }
    // 0x804a421
    platform_main_begin();
    crc32_gentab();
    func_1();
    transparent_crc(*(int32_t *)(v2 + 0x2c31), v2 + 3195, v4);
    transparent_crc((int32_t)*(char *)(v2 + 0x2c35), v2 + 3199, v4);
    platform_main_end(-1 - *(int32_t *)(v2 + 0x2c2d));
    return 0;
}

// Address range: 0x804a492 - 0x804a496
int32_t __x86_get_pc_thunk_ax(int32_t result) {
    // 0x804a492
    return result;
}
