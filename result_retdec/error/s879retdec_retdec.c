...
// Address range: 0x804a375 - 0x804a3ae
int32_t set_var(int32_t a1, int32_t a2, int32_t a3, int32_t a4, int32_t a5, int32_t a6, int32_t a7) {
    // 0x804a375
    int32_t v1; // 0x804a375
    int32_t v2 = __x86_get_pc_thunk_ax(v1); // 0x804a37b
    *(char *)(v2 + 0x30c4) = (char)a1;
    *(int16_t *)(v2 + 0x2c98) = (int16_t)a2;
    return 0;
}

// Address range: 0x804a3ae - 0x804a480
int32_t func_1(void) {
    // 0x804a3ae
...
// Address range: 0x804a480 - 0x804a561
int main(int argc, char ** argv) {
    // 0x804a480
    int32_t v1; // 0x804a480
    int32_t v2 = v1;
    char ** v3 = argv;
    __x86_get_pc_thunk_bx((int32_t)&v3);
    int32_t v4 = 0; // 0x804a4a9
    if (v3 == (char **)2) {
        int32_t str = *(int32_t *)(v1 + 4); // 0x804a4b1
        v4 = strcmp((char *)str, (char *)(v2 + 3025)) == 0;
    }
    // 0x804a4d1
    platform_main_begin();
    crc32_gentab();
    func_1();
    transparent_crc((int32_t)*(char *)(v2 + 0x2fad), v2 + 3027, v4);
    transparent_crc(-0x7360c970, v2 + 3031, v4);
    transparent_crc((int32_t)*(int16_t *)(v2 + 0x2b81), v2 + 3035, v4);
    platform_main_end(-1 - *(int32_t *)(v2 + 0x2b7d));
    return 0;
}

// Address range: 0x804a561 - 0x804a565
int32_t __x86_get_pc_thunk_ax(int32_t result) {
    // 0x804a561
    return result;
}
