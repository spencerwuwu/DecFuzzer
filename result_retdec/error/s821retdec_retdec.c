...
// Address range: 0x804a347 - 0x804a3a1
int32_t set_var(int32_t a1, int32_t a2, int32_t a3, int32_t a4, int32_t a5, int16_t a6, int32_t a7) {
    // 0x804a347
...
// Address range: 0x804a3a1 - 0x804a43c
int32_t func_1(void) {
    // 0x804a3a1
...
// Address range: 0x804a43c - 0x804a53a
int main(int argc, char ** argv) {
    ...
    int32_t v4 = 0; // 0x804a465
    if (v3 == (char **)2) {
        int32_t str = *(int32_t *)(v1 + 4); // 0x804a46d
        v4 = strcmp((char *)str, (char *)(v2 + 3085)) == 0;
    }
    // 0x804a48d
    platform_main_begin();
    crc32_gentab();
    func_1();
    transparent_crc(*(int32_t *)(v2 + 0x2bc5), v2 + 3087, v4);
    transparent_crc((int32_t)*(int16_t *)(v2 + 0x2bc9), v2 + 3091, v4);
    transparent_crc((int32_t)*(int16_t *)(v2 + 0x2bcb), v2 + 3096, v4);
    transparent_crc((int32_t)*(int16_t *)(v2 + 0x2bcd), v2 + 3101, v4);
    platform_main_end(-1 - *(int32_t *)(v2 + 0x2bc1));
    return 0;
}
