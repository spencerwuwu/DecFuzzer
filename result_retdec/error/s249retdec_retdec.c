...
// Address range: 0x804a347 - 0x804a39d
int32_t set_var(int32_t a1, int32_t a2, int32_t a3, int32_t a4, char a5, int32_t a6, int16_t a7, int32_t a8, char a9) {
    // 0x804a347
...
// Address range: 0x804a39d - 0x804a3fe
int32_t func_1(void) {
    // 0x804a39d
...
// Address range: 0x804a3fe - 0x804a4fe
int main(int argc, char ** argv) {
    // 0x804a3fe
    int32_t v1; // 0x804a3fe
    int32_t v2 = v1;
    char ** v3 = argv;
    __x86_get_pc_thunk_bx((int32_t)&v3);
    int32_t v4 = 0; // 0x804a427
    if (v3 == (char **)2) {
        int32_t str = *(int32_t *)(v1 + 4); // 0x804a42f
        v4 = strcmp((char *)str, (char *)(v2 + 3147)) == 0;
    }
    // 0x804a44f
    platform_main_begin();
    crc32_gentab();
    func_1();
    transparent_crc((int32_t)*(char *)(v2 + 0x2c03), v2 + 3149, v4);
    transparent_crc((int32_t)*(char *)(v2 + 0x2c04), v2 + 3153, v4);
    transparent_crc((int32_t)*(int16_t *)(v2 + 0x2c05), v2 + 3157, v4);
    transparent_crc(*(int32_t *)(v2 + 0x2c07), v2 + 3161, v4);
    platform_main_end(-1 - *(int32_t *)(v2 + 0x2bff));
    return 0;
}

// Address range: 0x804a4fe - 0x804a502
int32_t __x86_get_pc_thunk_ax(int32_t result) {
    // 0x804a4fe
    return result;
}
