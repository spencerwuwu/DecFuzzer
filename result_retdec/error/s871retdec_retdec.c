...
// Address range: 0x804a375 - 0x804a3c0
int32_t set_var(int32_t a1, int32_t a2, int32_t a3, int32_t a4, int16_t a5, int32_t a6, int16_t a7, int32_t a8, int32_t a9, int16_t a10, int32_t a11) {
    // 0x804a375
    int32_t v1; // 0x804a375
    int32_t v2 = __x86_get_pc_thunk_ax(v1); // 0x804a37b
    *(int16_t *)(v2 + 0x2c98) = (int16_t)a1;
    *(int32_t *)(v2 + 0x2c9c) = a2;
    *(char *)(v2 + 0x2ca0) = (char)a3;
    *(int32_t *)(v2 + 0x30e4) = a4;
    return 0;
}

// Address range: 0x804a3c0 - 0x804a512
int32_t func_1(void) {
    // 0x804a3c0
    int32_t v1; // 0x804a3c0
    __x86_get_pc_thunk_ax(v1);
    set_var(-0x28f0, 0x44ad, -73, 0, (int16_t)&g1, (int32_t)&g1, (int16_t)&g1, (int32_t)&g1, (int32_t)&g1, (int16_t)&g1, (int32_t)&g1);
    return 0x8850;
}

// Address range: 0x804a512 - 0x804a610
int main(int argc, char ** argv) {
    // 0x804a512
    int32_t v1; // 0x804a512
    int32_t v2 = v1;
    char ** v3 = argv;
    __x86_get_pc_thunk_bx((int32_t)&v3);
    int32_t v4 = 0; // 0x804a53b
    if (v3 == (char **)2) {
        int32_t str = *(int32_t *)(v1 + 4); // 0x804a543
        v4 = strcmp((char *)str, (char *)(v2 + 2875)) == 0;
    }
    // 0x804a563
    platform_main_begin();
    crc32_gentab();
    func_1();
    transparent_crc((int32_t)*(int16_t *)(v2 + 0x2aef), v2 + 2877, v4);
    transparent_crc(*(int32_t *)(v2 + 0x2af3), v2 + 2881, v4);
    transparent_crc((int32_t)*(char *)(v2 + 0x2af7), v2 + 2885, v4);
    transparent_crc(*(int32_t *)(v2 + 0x2f3b), v2 + 2890, v4);
    platform_main_end(-1 - *(int32_t *)(v2 + 0x2aeb));
    return 0;
}
