...
// Address range: 0x804a364 - 0x804a3dd
int32_t func_1(void) {
    // 0x804a364
...
// Address range: 0x804a3dd - 0x804a47f
int main(int argc, char ** argv) {
    // 0x804a3dd
    int32_t v1; // 0x804a3dd
    int32_t v2 = v1;
    char ** v3 = argv;
    __x86_get_pc_thunk_bx((int32_t)&v3);
    int32_t v4 = 0; // 0x804a406
    if (v3 == (char **)2) {
        int32_t str = *(int32_t *)(v1 + 4); // 0x804a40e
        v4 = strcmp((char *)str, (char *)(v2 + 3180)) == 0;
    }
    // 0x804a42e
    platform_main_begin();
    crc32_gentab();
    func_1();
    transparent_crc(*(int32_t *)(v2 + 0x2c24), v2 + 3182, v4);
    platform_main_end(-1 - *(int32_t *)(v2 + 0x2c20));
    return 0;
}

// Address range: 0x804a47f - 0x804a483
int32_t __x86_get_pc_thunk_ax(int32_t result) {
    // 0x804a47f
    return result;
}
