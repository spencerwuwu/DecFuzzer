...
// Address range: 0x804a39f - 0x804a44a
int32_t func_1(void) {
    // 0x804a39f
...
// Address range: 0x804a44a - 0x804a569
int main(int argc, char ** argv) {
    ...
    int32_t v4 = 0; // 0x804a473
    if (v3 == (char **)2) {
        int32_t str = *(int32_t *)(v1 + 4); // 0x804a47b
        v4 = strcmp((char *)str, (char *)(v2 + 3075)) == 0;
    }
    // 0x804a49b
    platform_main_begin();
    crc32_gentab();
    func_1();
    transparent_crc(0x36ccb036, v2 + 3077, v4);
    transparent_crc(*(int32_t *)(v2 + 0x2bb7), v2 + 3081, v4);
    transparent_crc((int32_t)*(int16_t *)(v2 + 0x2bbb), v2 + 3086, v4);
    transparent_crc((int32_t)*(int16_t *)(v2 + 0x2bbd), v2 + 3091, v4);
    transparent_crc((int32_t)*(char *)(v2 + 0x2bbf), v2 + 3096, v4);
    platform_main_end(-1 - *(int32_t *)(v2 + 0x2bb3));
    return 0;
}

// Address range: 0x804a569 - 0x804a56d
int32_t __x86_get_pc_thunk_ax(int32_t result) {
    // 0x804a569
    return result;
}
