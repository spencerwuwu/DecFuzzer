...
// Address range: 0x804a375 - 0x804a39c
int32_t set_var(int32_t a1, int32_t a2, char a3, int32_t a4, int16_t a5, char a6) {
    // 0x804a375
    int32_t v1; // 0x804a375
    *(char *)(__x86_get_pc_thunk_ax(v1) + 0x30c4) = (char)a1;
    return 0;
}

// Address range: 0x804a39c - 0x804a433
int32_t func_1(void) {
    // 0x804a39c
    int32_t v1; // 0x804a39c
    __x86_get_pc_thunk_ax(v1);
    set_var(0, 1, 84, 0x925e, -3, 0);
    return 0;
}

// Address range: 0x804a433 - 0x804a4d9
int main(int argc, char ** argv) {
    // 0x804a433
    int32_t v1; // 0x804a433
    int32_t v2 = v1;
    char ** v3 = argv;
    __x86_get_pc_thunk_bx((int32_t)&v3);
    int32_t v4 = 0; // 0x804a45c
    if (v3 == (char **)2) {
        int32_t str = *(int32_t *)(v1 + 4); // 0x804a464
        v4 = strcmp((char *)str, (char *)(v2 + 3098)) == 0;
    }
    // 0x804a484
    platform_main_begin();
    crc32_gentab();
    func_1();
    transparent_crc((int32_t)*(char *)(v2 + 0x2ffa), v2 + 3100, v4);
    platform_main_end(-1 - *(int32_t *)(v2 + 0x2bca));
    return 0;
}

// Address range: 0x804a4d9 - 0x804a4dd
int32_t __x86_get_pc_thunk_ax(int32_t result) {
    // 0x804a4d9
    return result;
}
