...
// Address range: 0x804a394 - 0x804a477
int32_t func_1(void) {
    // 0x804a394
...
// Address range: 0x804a477 - 0x804a595
int main(int argc, char ** argv) {
    // 0x804a477
    int32_t v1; // 0x804a477
    int32_t v2 = v1;
    char ** v3 = argv;
    __x86_get_pc_thunk_bx((int32_t)&v3);
    int32_t v4 = 0; // 0x804a4a0
    if (v3 == (char **)2) {
        int32_t str = *(int32_t *)(v1 + 4); // 0x804a4a8
        v4 = strcmp((char *)str, (char *)(v2 + 3026)) == 0;
    }
    // 0x804a4c8
    platform_main_begin();
    crc32_gentab();
    func_1();
    transparent_crc(*(int32_t *)(v2 + 0x2b8a), v2 + 3028, v4);
    transparent_crc(*(int32_t *)(v2 + 0x2b8e), v2 + 3032, v4);
    transparent_crc(*(int32_t *)(v2 + 0x2b92), v2 + 3036, v4);
    transparent_crc(*(int32_t *)(v2 + 0x2b96), v2 + 3040, v4);
    transparent_crc((int32_t)*(int16_t *)(v2 + 0x2b9a), v2 + 3044, v4);
    platform_main_end(-1 - *(int32_t *)(v2 + 0x2b86));
    return 0;
}

// Address range: 0x804a595 - 0x804a599
int32_t __x86_get_pc_thunk_ax(int32_t result) {
    // 0x804a595
    return result;
}
