...
// Address range: 0x804a364 - 0x804a3a1
int32_t func_1(void) {
    // 0x804a364
...
// Address range: 0x804a3a1 - 0x804a443
int main(int argc, char ** argv) {
    ...
    int32_t v4 = 0; // 0x804a3ca
    if (v3 == (char **)2) {
        int32_t str = *(int32_t *)(v1 + 4); // 0x804a3d2
        v4 = strcmp((char *)str, (char *)(v2 + 3240)) == 0;
    }
    // 0x804a3f2
    platform_main_begin();
    crc32_gentab();
    func_1();
    transparent_crc(*(int32_t *)(v2 + 0x2c60), v2 + 3242, v4);
    platform_main_end(-1 - *(int32_t *)(v2 + 0x2c5c));
    return 0;
}

// Address range: 0x804a443 - 0x804a447
int32_t __x86_get_pc_thunk_ax(int32_t result) {
    // 0x804a443
    return result;
}
