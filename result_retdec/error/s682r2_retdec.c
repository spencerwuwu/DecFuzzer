...
// Address range: 0x804a380 - 0x804a403
int32_t func_1(void) {
    // 0x804a380
...
// Address range: 0x804a403 - 0x804a4e5
int main(int argc, char ** argv) {
    ...
    int32_t v4 = 0; // 0x804a42c
    if (v3 == (char **)2) {
        int32_t str = *(int32_t *)(v1 + 4); // 0x804a434
        v4 = strcmp((char *)str, (char *)(v2 + 3142)) == 0;
    }
    // 0x804a454
    platform_main_begin();
    crc32_gentab();
    func_1();
    transparent_crc(*(int32_t *)(v2 + 0x2bfe), v2 + 3144, v4);
    transparent_crc((int32_t)*(char *)(v2 + 0x2c02), v2 + 3148, v4);
    transparent_crc(*(int32_t *)(v2 + 0x2c06), v2 + 3153, v4);
    platform_main_end(-1 - *(int32_t *)(v2 + 0x2bfa));
    return 0;
}

// Address range: 0x804a4e5 - 0x804a4e9
int32_t __x86_get_pc_thunk_ax(int32_t result) {
    // 0x804a4e5
    return result;
}
