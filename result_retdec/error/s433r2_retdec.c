...
int32_t set_var(int32_t a1, int32_t a2, int32_t a3, int32_t a4, int32_t a5, int32_t a6, int32_t a7, int32_t a8, char a9, int16_t a10, int32_t a11, int16_t a12);
...
int32_t set_var(int32_t a1, int32_t a2, int32_t a3, int32_t a4, int32_t a5, int32_t a6, int32_t a7, int32_t a8, char a9, int16_t a10, int32_t a11, int16_t a12) {
    ...
    *(int32_t *)(v2 + 0x3112) = a2;
    *(int16_t *)(v2 + 0x2cca) = (int16_t)a3;
    *(int32_t *)(v2 + 0x2cce) = a4;
    return 0;
}

// Address range: 0x804a38b - 0x804a440
int32_t func_1(void) {
    // 0x804a38b
    int32_t v1; // 0x804a38b
    __x86_get_pc_thunk_ax(v1);
    set_var(-0x40d4d66c, 21, -0x7f84, 0x1b16, -0x40d4d66c, -0xa06690d, 0x5fef9d78, 7, 21, 0x1b16, -0x7f84, 21);
    return 21;
}

// Address range: 0x804a440 - 0x804a53a
int main(int argc, char ** argv) {
    ...
    int32_t v4 = 0; // 0x804a469
    if (v3 == (char **)2) {
        int32_t str = *(int32_t *)(v1 + 4); // 0x804a471
        v4 = strcmp((char *)str, (char *)(v2 + 3081)) == 0;
    }
    // 0x804a491
    platform_main_begin();
    crc32_gentab();
    func_1();
    transparent_crc(*(int32_t *)(v2 + 0x2bc1), v2 + 3083, v4);
    transparent_crc(*(int32_t *)(v2 + 0x300d), v2 + 3087, v4);
    transparent_crc((int32_t)*(int16_t *)(v2 + 0x2bc5), v2 + 3091, v4);
    transparent_crc(*(int32_t *)(v2 + 0x2bc9), v2 + 3096, v4);
    platform_main_end(-1 - *(int32_t *)(v2 + 0x2bbd));
    return 0;
}
