...
int32_t set_var(int32_t a1, int32_t a2, int32_t a3) {
    ...
    *(char *)(v2 + 0x2cc8) = (char)a2;
    return 0;
}

// Address range: 0x804a380 - 0x804a3fe
int32_t func_1(void) {
    // 0x804a380
...
// Address range: 0x804a3fe - 0x804a4c2
int main(int argc, char ** argv) {
    ...
    crc32_gentab();
    func_1();
    transparent_crc((int32_t)*(int16_t *)(v2 + 0x2c03), v2 + 3149, v4);
    transparent_crc((int32_t)*(char *)(v2 + 0x2c05), v2 + 3154, v4);
    platform_main_end(-1 - *(int32_t *)(v2 + 0x2bff));
    return 0;
}

// Address range: 0x804a4c2 - 0x804a4c6
int32_t __x86_get_pc_thunk_ax(int32_t result) {
    // 0x804a4c2
    return result;
}
