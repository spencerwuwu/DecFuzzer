...
// Address range: 0x804a377 - 0x804a3c3
int32_t func_1(void) {
    // 0x804a377
...
// Address range: 0x804a3c3 - 0x804a485
int main(int argc, char ** argv) {
    ...
    int32_t v4 = 0; // 0x804a3ec
    if (v3 == (char **)2) {
        int32_t str = *(int32_t *)(v1 + 4); // 0x804a3f4
        v4 = strcmp((char *)str, (char *)(v2 + 3206)) == 0;
    }
    // 0x804a414
    platform_main_begin();
    crc32_gentab();
    func_1();
    transparent_crc(*(int32_t *)(v2 + 0x2c3e), v2 + 3208, v4);
    transparent_crc((int32_t)*(char *)(v2 + 0x2c42), v2 + 3212, v4);
    platform_main_end(-1 - *(int32_t *)(v2 + 0x2c3a));
    return 0;
}

// Address range: 0x804a485 - 0x804a489
int32_t __x86_get_pc_thunk_ax(int32_t result) {
    // 0x804a485
    return result;
}
