...
// Address range: 0x804a347 - 0x804a394
int32_t set_var(int32_t a1, int32_t a2, int32_t a3, int32_t a4, int32_t a5, int32_t a6, int32_t a7, int16_t a8, char a9, char a10) {
    // 0x804a347
...
// Address range: 0x804a394 - 0x804a43f
int32_t func_1(void) {
    // 0x804a394
    int32_t v1; // 0x804a394
    __x86_get_pc_thunk_ax(v1);
    set_var(1, 0, 0, 0x11fc80ae, -0x1c1ba445, 0, 0x5fdc8dfb, 0, 0, 1);
    return 0x5fdc8dfb;
}

// Address range: 0x804a43f - 0x804a523
int main(int argc, char ** argv) {
    ...
    int32_t v4 = 0; // 0x804a468
    if (v3 == (char **)2) {
        int32_t str = *(int32_t *)(v1 + 4); // 0x804a470
        v4 = strcmp((char *)str, (char *)(v2 + 3082)) == 0;
    }
    // 0x804a490
    platform_main_begin();
    crc32_gentab();
    func_1();
    transparent_crc((int32_t)*(char *)(v2 + 0x2bc2), v2 + 3084, v4);
    transparent_crc((int32_t)*(char *)(v2 + 0x2bc3), v2 + 3088, v4);
    transparent_crc((int32_t)*(int16_t *)(v2 + 0x2bc4), v2 + 3093, v4);
    platform_main_end(-1 - *(int32_t *)(v2 + 0x2bbe));
    return 0;
}

// Address range: 0x804a523 - 0x804a527
int32_t __x86_get_pc_thunk_ax(int32_t result) {
    // 0x804a523
    return result;
}
