...
// Address range: 0x804a36d - 0x804a433
int32_t func_1(void) {
    // 0x804a36d
...
// Address range: 0x804a433 - 0x804a4f1
int main(int argc, char ** argv) {
    ...
    if (v3 == (char **)2) {
        ...
        v4 = strcmp((char *)str, (char *)(v2 + 3094)) == 0;
    }
    // 0x804a484
    platform_main_begin();
    crc32_gentab();
    func_1();
    transparent_crc(*(int32_t *)(v2 + 0x2bce), v2 + 3096, v4);
    transparent_crc(*(int32_t *)(v2 + 0x2bd2), v2 + 3100, v4);
