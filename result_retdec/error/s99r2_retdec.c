...
// Address range: 0x804a377 - 0x804a418
int32_t func_1(void) {
    // 0x804a377
...
// Address range: 0x804a418 - 0x804a4da
int main(int argc, char ** argv) {
    ...
    crc32_gentab();
    func_1();
    transparent_crc(*(int32_t *)(v2 + 0x2be9), v2 + 3123, v4);
    transparent_crc((int32_t)*(char *)(v2 + 0x2bed), v2 + 3128, v4);
    platform_main_end(-1 - *(int32_t *)(v2 + 0x2be5));
    return 0;
}

// Address range: 0x804a4da - 0x804a4de
int32_t __x86_get_pc_thunk_ax(int32_t result) {
    // 0x804a4da
    return result;
}
