...
// Address range: 0x804a347 - 0x804a379
int32_t set_var(int32_t a1, int32_t a2, int32_t a3) {
    // 0x804a347
    int32_t v1; // 0x804a347
    int32_t v2 = __x86_get_pc_thunk_ax(v1); // 0x804a34d
    *(int16_t *)(v2 + 0x2cc6) = (int16_t)a1;
    *(int32_t *)(v2 + 0x30f2) = a2;
    return 0;
}

// Address range: 0x804a379 - 0x804a405
int32_t func_1(void) {
    // 0x804a379
    int32_t v1; // 0x804a379
    __x86_get_pc_thunk_ax(v1);
    set_var(0x3948, 0, 0);
    return -0x652a61a9;
}

// Address range: 0x804a405 - 0x804a4c7
int main(int argc, char ** argv) {
    // 0x804a405
    int32_t v1; // 0x804a405
    int32_t v2 = v1;
    char ** v3 = argv;
    __x86_get_pc_thunk_bx((int32_t)&v3);
    int32_t v4 = 0; // 0x804a42e
    if (v3 == (char **)2) {
        int32_t str = *(int32_t *)(v1 + 4); // 0x804a436
        v4 = strcmp((char *)str, (char *)(v2 + 3140)) == 0;
    }
    // 0x804a456
    platform_main_begin();
    crc32_gentab();
    func_1();
    transparent_crc((int32_t)*(int16_t *)(v2 + 0x2bfc), v2 + 3142, v4);
    transparent_crc(*(int32_t *)(v2 + 0x3028), v2 + 3147, v4);
    platform_main_end(-1 - *(int32_t *)(v2 + 0x2bf8));
    return 0;
}

// Address range: 0x804a4c7 - 0x804a4cb
int32_t __x86_get_pc_thunk_ax(int32_t result) {
    // 0x804a4c7
    return result;
}
