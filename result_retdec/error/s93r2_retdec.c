...
// Address range: 0x804a36d - 0x804a3c2
int32_t func_1(void) {
    // 0x804a36d
...
// Address range: 0x804a3c2 - 0x804a482
int main(int argc, char ** argv) {
    // 0x804a3c2
    int32_t v1; // 0x804a3c2
    int32_t v2 = v1;
    char ** v3 = argv;
    __x86_get_pc_thunk_bx((int32_t)&v3);
    int32_t v4 = 0; // 0x804a3eb
    if (v3 == (char **)2) {
        int32_t str = *(int32_t *)(v1 + 4); // 0x804a3f3
        v4 = strcmp((char *)str, (char *)(v2 + 3207)) == 0;
    }
    // 0x804a413
    platform_main_begin();
    crc32_gentab();
    func_1();
    transparent_crc(*(int32_t *)(v2 + 0x2c3f), v2 + 3209, v4);
    transparent_crc(*(int32_t *)(v2 + 0x2c43), v2 + 3213, v4);
    platform_main_end(-1 - *(int32_t *)(v2 + 0x2c3b));
    return 0;
}
