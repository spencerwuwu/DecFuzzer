...
// Address range: 0x804a36d - 0x804a3ad
int32_t func_1(void) {
    // 0x804a36d
...
// Address range: 0x804a3ad - 0x804a46d
int main(int argc, char ** argv) {
    ...
    int32_t v4 = 0; // 0x804a3d6
    if (v3 == (char **)2) {
        int32_t str = *(int32_t *)(v1 + 4); // 0x804a3de
        v4 = strcmp((char *)str, (char *)(v2 + 3228)) == 0;
    }
    // 0x804a3fe
    platform_main_begin();
    crc32_gentab();
    func_1();
    transparent_crc(*(int32_t *)(v2 + 0x2c54), v2 + 3230, v4);
    transparent_crc(*(int32_t *)(v2 + 0x3080), v2 + 3234, v4);
    platform_main_end(-1 - *(int32_t *)(v2 + 0x2c50));
    return 0;
}

// Address range: 0x804a46d - 0x804a471
int32_t __x86_get_pc_thunk_ax(int32_t result) {
    // 0x804a46d
    return result;
}
