...
int32_t set_var(int32_t a1, int32_t a2, int32_t a3) {
    ...
    *(int16_t *)(v2 + 0x30f2) = (int16_t)a2;
    return 0;
}

// Address range: 0x804a379 - 0x804a3d6
int32_t func_1(void) {
    // 0x804a379
...
// Address range: 0x804a3d6 - 0x804a498
int main(int argc, char ** argv) {
    // 0x804a3d6
    int32_t v1; // 0x804a3d6
    int32_t v2 = v1;
    char ** v3 = argv;
    __x86_get_pc_thunk_bx((int32_t)&v3);
    int32_t v4 = 0; // 0x804a3ff
    if (v3 == (char **)2) {
        int32_t str = *(int32_t *)(v1 + 4); // 0x804a407
        v4 = strcmp((char *)str, (char *)(v2 + 3187)) == 0;
    }
    // 0x804a427
    platform_main_begin();
    crc32_gentab();
    func_1();
    transparent_crc(*(int32_t *)(v2 + 0x2c2b), v2 + 3189, v4);
    transparent_crc((int32_t)*(int16_t *)(v2 + 0x3057), v2 + 3194, v4);
    platform_main_end(-1 - *(int32_t *)(v2 + 0x2c27));
    return 0;
}

// Address range: 0x804a498 - 0x804a49c
int32_t __x86_get_pc_thunk_ax(int32_t result) {
    // 0x804a498
    return result;
}
