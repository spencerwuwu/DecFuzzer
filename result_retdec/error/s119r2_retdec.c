...
int32_t set_var(int32_t a1, int32_t a2, int32_t a3, int32_t a4, int32_t a5, int32_t a6, int32_t a7, int32_t a8, int32_t a9, int32_t a10) {
    ...
    *(int16_t *)(v2 + 0x2cc8) = (int16_t)a2;
    *(int32_t *)(v2 + 0x2cca) = a3;
    return 0;
}

// Address range: 0x804a389 - 0x804a475
int32_t func_1(void) {
    // 0x804a389
...
// Address range: 0x804a475 - 0x804a575
int main(int argc, char ** argv) {
    // 0x804a475
    int32_t v1; // 0x804a475
    int32_t v2 = v1;
    char ** v3 = argv;
    __x86_get_pc_thunk_bx((int32_t)&v3);
    int32_t v4 = 0; // 0x804a49e
    if (v3 == (char **)2) {
        int32_t str = *(int32_t *)(v1 + 4); // 0x804a4a6
        v4 = strcmp((char *)str, (char *)(v2 + 3030)) == 0;
    }
    // 0x804a4c6
    platform_main_begin();
    crc32_gentab();
    func_1();
    transparent_crc(0x59b8, v2 + 3032, v4);
    transparent_crc((int32_t)*(char *)(v2 + 0x2b8c), v2 + 3036, v4);
    transparent_crc((int32_t)*(int16_t *)(v2 + 0x2b8e), v2 + 3041, v4);
    transparent_crc(*(int32_t *)(v2 + 0x2b90), v2 + 3046, v4);
    platform_main_end(-1 - *(int32_t *)(v2 + 0x2b88));
    return 0;
}
