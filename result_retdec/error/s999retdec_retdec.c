...
// Address range: 0x804a382 - 0x804a4a4
int32_t func_1(void) {
    // 0x804a382
...
// Address range: 0x804a4a4 - 0x804a582
int main(int argc, char ** argv) {
    ...
    int32_t v4 = 0; // 0x804a4cd
    if (v3 == (char **)2) {
        int32_t str = *(int32_t *)(v1 + 4); // 0x804a4d5
        v4 = strcmp((char *)str, (char *)(v2 + 2981)) == 0;
    }
    // 0x804a4f5
    platform_main_begin();
    crc32_gentab();
    func_1();
    transparent_crc(*(int32_t *)(v2 + 0x2b5d), v2 + 2983, v4);
    transparent_crc(*(int32_t *)(v2 + 0x2b61), v2 + 2987, v4);
    transparent_crc((int32_t)*(int16_t *)(v2 + 0x2b65), v2 + 2992, v4);
    platform_main_end(-1 - *(int32_t *)(v2 + 0x2b59));
    return 0;
}

// Address range: 0x804a582 - 0x804a586
int32_t __x86_get_pc_thunk_ax(int32_t result) {
    // 0x804a582
    return result;
}
