...
int32_t set_var(int32_t a1, int32_t a2, int32_t a3, int32_t a4, char a5) {
    ...
    *(char *)(v2 + 0x30f2) = (char)a1;
    *(int32_t *)(v2 + 0x2cc6) = a2;
    return 0;
}

// Address range: 0x804a377 - 0x804a3dc
int32_t func_1(void) {
    // 0x804a377
...
// Address range: 0x804a3dc - 0x804a49e
int main(int argc, char ** argv) {
    ...
    int32_t v4 = 0; // 0x804a405
    if (v3 == (char **)2) {
        int32_t str = *(int32_t *)(v1 + 4); // 0x804a40d
        v4 = strcmp((char *)str, (char *)(v2 + 3181)) == 0;
    }
    // 0x804a42d
    platform_main_begin();
    crc32_gentab();
    func_1();
    transparent_crc((int32_t)*(char *)(v2 + 0x3051), v2 + 3183, v4);
    transparent_crc(*(int32_t *)(v2 + 0x2c25), v2 + 3188, v4);
    platform_main_end(-1 - *(int32_t *)(v2 + 0x2c21));
    return 0;
}
