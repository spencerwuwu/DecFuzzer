...
// Address range: 0x804a380 - 0x804a3ff
int32_t func_1(void) {
    // 0x804a380
...
// Address range: 0x804a3ff - 0x804a4dd
int main(int argc, char ** argv) {
    // 0x804a3ff
    int32_t v1; // 0x804a3ff
    int32_t v2 = v1;
    char ** v3 = argv;
    __x86_get_pc_thunk_bx((int32_t)&v3);
    int32_t v4 = 0; // 0x804a428
    if (v3 == (char **)2) {
        int32_t str = *(int32_t *)(v1 + 4); // 0x804a430
        v4 = strcmp((char *)str, (char *)(v2 + 3146)) == 0;
    }
    // 0x804a450
    platform_main_begin();
    crc32_gentab();
    func_1();
    transparent_crc(*(int32_t *)(v2 + 0x2c02), v2 + 3148, v4);
    transparent_crc((int32_t)*(char *)(v2 + 0x2c06), v2 + 3152, v4);
    transparent_crc(*(int32_t *)(v2 + 0x2c0a), v2 + 3156, v4);
    platform_main_end(-1 - *(int32_t *)(v2 + 0x2bfe));
    return 0;
}

// Address range: 0x804a4dd - 0x804a4e1
int32_t __x86_get_pc_thunk_ax(int32_t result) {
    // 0x804a4dd
    return result;
}
