...
// Address range: 0x804a364 - 0x804a3c4
int32_t func_1(void) {
    // 0x804a364
...
// Address range: 0x804a3c4 - 0x804a468
int main(int argc, char ** argv) {
    ...
    int32_t v4 = 0; // 0x804a3ed
    if (v3 == (char **)2) {
        int32_t str = *(int32_t *)(v1 + 4); // 0x804a3f5
        v4 = strcmp((char *)str, (char *)(v2 + 3205)) == 0;
    }
    // 0x804a415
    platform_main_begin();
    crc32_gentab();
    func_1();
    transparent_crc(*(int32_t *)(v2 + 0x2c3d), v2 + 3207, v4);
    platform_main_end(-1 - *(int32_t *)(v2 + 0x2c39));
    return 0;
}

// Address range: 0x804a468 - 0x804a46c
int32_t __x86_get_pc_thunk_ax(int32_t result) {
    // 0x804a468
    return result;
}
