...
// Address range: 0x804a380 - 0x804a3e6
int32_t func_1(void) {
    // 0x804a380
...
// Address range: 0x804a3e6 - 0x804a4c4
int main(int argc, char ** argv) {
    ...
    int32_t v4 = 0; // 0x804a40f
    if (v3 == (char **)2) {
        int32_t str = *(int32_t *)(v1 + 4); // 0x804a417
        v4 = strcmp((char *)str, (char *)(v2 + 3171)) == 0;
    }
    // 0x804a437
    platform_main_begin();
    crc32_gentab();
    func_1();
    transparent_crc(*(int32_t *)(v2 + 0x2c1b), v2 + 3173, v4);
    transparent_crc(*(int32_t *)(v2 + 0x2c1f), v2 + 3177, v4);
    transparent_crc((int32_t)*(char *)(v2 + 0x2c23), v2 + 3181, v4);
    platform_main_end(-1 - *(int32_t *)(v2 + 0x2c17));
    return 0;
}

// Address range: 0x804a4c4 - 0x804a4c8
int32_t __x86_get_pc_thunk_ax(int32_t result) {
    // 0x804a4c4
    return result;
}
