...
// Address range: 0x804a347 - 0x804a3cc
int32_t set_var(int32_t a1, int32_t a2, int32_t a3, int32_t a4, int32_t a5, int32_t a6, int32_t a7, int32_t a8, int32_t a9, int32_t a10, int32_t a11) {
    // 0x804a347
    int32_t v1; // 0x804a347
    int32_t v2 = __x86_get_pc_thunk_ax(v1); // 0x804a34e
    *(int32_t *)(v2 + 0x3111) = a1;
    *(int32_t *)(v2 + 0x3115) = a2;
    *(int32_t *)(v2 + 0x2cc5) = a3;
    *(int32_t *)(v2 + 0x2cc9) = a4;
    *(int16_t *)(v2 + 0x3119) = (int16_t)a5;
    *(char *)(v2 + 0x2ccd) = (char)a6;
    *(int32_t *)(v2 + 0x2cd1) = a7;
    *(int16_t *)(v2 + 0x2cd5) = (int16_t)a8;
    *(int32_t *)(v2 + 0x2cd9) = a9;
    return 0;
}

// Address range: 0x804a3cc - 0x804a76c
int32_t func_1(void) {
    // 0x804a3cc
    int32_t v1; // 0x804a3cc
    __x86_get_pc_thunk_ax(v1);
    set_var(-1, 0, 1, 1, 0, 9, 2, -0x480e, -0x504f6dcc, (int32_t)&g1, (int32_t)&g1);
    return 5;
}

// Address range: 0x804a76c - 0x804a8fe
int main(int argc, char ** argv) {
    // 0x804a76c
    int32_t v1; // 0x804a76c
    int32_t v2 = v1;
    char ** v3 = argv;
    __x86_get_pc_thunk_bx((int32_t)&v3);
    int32_t v4 = 0; // 0x804a795
    if (v3 == (char **)2) {
        int32_t str = *(int32_t *)(v1 + 4); // 0x804a79d
        v4 = strcmp((char *)str, (char *)(v2 + 2269)) == 0;
    }
    // 0x804a7bd
    platform_main_begin();
    crc32_gentab();
    func_1();
    transparent_crc(*(int32_t *)(v2 + 0x2ce1), v2 + 2271, v4);
    transparent_crc(*(int32_t *)(v2 + 0x2ce5), v2 + 2275, v4);
    transparent_crc(*(int32_t *)(v2 + 0x2895), v2 + 2280, v4);
    transparent_crc(*(int32_t *)(v2 + 0x2899), v2 + 2285, v4);
    transparent_crc((int32_t)*(int16_t *)(v2 + 0x2ce9), v2 + 2290, v4);
    transparent_crc((int32_t)*(char *)(v2 + 0x289d), v2 + 2295, v4);
    transparent_crc(*(int32_t *)(v2 + 0x28a1), v2 + 2300, v4);
    transparent_crc((int32_t)*(int16_t *)(v2 + 0x28a5), v2 + 2305, v4);
    transparent_crc(*(int32_t *)(v2 + 0x28a9), v2 + 2310, v4);
    platform_main_end(-1 - *(int32_t *)(v2 + 0x2891));
    return 0;
}

// Address range: 0x804a8fe - 0x804a902
int32_t __x86_get_pc_thunk_ax(int32_t result) {
    // 0x804a8fe
    return result;
}
