...
// Address range: 0x804a36d - 0x804a3c9
int32_t func_1(void) {
    // 0x804a36d
...
// Address range: 0x804a3c9 - 0x804a4a6
int main(int argc, char ** argv) {
    ...
    int32_t v4 = 0; // 0x804a3f2
    if (v3 == (char **)2) {
        int32_t str = *(int32_t *)(v1 + 4); // 0x804a3fa
        v4 = strcmp((char *)str, (char *)(v2 + 3204)) == 0;
    }
    // 0x804a41a
    platform_main_begin();
    crc32_gentab();
    func_1();
    transparent_crc(*(int32_t *)(v2 + 0x2c38), v2 + 3206, v4);
    transparent_crc(0x2e31d832, v2 + 3210, v4);
    transparent_crc(*(int32_t *)(v2 + 0x2c3c), v2 + 3214, v4);
    platform_main_end(-1 - *(int32_t *)(v2 + 0x2c34));
    return 0;
}

// Address range: 0x804a4a6 - 0x804a4aa
int32_t __x86_get_pc_thunk_ax(int32_t result) {
    // 0x804a4a6
    return result;
}
