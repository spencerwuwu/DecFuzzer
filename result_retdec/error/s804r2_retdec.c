...
// Address range: 0x804a390 - 0x804a3f3
int32_t func_1(void) {
    // 0x804a390
...
// Address range: 0x804a3f3 - 0x804a4f1
int main(int argc, char ** argv) {
    ...
    int32_t v4 = 0; // 0x804a41c
    if (v3 == (char **)2) {
        int32_t str = *(int32_t *)(v1 + 4); // 0x804a424
        v4 = strcmp((char *)str, (char *)(v2 + 3158)) == 0;
    }
    // 0x804a444
    platform_main_begin();
    crc32_gentab();
    func_1();
    transparent_crc((int32_t)*(char *)(v2 + 0x2c0e), v2 + 3160, v4);
    transparent_crc(*(int32_t *)(v2 + 0x2c12), v2 + 3164, v4);
    transparent_crc(*(int32_t *)(v2 + 0x2c16), v2 + 3168, v4);
    transparent_crc((int32_t)*(char *)(v2 + 0x2c1a), v2 + 3173, v4);
    platform_main_end(-1 - *(int32_t *)(v2 + 0x2c0a));
    return 0;
}

// Address range: 0x804a4f1 - 0x804a4f5
int32_t __x86_get_pc_thunk_ax(int32_t result) {
    // 0x804a4f1
    return result;
}
