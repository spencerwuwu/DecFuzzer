...
// Address range: 0x804a347 - 0x804a3a4
int32_t set_var(int32_t a1, int32_t a2, int32_t a3, int32_t a4, int32_t a5, int32_t a6, int32_t a7, int32_t a8, int32_t a9, char a10, char a11, int32_t a12, int32_t a13, int32_t a14, int32_t a15, int16_t a16, int32_t a17) {
    // 0x804a347
    int32_t v1; // 0x804a347
    int32_t v2 = __x86_get_pc_thunk_ax(v1); // 0x804a34d
    *(int32_t *)(v2 + 0x2cc6) = a1;
    *(int16_t *)(v2 + 0x2cca) = (int16_t)a2;
    *(char *)(v2 + 0x2ccc) = (char)a3;
    *(int32_t *)(v2 + 0x2cce) = a4;
    *(int32_t *)(v2 + 0x2cd2) = a5;
    *(int32_t *)(v2 + 0x2cd6) = a6;
    return 0;
}

// Address range: 0x804a3a4 - 0x804a488
int32_t func_1(void) {
    // 0x804a3a4
    int32_t v1; // 0x804a3a4
    __x86_get_pc_thunk_ax(v1);
    set_var(-2, -0x5795, 0, 0, -0x6e090b64, -2, 0, 0, 0, -33, -37, -2, -0x6e090b64, 0, 0, -0x5795, -2);
    return -2;
}

// Address range: 0x804a488 - 0x804a5be
int main(int argc, char ** argv) {
    ...
    int32_t v4 = 0; // 0x804a4b1
    if (v3 == (char **)2) {
        int32_t str = *(int32_t *)(v1 + 4); // 0x804a4b9
        v4 = strcmp((char *)str, (char *)(v2 + 3009)) == 0;
    }
    // 0x804a4d9
    platform_main_begin();
    crc32_gentab();
    func_1();
    transparent_crc(*(int32_t *)(v2 + 0x2b79), v2 + 3011, v4);
    transparent_crc((int32_t)*(int16_t *)(v2 + 0x2b7d), v2 + 3015, v4);
    transparent_crc((int32_t)*(char *)(v2 + 0x2b7f), v2 + 3020, v4);
    transparent_crc(*(int32_t *)(v2 + 0x2b81), v2 + 3025, v4);
    transparent_crc(*(int32_t *)(v2 + 0x2b85), v2 + 3030, v4);
    transparent_crc(*(int32_t *)(v2 + 0x2b89), v2 + 3035, v4);
    platform_main_end(-1 - *(int32_t *)(v2 + 0x2b75));
    return 0;
}

// Address range: 0x804a5be - 0x804a5c2
int32_t __x86_get_pc_thunk_ax(int32_t result) {
    // 0x804a5be
    return result;
}
