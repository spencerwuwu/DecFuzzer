...
int main(int argc, char ** argv) {
    ...
    int32_t v4 = 0; // 0x804a4df
    if (v3 == (char **)2) {
        int32_t str = *(int32_t *)(v1 + 4); // 0x804a4e7
        v4 = strcmp((char *)str, (char *)(v2 + 2963)) == 0;
    }
    // 0x804a507
    platform_main_begin();
    crc32_gentab();
    func_1();
    transparent_crc((int32_t)*(int16_t *)(v2 + 0x2b4b), v2 + 2965, v4);
    transparent_crc((int32_t)*(char *)(v2 + 0x2f77), v2 + 2970, v4);
    transparent_crc((int32_t)*(int16_t *)(v2 + 0x2b4d), v2 + 2975, v4);
    platform_main_end(-1 - *(int32_t *)(v2 + 0x2b47));
    return 0;
}

// Address range: 0x804a59a - 0x804a59e
int32_t __x86_get_pc_thunk_ax(int32_t result) {
    // 0x804a59a
    return result;
}
