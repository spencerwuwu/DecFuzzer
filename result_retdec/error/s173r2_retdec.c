...
// Address range: 0x804a3a8 - 0x804a4af
int32_t func_1(void) {
    // 0x804a3a8
...
// Address range: 0x804a4af - 0x804a5cd
int main(int argc, char ** argv) {
    // 0x804a4af
    int32_t v1; // 0x804a4af
    int32_t v2 = v1;
    char ** v3 = argv;
    __x86_get_pc_thunk_bx((int32_t)&v3);
    int32_t v4 = 0; // 0x804a4d8
    if (v3 == (char **)2) {
        int32_t str = *(int32_t *)(v1 + 4); // 0x804a4e0
        v4 = strcmp((char *)str, (char *)(v2 + 2970)) == 0;
    }
    // 0x804a500
    platform_main_begin();
    crc32_gentab();
    func_1();
    transparent_crc(*(int32_t *)(v2 + 0x2b52), v2 + 2972, v4);
    transparent_crc((int32_t)*(int16_t *)(v2 + 0x2b56), v2 + 2977, v4);
    transparent_crc((int32_t)*(int16_t *)(v2 + 0x2b58), v2 + 2982, v4);
    transparent_crc((int32_t)*(char *)(v2 + 0x2b5a), v2 + 2987, v4);
    transparent_crc(*(int32_t *)(v2 + 0x2f9e), v2 + 2992, v4);
    platform_main_end(-1 - *(int32_t *)(v2 + 0x2b4e));
    return 0;
}

// Address range: 0x804a5cd - 0x804a5d1
int32_t __x86_get_pc_thunk_ax(int32_t result) {
    // 0x804a5cd
    return result;
}
